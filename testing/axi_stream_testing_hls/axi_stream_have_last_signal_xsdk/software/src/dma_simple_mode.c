...
/********************************************************************************************
* Enable interrupt of TX channel (MM2S channel) using mask
* @param
...
/*****************************************************************************
** Read Status Register of TX channel
** @param:  pointer to DMA instance
*
*  @return: 32-bit status register
*
*  @note: None
*****************************************************************************/
u32 readStatus_TX_channel(XAxiDma *dma_Device){
	u32 baseAddressTXchannel = dma_Device->TxBdRing.ChanBase;
	return readReg32(baseAddressTXchannel, XAXIDMA_SR_OFFSET);
}

/*****************************************************************************
*  Read Status Register of RX channel
** @param:  pointer to DMA instance
** @param:  channel's number
*
*  @return: 32-bit status register
*
*  @note: In simple mode, channel = 0
*****************************************************************************/
u32 readStatus_RX_channel(XAxiDma *dma_Device, int channel){
	u32 baseAddressRXchannel = dma_Device->RxBdRing[channel].ChanBase;
	return readReg32(baseAddressRXchannel, XAXIDMA_SR_OFFSET);

}

/*****************************************************************************
*  Read Buffer Length Register of RX channel
** @param:  pointer to DMA instance
** @param:  channel's number
*
*  @return: 32-bit status register
...
u32 readBuffLen_RX_channel(XAxiDma *dma_Device, int channel){
	u32 baseAddressRXchannel = dma_Device->RxBdRing[channel].ChanBase;
	return readReg32(baseAddressRXchannel, XAXIDMA_BUFFLEN_OFFSET);
}
