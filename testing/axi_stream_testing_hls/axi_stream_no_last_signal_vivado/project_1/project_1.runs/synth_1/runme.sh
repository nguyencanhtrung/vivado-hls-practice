...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls/axi_stream_no_last_signal_vivado/project_1/project_1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log no_last_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source no_last_wrapper.tcl
