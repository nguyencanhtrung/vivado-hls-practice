...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("counter_V_data_TDATA", 32, hls_out, 2, "axis", "out_data", 1),
	Port_Property("counter_V_data_TVALID", 1, hls_out, 2, "axis", "out_vld", 1),
	Port_Property("counter_V_data_TREADY", 1, hls_in, 2, "axis", "out_acc", 1),
