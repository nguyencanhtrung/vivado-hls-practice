set C_TypeInfoList {{ 
"counter_stream_hls" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"resolution": [["const"], {"scalar": "int"}] }, {"numIteration": [["const"], {"scalar": "int"}] }, {"counter": [[], {"reference": "0"}] }],[],""], 
"0": [ "stream<axis_t>", {"hls_type": {"stream": [[[[],"1"]],"2"]}}], 
"1": [ "axis_t", {"struct": [[],[],[{ "data": [[],  {"scalar": "int"}]}],""]}],
"2": ["hls", ""]
}}
...
set C_modelArgList { 
	...
	{ counter_V_data int 32 regular {axi_s 1 volatile  { counter_V_data data } }  }
}
...
set portList { 
	...
	{ counter_V_data_TDATA sc_out sc_lv 32 signal 2 } 
	{ counter_V_data_TVALID sc_out sc_logic 1 outvld 2 } 
	{ counter_V_data_TREADY sc_in sc_logic 1 outacc 2 } 
...
set NewPortList {[ 
	{ "name": "s_axi_cpuControl_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "cpuControl", "role": "AWADDR" },"address":[{"name":"counter_stream_hls","role":"start","value":"0","valid_bit":"0"},{"name":"counter_stream_hls","role":"continue","value":"0","valid_bit":"4"},{"name":"counter_stream_hls","role":"auto_start","value":"0","valid_bit":"7"},{"name":"resolution","role":"data","value":"16"},{"name":"numIteration","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_cpuControl_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "cpuControl", "role": "ARADDR" },"address":[{"name":"counter_stream_hls","role":"start","value":"0","valid_bit":"0"},{"name":"counter_stream_hls","role":"done","value":"0","valid_bit":"1"},{"name":"counter_stream_hls","role":"idle","value":"0","valid_bit":"2"},{"name":"counter_stream_hls","role":"ready","value":"0","valid_bit":"3"},{"name":"counter_stream_hls","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_cpuControl_BRESP", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "cpuControl", "role": "BRESP" } }, 
 	...
 	{ "name": "counter_V_data_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "counter_V_data", "role": "TDATA" }} , 
 	{ "name": "counter_V_data_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "counter_V_data", "role": "TVALID" }} , 
 	{ "name": "counter_V_data_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "counter_V_data", "role": "TREADY" }} , 
 	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "interrupt", "role": "default" }}  ]}
set Spec2ImplPortList { 
	counter_V_data { axis {  { counter_V_data_TDATA out_data 1 32 }  { counter_V_data_TVALID out_vld 1 1 }  { counter_V_data_TREADY out_acc 0 1 } } }
}
