; ModuleID = '/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls/unusual_s2mm_hls/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@counter_stream_unusual_s2mm_hl = internal unnamed_addr constant [32 x i8] c"counter_stream_unusual_s2mm_hls\00" ; [#uses=1 type=[32 x i8]*]
@p_str5 = private unnamed_addr constant [11 x i8] c"DELAY_LOOP\00", align 1 ; [#uses=1 type=[11 x i8]*]
@p_str4 = private unnamed_addr constant [5 x i8] c"LOOP\00", align 1 ; [#uses=3 type=[5 x i8]*]
@p_str3 = private unnamed_addr constant [11 x i8] c"cpuControl\00", align 1 ; [#uses=4 type=[11 x i8]*]
...
define void @counter_stream_unusual_s2mm_hls(i32 %resolution, i32 %numIteration, i32 %delay, i32* %counter_V_data, i1* %counter_V_last_V) {
  ...
  call void @llvm.dbg.value(metadata !{i32 %delay_read}, i64 0, metadata !29), !dbg !453 ; [debug line = 14:12] [debug variable = delay]
  %numIteration_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %numIteration) ; [#uses=2 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %numIteration_read}, i64 0, metadata !454), !dbg !455 ; [debug line = 13:12] [debug variable = numIteration]
  %resolution_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %resolution) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %resolution_read}, i64 0, metadata !456), !dbg !457 ; [debug line = 12:12] [debug variable = resolution]
  %acc = alloca i32, align 4                      ; [#uses=2 type=i32*]
  call void @llvm.dbg.value(metadata !{i32 %resolution}, i64 0, metadata !456), !dbg !457 ; [debug line = 12:12] [debug variable = resolution]
  call void @llvm.dbg.value(metadata !{i32 %numIteration}, i64 0, metadata !454), !dbg !455 ; [debug line = 13:12] [debug variable = numIteration]
  call void @llvm.dbg.value(metadata !{i32 %delay}, i64 0, metadata !29), !dbg !453 ; [debug line = 14:12] [debug variable = delay]
  call void @llvm.dbg.value(metadata !{i32* %counter_V_data}, i64 0, metadata !458), !dbg !465 ; [debug line = 16:23] [debug variable = counter.V.data]
  call void @llvm.dbg.value(metadata !{i1* %counter_V_last_V}, i64 0, metadata !466), !dbg !465 ; [debug line = 16:23] [debug variable = counter.V.last.V]
  call void (...)* @_ssdm_op_SpecInterface(i32* %counter_V_data, i1* %counter_V_last_V, [5 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !478 ; [debug line = 20:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !480 ; [debug line = 22:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %numIteration, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !481 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %resolution, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !482 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %delay, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !483 ; [debug line = 25:1]
  br label %1, !dbg !484                          ; [debug line = 29:20]

; <label>:1                                       ; preds = %5, %0
  %i = phi i32 [ 1, %0 ], [ %i_1, %5 ]            ; [#uses=4 type=i32]
  %tmp = icmp sgt i32 %i, %numIteration_read, !dbg !484 ; [#uses=1 type=i1] [debug line = 29:20]
  br i1 %tmp, label %6, label %2, !dbg !484       ; [debug line = 29:20]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([5 x i8]* @p_str4) nounwind, !dbg !486 ; [debug line = 29:47]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([5 x i8]* @p_str4), !dbg !486 ; [#uses=1 type=i32] [debug line = 29:47]
  %tmp_data = mul nsw i32 %i, %resolution_read, !dbg !488 ; [#uses=1 type=i32] [debug line = 31:3]
  %tmp_last_V = icmp eq i32 %i, %numIteration_read, !dbg !489 ; [#uses=1 type=i1] [debug line = 32:3]
  call void @llvm.dbg.value(metadata !{i32* %counter_V_data}, i64 0, metadata !490), !dbg !495 ; [debug line = 105:48@33:3] [debug variable = stream<axis_t>.V.data]
  call void @llvm.dbg.value(metadata !{i1* %counter_V_last_V}, i64 0, metadata !497), !dbg !495 ; [debug line = 105:48@33:3] [debug variable = stream<axis_t>.V.last.V]
  call void @llvm.dbg.value(metadata !{i32* %counter_V_data}, i64 0, metadata !499), !dbg !502 ; [debug line = 144:48@106:9@33:3] [debug variable = stream<axis_t>.V.data]
  call void @llvm.dbg.value(metadata !{i1* %counter_V_last_V}, i64 0, metadata !505), !dbg !502 ; [debug line = 144:48@106:9@33:3] [debug variable = stream<axis_t>.V.last.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data}, i64 0, metadata !506), !dbg !509 ; [debug line = 145:31@106:9@33:3] [debug variable = tmp.data]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !510), !dbg !509 ; [debug line = 145:31@106:9@33:3] [debug variable = tmp.last.V]
  call void @_ssdm_op_Write.axis.volatile.i32P.i1P(i32* %counter_V_data, i1* %counter_V_last_V, i32 %tmp_data, i1 %tmp_last_V), !dbg !511 ; [debug line = 146:9@106:9@33:3]
  br label %3, !dbg !512                          ; [debug line = 35:28]

; <label>:3                                       ; preds = %4, %2
  %j = phi i31 [ 0, %2 ], [ %j_1, %4 ]            ; [#uses=2 type=i31]
  %j_cast = zext i31 %j to i32, !dbg !512         ; [#uses=2 type=i32] [debug line = 35:28]
  %tmp_4 = icmp slt i32 %j_cast, %delay_read, !dbg !512 ; [#uses=1 type=i1] [debug line = 35:28]
  %j_1 = add i31 %j, 1, !dbg !514                 ; [#uses=1 type=i31] [debug line = 35:41]
  br i1 %tmp_4, label %4, label %5, !dbg !512     ; [debug line = 35:28]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @p_str5) nounwind, !dbg !515 ; [debug line = 35:46]
  call void @llvm.dbg.value(metadata !{i32* %acc}, i64 0, metadata !517), !dbg !519 ; [debug line = 36:4] [debug variable = acc]
  %acc_load = load volatile i32* %acc, align 4, !dbg !519 ; [#uses=1 type=i32] [debug line = 36:4]
  %acc_1 = add nsw i32 %acc_load, %j_cast, !dbg !519 ; [#uses=1 type=i32] [debug line = 36:4]
  call void @llvm.dbg.value(metadata !{i32 %acc_1}, i64 0, metadata !517), !dbg !519 ; [debug line = 36:4] [debug variable = acc]
  store volatile i32 %acc_1, i32* %acc, align 4, !dbg !519 ; [debug line = 36:4]
  call void @llvm.dbg.value(metadata !{i31 %j_1}, i64 0, metadata !520), !dbg !514 ; [debug line = 35:41] [debug variable = j]
  br label %3, !dbg !514                          ; [debug line = 35:41]

; <label>:5                                       ; preds = %3
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([5 x i8]* @p_str4, i32 %tmp_3), !dbg !521 ; [#uses=0 type=i32] [debug line = 38:2]
  %i_1 = add nsw i32 %i, 1, !dbg !522             ; [#uses=1 type=i32] [debug line = 29:41]
  call void @llvm.dbg.value(metadata !{i32 %i_1}, i64 0, metadata !523), !dbg !522 ; [debug line = 29:41] [debug variable = i]
  br label %1, !dbg !522                          ; [debug line = 29:41]

; <label>:6                                       ; preds = %1
  ret void, !dbg !524                             ; [debug line = 39:1]
}
...
!29 = metadata !{i32 786689, metadata !30, metadata !"delay", metadata !31, i32 50331662, metadata !34, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!30 = metadata !{i32 786478, i32 0, metadata !31, metadata !"counter_stream_unusual_s2mm_hls", metadata !"counter_stream_unusual_s2mm_hls", metadata !"_Z31counter_stream_unusual_s2mm_hlsiiiRN3hls6streamI6axis_tEE", metadata !31, i32 11, metadata !32, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !64, i32 18} ; [ DW_TAG_subprogram ]
!31 = metadata !{i32 786473, metadata !"unusual_s2mm_hls/src/counter_stream_unusual_s2mm_hls.cpp", metadata !"/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls", null} ; [ DW_TAG_file_type ]
!32 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !33, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!33 = metadata !{null, metadata !34, metadata !34, metadata !34, metadata !36}
...
!37 = metadata !{i32 786434, metadata !38, metadata !"stream<axis_t>", metadata !39, i32 79, i64 64, i64 32, i32 0, i32 0, null, metadata !40, i32 0, null, metadata !451} ; [ DW_TAG_class_type ]
...
!42 = metadata !{i32 786434, null, metadata !"", metadata !43, i32 7, i64 64, i64 32, i32 0, i32 0, null, metadata !44, i32 0, null, null} ; [ DW_TAG_class_type ]
!43 = metadata !{i32 786473, metadata !"unusual_s2mm_hls/src/counter_stream_unusual_s2mm_hls.hpp", metadata !"/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls", null} ; [ DW_TAG_file_type ]
!44 = metadata !{metadata !45, metadata !46, metadata !404}
!45 = metadata !{i32 786445, metadata !42, metadata !"data", metadata !43, i32 8, i64 32, i64 32, i64 0, i32 0, metadata !35} ; [ DW_TAG_member ]
!46 = metadata !{i32 786445, metadata !42, metadata !"last", metadata !43, i32 9, i64 8, i64 8, i64 32, i32 0, metadata !47} ; [ DW_TAG_member ]
...
!404 = metadata !{i32 786478, i32 0, metadata !42, metadata !"", metadata !"", metadata !"", metadata !43, i32 7, metadata !405, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !64, i32 7} ; [ DW_TAG_subprogram ]
...
!420 = metadata !{i32 786478, i32 0, metadata !37, metadata !"operator=", metadata !"operator=", metadata !"_ZN3hls6streamI6axis_tEaSERKS2_", metadata !39, i32 94, metadata !421, i1 false, i1 false, i32 0, i32 0, null, i32 257, i1 false, null, null, i32 0, metadata !64, i32 94} ; [ DW_TAG_subprogram ]
!421 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !422, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!422 = metadata !{metadata !36, metadata !411, metadata !418}
!423 = metadata !{i32 786478, i32 0, metadata !37, metadata !"operator>>", metadata !"operator>>", metadata !"_ZN3hls6streamI6axis_tErsERS1_", metadata !39, i32 101, metadata !424, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 101} ; [ DW_TAG_subprogram ]
...
!427 = metadata !{i32 786478, i32 0, metadata !37, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamI6axis_tElsERKS1_", metadata !39, i32 105, metadata !428, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 105} ; [ DW_TAG_subprogram ]
...
!432 = metadata !{i32 786478, i32 0, metadata !37, metadata !"empty", metadata !"empty", metadata !"_ZNK3hls6streamI6axis_tE5emptyEv", metadata !39, i32 112, metadata !433, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 112} ; [ DW_TAG_subprogram ]
...
!436 = metadata !{i32 786478, i32 0, metadata !37, metadata !"full", metadata !"full", metadata !"_ZNK3hls6streamI6axis_tE4fullEv", metadata !39, i32 117, metadata !433, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 117} ; [ DW_TAG_subprogram ]
!437 = metadata !{i32 786478, i32 0, metadata !37, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI6axis_tE4readERS1_", metadata !39, i32 123, metadata !424, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 123} ; [ DW_TAG_subprogram ]
!438 = metadata !{i32 786478, i32 0, metadata !37, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI6axis_tE4readEv", metadata !39, i32 129, metadata !439, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 129} ; [ DW_TAG_subprogram ]
!439 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !440, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!440 = metadata !{metadata !42, metadata !411}
!441 = metadata !{i32 786478, i32 0, metadata !37, metadata !"read_nb", metadata !"read_nb", metadata !"_ZN3hls6streamI6axis_tE7read_nbERS1_", metadata !39, i32 136, metadata !442, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 136} ; [ DW_TAG_subprogram ]
!442 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !443, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!443 = metadata !{metadata !69, metadata !411, metadata !426}
!444 = metadata !{i32 786478, i32 0, metadata !37, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI6axis_tE5writeERKS1_", metadata !39, i32 144, metadata !428, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 144} ; [ DW_TAG_subprogram ]
!445 = metadata !{i32 786478, i32 0, metadata !37, metadata !"write_nb", metadata !"write_nb", metadata !"_ZN3hls6streamI6axis_tE8write_nbERKS1_", metadata !39, i32 150, metadata !446, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 150} ; [ DW_TAG_subprogram ]
!446 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !447, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!447 = metadata !{metadata !69, metadata !411, metadata !430}
!448 = metadata !{i32 786478, i32 0, metadata !37, metadata !"size", metadata !"size", metadata !"_ZN3hls6streamI6axis_tE4sizeEv", metadata !39, i32 157, metadata !449, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !64, i32 157} ; [ DW_TAG_subprogram ]
...
!453 = metadata !{i32 14, i32 12, metadata !30, null}
!454 = metadata !{i32 786689, metadata !30, metadata !"numIteration", metadata !31, i32 33554445, metadata !34, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!455 = metadata !{i32 13, i32 12, metadata !30, null}
!456 = metadata !{i32 786689, metadata !30, metadata !"resolution", metadata !31, i32 16777228, metadata !34, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!457 = metadata !{i32 12, i32 12, metadata !30, null}
!458 = metadata !{i32 790531, metadata !459, metadata !"counter.V.data", null, i32 16, metadata !460, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!459 = metadata !{i32 786689, metadata !30, metadata !"counter", metadata !31, i32 67108880, metadata !36, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!460 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !461} ; [ DW_TAG_pointer_type ]
!461 = metadata !{i32 786438, metadata !38, metadata !"stream<axis_t>", metadata !39, i32 79, i64 32, i64 32, i32 0, i32 0, null, metadata !462, i32 0, null, metadata !451} ; [ DW_TAG_class_field_type ]
!462 = metadata !{metadata !463}
!463 = metadata !{i32 786438, null, metadata !"", metadata !43, i32 7, i64 32, i64 32, i32 0, i32 0, null, metadata !464, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!464 = metadata !{metadata !45}
!465 = metadata !{i32 16, i32 23, metadata !30, null}
!466 = metadata !{i32 790531, metadata !459, metadata !"counter.V.last.V", null, i32 16, metadata !467, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!467 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !468} ; [ DW_TAG_pointer_type ]
!468 = metadata !{i32 786438, metadata !38, metadata !"stream<axis_t>", metadata !39, i32 79, i64 1, i64 32, i32 0, i32 0, null, metadata !469, i32 0, null, metadata !451} ; [ DW_TAG_class_field_type ]
!469 = metadata !{metadata !470}
!470 = metadata !{i32 786438, null, metadata !"", metadata !43, i32 7, i64 1, i64 32, i32 0, i32 0, null, metadata !471, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!471 = metadata !{metadata !472}
!472 = metadata !{i32 786438, null, metadata !"ap_uint<1>", metadata !48, i32 180, i64 1, i64 8, i32 0, i32 0, null, metadata !473, i32 0, null, metadata !403} ; [ DW_TAG_class_field_type ]
!473 = metadata !{metadata !474}
!474 = metadata !{i32 786438, null, metadata !"ap_int_base<1, false, true>", metadata !52, i32 1396, i64 1, i64 8, i32 0, i32 0, null, metadata !475, i32 0, null, metadata !321} ; [ DW_TAG_class_field_type ]
!475 = metadata !{metadata !476}
!476 = metadata !{i32 786438, null, metadata !"ssdm_int<1 + 1024 * 0, false>", metadata !56, i32 3, i64 1, i64 8, i32 0, i32 0, null, metadata !477, i32 0, null, metadata !66} ; [ DW_TAG_class_field_type ]
!477 = metadata !{metadata !58}
!478 = metadata !{i32 20, i32 1, metadata !479, null}
!479 = metadata !{i32 786443, metadata !30, i32 18, i32 1, metadata !31, i32 0} ; [ DW_TAG_lexical_block ]
!480 = metadata !{i32 22, i32 1, metadata !479, null}
!481 = metadata !{i32 23, i32 1, metadata !479, null}
!482 = metadata !{i32 24, i32 1, metadata !479, null}
!483 = metadata !{i32 25, i32 1, metadata !479, null}
!484 = metadata !{i32 29, i32 20, metadata !485, null}
!485 = metadata !{i32 786443, metadata !479, i32 29, i32 7, metadata !31, i32 1} ; [ DW_TAG_lexical_block ]
!486 = metadata !{i32 29, i32 47, metadata !487, null}
!487 = metadata !{i32 786443, metadata !485, i32 29, i32 46, metadata !31, i32 2} ; [ DW_TAG_lexical_block ]
!488 = metadata !{i32 31, i32 3, metadata !487, null}
!489 = metadata !{i32 32, i32 3, metadata !487, null}
!490 = metadata !{i32 790531, metadata !491, metadata !"stream<axis_t>.V.data", null, i32 105, metadata !494, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!491 = metadata !{i32 786689, metadata !492, metadata !"this", metadata !39, i32 16777321, metadata !493, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!492 = metadata !{i32 786478, i32 0, metadata !38, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamI6axis_tElsERKS1_", metadata !39, i32 105, metadata !428, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !427, metadata !64, i32 105} ; [ DW_TAG_subprogram ]
!493 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !37} ; [ DW_TAG_pointer_type ]
!494 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !461} ; [ DW_TAG_pointer_type ]
!495 = metadata !{i32 105, i32 48, metadata !492, metadata !496}
!496 = metadata !{i32 33, i32 3, metadata !487, null}
!497 = metadata !{i32 790531, metadata !491, metadata !"stream<axis_t>.V.last.V", null, i32 105, metadata !498, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!498 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !468} ; [ DW_TAG_pointer_type ]
!499 = metadata !{i32 790531, metadata !500, metadata !"stream<axis_t>.V.data", null, i32 144, metadata !494, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!500 = metadata !{i32 786689, metadata !501, metadata !"this", metadata !39, i32 16777360, metadata !493, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!501 = metadata !{i32 786478, i32 0, metadata !38, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI6axis_tE5writeERKS1_", metadata !39, i32 144, metadata !428, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !444, metadata !64, i32 144} ; [ DW_TAG_subprogram ]
!502 = metadata !{i32 144, i32 48, metadata !501, metadata !503}
!503 = metadata !{i32 106, i32 9, metadata !504, metadata !496}
!504 = metadata !{i32 786443, metadata !492, i32 105, i32 88, metadata !39, i32 5} ; [ DW_TAG_lexical_block ]
!505 = metadata !{i32 790531, metadata !500, metadata !"stream<axis_t>.V.last.V", null, i32 144, metadata !498, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!506 = metadata !{i32 790529, metadata !507, metadata !"tmp.data", null, i32 145, metadata !463, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!507 = metadata !{i32 786688, metadata !508, metadata !"tmp", metadata !39, i32 145, metadata !42, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!508 = metadata !{i32 786443, metadata !501, i32 144, i32 79, metadata !39, i32 6} ; [ DW_TAG_lexical_block ]
!509 = metadata !{i32 145, i32 31, metadata !508, metadata !503}
!510 = metadata !{i32 790529, metadata !507, metadata !"tmp.last.V", null, i32 145, metadata !470, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!511 = metadata !{i32 146, i32 9, metadata !508, metadata !503}
!512 = metadata !{i32 35, i32 28, metadata !513, null}
!513 = metadata !{i32 786443, metadata !487, i32 35, i32 15, metadata !31, i32 3} ; [ DW_TAG_lexical_block ]
!514 = metadata !{i32 35, i32 41, metadata !513, null}
!515 = metadata !{i32 35, i32 46, metadata !516, null}
!516 = metadata !{i32 786443, metadata !513, i32 35, i32 45, metadata !31, i32 4} ; [ DW_TAG_lexical_block ]
!517 = metadata !{i32 786688, metadata !487, metadata !"acc", metadata !31, i32 34, metadata !518, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!518 = metadata !{i32 786485, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !35} ; [ DW_TAG_volatile_type ]
!519 = metadata !{i32 36, i32 4, metadata !516, null}
!520 = metadata !{i32 786688, metadata !513, metadata !"j", metadata !31, i32 35, metadata !35, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!521 = metadata !{i32 38, i32 2, metadata !487, null}
!522 = metadata !{i32 29, i32 41, metadata !485, null}
!523 = metadata !{i32 786688, metadata !485, metadata !"i", metadata !31, i32 29, metadata !35, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!524 = metadata !{i32 39, i32 1, metadata !479, null}
