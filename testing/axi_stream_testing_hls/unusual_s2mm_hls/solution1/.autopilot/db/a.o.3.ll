...
define void @counter_stream_unusual_s2mm_hls(i32 %resolution, i32 %numIteration, i32* %counter_V_data, i1* %counter_V_last_V) {
  ...
  call void @llvm.dbg.value(metadata !{i32 %numIteration_read}, i64 0, metadata !25), !dbg !449 ; [debug line = 13:12] [debug variable = numIteration]
  %resolution_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %resolution) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %resolution_read}, i64 0, metadata !450), !dbg !451 ; [debug line = 12:12] [debug variable = resolution]
  %acc = alloca i32, align 4                      ; [#uses=20 type=i32*]
  call void @llvm.dbg.value(metadata !{i32 %resolution}, i64 0, metadata !450), !dbg !451 ; [debug line = 12:12] [debug variable = resolution]
  call void @llvm.dbg.value(metadata !{i32 %numIteration}, i64 0, metadata !25), !dbg !449 ; [debug line = 13:12] [debug variable = numIteration]
  call void @llvm.dbg.value(metadata !{i32* %counter_V_data}, i64 0, metadata !452), !dbg !459 ; [debug line = 15:23] [debug variable = counter.V.data]
  call void @llvm.dbg.value(metadata !{i1* %counter_V_last_V}, i64 0, metadata !460), !dbg !459 ; [debug line = 15:23] [debug variable = counter.V.last.V]
  call void (...)* @_ssdm_op_SpecInterface(i32* %counter_V_data, i1* %counter_V_last_V, [5 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !472 ; [debug line = 18:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !474 ; [debug line = 20:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %numIteration, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !475 ; [debug line = 21:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %resolution, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [11 x i8]* @p_str3, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !476 ; [debug line = 22:1]
  br label %1, !dbg !477                          ; [debug line = 26:20]

; <label>:1                                       ; preds = %2, %0
  %i = phi i31 [ 0, %0 ], [ %i_1, %2 ]            ; [#uses=2 type=i31]
  %tmp_data = phi i32 [ 0, %0 ], [ %next_mul, %2 ] ; [#uses=2 type=i32]
  %i_cast = zext i31 %i to i32, !dbg !477         ; [#uses=2 type=i32] [debug line = 26:20]
  %tmp = icmp slt i32 %i_cast, %numIteration_read, !dbg !477 ; [#uses=1 type=i1] [debug line = 26:20]
  %i_1 = add i31 %i, 1, !dbg !479                 ; [#uses=1 type=i31] [debug line = 26:40]
  br i1 %tmp, label %2, label %3, !dbg !477       ; [debug line = 26:20]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([5 x i8]* @p_str4) nounwind, !dbg !480 ; [debug line = 26:46]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([5 x i8]* @p_str4), !dbg !480 ; [#uses=1 type=i32] [debug line = 26:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 10, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !482 ; [debug line = 27:1]
  %next_mul = add i32 %tmp_data, %resolution_read ; [#uses=1 type=i32]
  %tmp_last_V = icmp eq i32 %i_cast, %numIteration_read, !dbg !483 ; [#uses=1 type=i1] [debug line = 30:3]
  call void @llvm.dbg.value(metadata !{i32* %counter_V_data}, i64 0, metadata !484), !dbg !489 ; [debug line = 105:48@31:3] [debug variable = stream<axis_t>.V.data]
  call void @llvm.dbg.value(metadata !{i1* %counter_V_last_V}, i64 0, metadata !491), !dbg !489 ; [debug line = 105:48@31:3] [debug variable = stream<axis_t>.V.last.V]
  call void @llvm.dbg.value(metadata !{i32* %counter_V_data}, i64 0, metadata !493), !dbg !496 ; [debug line = 144:48@106:9@31:3] [debug variable = stream<axis_t>.V.data]
  call void @llvm.dbg.value(metadata !{i1* %counter_V_last_V}, i64 0, metadata !499), !dbg !496 ; [debug line = 144:48@106:9@31:3] [debug variable = stream<axis_t>.V.last.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data}, i64 0, metadata !500), !dbg !503 ; [debug line = 145:31@106:9@31:3] [debug variable = tmp.data]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !504), !dbg !503 ; [debug line = 145:31@106:9@31:3] [debug variable = tmp.last.V]
  call void @_ssdm_op_Write.axis.volatile.i32P.i1P(i32* %counter_V_data, i1* %counter_V_last_V, i32 %tmp_data, i1 %tmp_last_V), !dbg !505 ; [debug line = 146:9@106:9@31:3]
  call void @llvm.dbg.value(metadata !{i32* %acc}, i64 0, metadata !506), !dbg !508 ; [debug line = 35:2] [debug variable = acc]
  %acc_load = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_load, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_1 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_1 = add nsw i32 %acc_load_1, 1, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_1, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_2 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_2 = add nsw i32 %acc_load_2, 2, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_2, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_3 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_3 = add nsw i32 %acc_load_3, 3, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_3, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_4 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_4 = add nsw i32 %acc_load_4, 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_4, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_5 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_5 = add nsw i32 %acc_load_5, 5, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_5, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_6 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_6 = add nsw i32 %acc_load_6, 6, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_6, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_7 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_7 = add nsw i32 %acc_load_7, 7, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_7, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_8 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_8 = add nsw i32 %acc_load_8, 8, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_8, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %acc_load_9 = load volatile i32* %acc, align 4, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  %acc_1_9 = add nsw i32 %acc_load_9, 9, !dbg !508 ; [#uses=1 type=i32] [debug line = 35:2]
  store volatile i32 %acc_1_9, i32* %acc, align 4, !dbg !508 ; [debug line = 35:2]
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([5 x i8]* @p_str4, i32 %tmp_3), !dbg !511 ; [#uses=0 type=i32] [debug line = 37:2]
  call void @llvm.dbg.value(metadata !{i31 %i_1}, i64 0, metadata !512), !dbg !479 ; [debug line = 26:40] [debug variable = i]
  br label %1, !dbg !479                          ; [debug line = 26:40]

; <label>:3                                       ; preds = %1
  ret void, !dbg !513                             ; [debug line = 38:1]
}
...
!25 = metadata !{i32 786689, metadata !26, metadata !"numIteration", metadata !27, i32 33554445, metadata !30, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!26 = metadata !{i32 786478, i32 0, metadata !27, metadata !"counter_stream_unusual_s2mm_hls", metadata !"counter_stream_unusual_s2mm_hls", metadata !"_Z31counter_stream_unusual_s2mm_hlsiiRN3hls6streamI6axis_tEE", metadata !27, i32 11, metadata !28, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !60, i32 17} ; [ DW_TAG_subprogram ]
!27 = metadata !{i32 786473, metadata !"unusual_s2mm_hls/src/counter_stream_unusual_s2mm_hls.cpp", metadata !"/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls", null} ; [ DW_TAG_file_type ]
...
!39 = metadata !{i32 786473, metadata !"unusual_s2mm_hls/src/counter_stream_unusual_s2mm_hls.hpp", metadata !"/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls", null} ; [ DW_TAG_file_type ]
...
!449 = metadata !{i32 13, i32 12, metadata !26, null}
!450 = metadata !{i32 786689, metadata !26, metadata !"resolution", metadata !27, i32 16777228, metadata !30, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!451 = metadata !{i32 12, i32 12, metadata !26, null}
!452 = metadata !{i32 790531, metadata !453, metadata !"counter.V.data", null, i32 15, metadata !454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!453 = metadata !{i32 786689, metadata !26, metadata !"counter", metadata !27, i32 50331663, metadata !32, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!459 = metadata !{i32 15, i32 23, metadata !26, null}
!460 = metadata !{i32 790531, metadata !453, metadata !"counter.V.last.V", null, i32 15, metadata !461, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!472 = metadata !{i32 18, i32 1, metadata !473, null}
!473 = metadata !{i32 786443, metadata !26, i32 17, i32 1, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
!474 = metadata !{i32 20, i32 1, metadata !473, null}
!475 = metadata !{i32 21, i32 1, metadata !473, null}
!476 = metadata !{i32 22, i32 1, metadata !473, null}
!477 = metadata !{i32 26, i32 20, metadata !478, null}
!478 = metadata !{i32 786443, metadata !473, i32 26, i32 7, metadata !27, i32 1} ; [ DW_TAG_lexical_block ]
!479 = metadata !{i32 26, i32 40, metadata !478, null}
!480 = metadata !{i32 26, i32 46, metadata !481, null}
!481 = metadata !{i32 786443, metadata !478, i32 26, i32 45, metadata !27, i32 2} ; [ DW_TAG_lexical_block ]
!482 = metadata !{i32 27, i32 1, metadata !481, null}
!483 = metadata !{i32 30, i32 3, metadata !481, null}
...
!490 = metadata !{i32 31, i32 3, metadata !481, null}
...
!498 = metadata !{i32 786443, metadata !486, i32 105, i32 88, metadata !35, i32 5} ; [ DW_TAG_lexical_block ]
...
!502 = metadata !{i32 786443, metadata !495, i32 144, i32 79, metadata !35, i32 6} ; [ DW_TAG_lexical_block ]
...
!506 = metadata !{i32 786688, metadata !481, metadata !"acc", metadata !27, i32 32, metadata !507, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!507 = metadata !{i32 786485, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !31} ; [ DW_TAG_volatile_type ]
!508 = metadata !{i32 35, i32 2, metadata !509, null}
!509 = metadata !{i32 786443, metadata !510, i32 33, i32 42, metadata !27, i32 4} ; [ DW_TAG_lexical_block ]
!510 = metadata !{i32 786443, metadata !481, i32 33, i32 15, metadata !27, i32 3} ; [ DW_TAG_lexical_block ]
!511 = metadata !{i32 37, i32 2, metadata !481, null}
!512 = metadata !{i32 786688, metadata !478, metadata !"i", metadata !27, i32 26, metadata !31, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!513 = metadata !{i32 38, i32 1, metadata !473, null}
