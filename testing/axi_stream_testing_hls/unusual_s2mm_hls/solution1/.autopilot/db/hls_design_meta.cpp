...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("counter_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("counter_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
	Port_Property("counter_TLAST", 1, hls_out, 4, "axis", "out_data", 1),
