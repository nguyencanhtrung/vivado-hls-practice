...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls/axi_stream_have_last_signal_vivado/project_1/project_1.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log testing_stream_have_last_signal_system_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source testing_stream_have_last_signal_system_wrapper.tcl -notrace
