set C_TypeInfoList {{ 
"counter_stream_have_last_hls" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"resolution": [["const"], {"scalar": "int"}] }, {"numIteration": [["const"], {"scalar": "int"}] }, {"counter": [[], {"reference": "0"}] }],[],""], 
"0": [ "stream<axis_t>", {"hls_type": {"stream": [[[[],"1"]],"2"]}}], 
"1": [ "axis_t", {"struct": [[],[],[{ "data": [[],  {"scalar": "int"}]},{ "last": [[], "3"]}],""]}], 
"3": [ "ap_uint<1>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 1}}]],""]}}],
"2": ["hls", ""]
}}
set moduleName counter_stream_have_last_hls
...
set isOneStateSeq 0
set C_modelName {counter_stream_have_last_hls}
...
set NewPortList {[ 
	{ "name": "s_axi_cpuControl_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "cpuControl", "role": "AWADDR" },"address":[{"name":"counter_stream_have_last_hls","role":"start","value":"0","valid_bit":"0"},{"name":"counter_stream_have_last_hls","role":"continue","value":"0","valid_bit":"4"},{"name":"counter_stream_have_last_hls","role":"auto_start","value":"0","valid_bit":"7"},{"name":"resolution","role":"data","value":"16"},{"name":"numIteration","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_cpuControl_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "cpuControl", "role": "ARADDR" },"address":[{"name":"counter_stream_have_last_hls","role":"start","value":"0","valid_bit":"0"},{"name":"counter_stream_have_last_hls","role":"done","value":"0","valid_bit":"1"},{"name":"counter_stream_have_last_hls","role":"idle","value":"0","valid_bit":"2"},{"name":"counter_stream_have_last_hls","role":"ready","value":"0","valid_bit":"3"},{"name":"counter_stream_have_last_hls","role":"auto_start","value":"0","valid_bit":"7"}] },
