...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls/unusual_mm2s_vivado/project_1/project_1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log unusual_mm2s_sys_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source unusual_mm2s_sys_wrapper.tcl
