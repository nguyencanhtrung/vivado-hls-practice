...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/testing/axi_stream_testing_hls/unusual_s2mm_vivado/project_1/project_1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log unusual_s2mm_sys_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source unusual_s2mm_sys_wrapper.tcl
