...
################################################################
# This is a generated script based on design: unusual_s2mm_sys
#
...
# source unusual_s2mm_sys_script.tcl
...
set design_name unusual_s2mm_sys
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: counter_stream_unusual_s2mm_hls_0, and set properties
  set counter_stream_unusual_s2mm_hls_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:counter_stream_unusual_s2mm_hls:1.0 counter_stream_unusual_s2mm_hls_0 ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net counter_stream_unusual_s2mm_hls_0_counter [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins counter_stream_unusual_s2mm_hls_0/counter]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins counter_stream_unusual_s2mm_hls_0/s_axi_cpuControl] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins counter_stream_unusual_s2mm_hls_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins counter_stream_unusual_s2mm_hls_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs counter_stream_unusual_s2mm_hls_0/s_axi_cpuControl/Reg] SEG_counter_stream_unusual_s2mm_hls_0_Reg
...
preplace inst counter_stream_unusual_s2mm_hls_0 -pg 1 -lvl 3 -y 410 -defaultsOSRD
