...
architecture behav of mm2s is 
    ...
    "mm2s,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=0,HLS_SYN_FF=1155,HLS_SYN_LUT=1187}";
    ...
    constant ap_ST_pp0_stg0_fsm_8 : STD_LOGIC_VECTOR (9 downto 0) := "0100000000";
    constant ap_ST_pp1_stg0_fsm_9 : STD_LOGIC_VECTOR (9 downto 0) := "1000000000";
    ...
    signal indvar_reg_149 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_reg_ppstg_indvar_reg_149_pp0_it1 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_sig_cseq_ST_pp0_stg0_fsm_8 : STD_LOGIC;
    signal ap_sig_bdd_214 : BOOLEAN;
    signal ap_reg_ppiten_pp0_it0 : STD_LOGIC := '0';
    signal exitcond4_reg_293 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_bdd_223 : BOOLEAN;
    signal ap_reg_ppiten_pp0_it1 : STD_LOGIC := '0';
    signal ap_reg_ppiten_pp0_it2 : STD_LOGIC := '0';
    signal j_reg_161 : STD_LOGIC_VECTOR (31 downto 0);
    signal offset_read_reg_243 : STD_LOGIC_VECTOR (31 downto 0);
    signal burst_size_read_reg_248 : STD_LOGIC_VECTOR (31 downto 0);
    signal num_of_burst_read_reg_254 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_fu_172_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_reg_259 : STD_LOGIC_VECTOR (29 downto 0);
    signal p_add_i32_shr_cast3_fu_176_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_add_i32_shr_cast3_reg_264 : STD_LOGIC_VECTOR (31 downto 0);
    signal next_mul_fu_180_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal next_mul_reg_269 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_cseq_ST_st2_fsm_1 : STD_LOGIC;
    signal ap_sig_bdd_253 : BOOLEAN;
    signal i_1_fu_190_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_1_reg_277 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_196_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_reg_282 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal exitcond4_fu_211_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_reg_ppstg_exitcond4_reg_293_pp0_it1 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_next_fu_216_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal indvar_next_reg_297 : STD_LOGIC_VECTOR (29 downto 0);
    signal memory_map_addr_read_reg_302 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal j_1_fu_232_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal indvar_phi_fu_153_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_2_fu_222_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_4_fu_238_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_3_fu_201_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (ap_sig_bdd_370) then
                    if (not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1)))) then 
                        ap_reg_ioackin_stream_V_TREADY <= ap_const_logic_0;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2)))) then 
                    ap_reg_ppiten_pp0_it0 <= ap_const_logic_0;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and (ap_const_lv1_0 = exitcond4_fu_211_p2))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_1;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2))))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond_fu_227_p2)))) then 
                    ap_reg_ppiten_pp1_it0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and (ap_const_lv1_0 = exitcond_fu_227_p2))) then 
                    ap_reg_ppiten_pp1_it1 <= ap_const_logic_1;
                elsif ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond_fu_227_p2))))) then 
                    ap_reg_ppiten_pp1_it1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond_fu_227_p2)))) then 
                i_reg_127 <= i_1_reg_277;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then 
                i_reg_127 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;

    -- indvar_reg_149 assign process. --
    indvar_reg_149_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (exitcond4_reg_293 = ap_const_lv1_0) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then 
                indvar_reg_149 <= indvar_next_reg_297;
            elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
                indvar_reg_149 <= ap_const_lv30_0;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2)))) then 
                j_reg_161 <= ap_const_lv32_0;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and (ap_const_lv1_0 = exitcond_fu_227_p2))) then 
                j_reg_161 <= j_1_fu_232_p2;
            end if; 
        end if;
    end process;

    -- phi_mul_reg_138 assign process. --
    phi_mul_reg_138_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond_fu_227_p2)))) then 
                phi_mul_reg_138 <= next_mul_reg_269;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then
                ap_reg_ppstg_exitcond4_reg_293_pp0_it1 <= exitcond4_reg_293;
                ap_reg_ppstg_indvar_reg_149_pp0_it1 <= indvar_reg_149;
                exitcond4_reg_293 <= exitcond4_fu_211_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then
                burst_size_read_reg_248 <= burst_size;
                num_of_burst_read_reg_254 <= num_of_burst;
                offset_read_reg_243 <= offset;
                    p_add_i32_shr_cast3_reg_264(29 downto 0) <= p_add_i32_shr_cast3_fu_176_p1(29 downto 0);
                tmp_reg_259 <= tmp_fu_172_p1;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))))) then
                exitcond_reg_307 <= exitcond_fu_227_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then
                i_1_reg_277 <= i_1_fu_190_p2;
                next_mul_reg_269 <= next_mul_fu_180_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then
                indvar_next_reg_297 <= indvar_next_fu_216_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (exitcond4_reg_293 = ap_const_lv1_0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then
                memory_map_addr_read_reg_302 <= memory_map_RDATA;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (ap_const_lv1_0 = exitcond3_fu_185_p2))) then
                tmp_1_reg_282 <= tmp_1_fu_196_p2;
            end if;
        end if;
    end process;
    p_add_i32_shr_cast3_reg_264(31 downto 30) <= "00";

    -- the next state (ap_NS_fsm) of the state machine. --
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_reg_ppiten_pp0_it0, ap_sig_bdd_223, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond3_fu_185_p2, ap_sig_ioackin_memory_map_ARREADY, exitcond4_fu_211_p2, exitcond_fu_227_p2, exitcond_reg_307, ap_reg_ppiten_pp1_it0, ap_sig_ioackin_stream_V_TREADY, ap_reg_ppiten_pp1_it1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_pp0_stg0_fsm_8 => 
                if ((not(((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))) and not(((ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2)) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))))) then
                    ap_NS_fsm <= ap_ST_pp0_stg0_fsm_8;
                elsif ((((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond4_fu_211_p2)) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then
                    ap_NS_fsm <= ap_ST_pp1_stg0_fsm_9;
                else
                    ap_NS_fsm <= ap_ST_pp0_stg0_fsm_8;
                end if;
            when ap_ST_pp1_stg0_fsm_9 => 
                if (not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond_fu_227_p2))))) then
                    ap_NS_fsm <= ap_ST_pp1_stg0_fsm_9;
                elsif (((ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond_fu_227_p2)))) then
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                else
                    ap_NS_fsm <= ap_ST_pp1_stg0_fsm_9;
                end if;
    ...
    ap_done_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond3_fu_185_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((ap_const_lv1_0 = exitcond3_fu_185_p2)))) then 
    ...
    ap_ready_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond3_fu_185_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((ap_const_lv1_0 = exitcond3_fu_185_p2)))) then 
    ...
    begin
                ap_sig_bdd_214 <= (ap_const_lv1_1 = ap_CS_fsm(8 downto 8));
    end process;


    -- ap_sig_bdd_223 assign process. --
    ap_sig_bdd_223_assign_proc : process(memory_map_RVALID, exitcond4_reg_293)
    begin
                ap_sig_bdd_223 <= ((memory_map_RVALID = ap_const_logic_0) and (exitcond4_reg_293 = ap_const_lv1_0));
    end process;
    ...
    begin
                ap_sig_bdd_253 <= (ap_const_lv1_1 = ap_CS_fsm(1 downto 1));
    end process;
    ...
    begin
                ap_sig_bdd_292 <= (ap_const_lv1_1 = ap_CS_fsm(9 downto 9));
    end process;
    ...
    ap_sig_bdd_370_assign_proc : process(exitcond_reg_307, ap_sig_cseq_ST_pp1_stg0_fsm_9, ap_reg_ppiten_pp1_it1)
    begin
                ap_sig_bdd_370 <= ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1));
    end process;


    -- ap_sig_cseq_ST_pp0_stg0_fsm_8 assign process. --
    ap_sig_cseq_ST_pp0_stg0_fsm_8_assign_proc : process(ap_sig_bdd_214)
    begin
    ...
    ap_sig_cseq_ST_pp1_stg0_fsm_9_assign_proc : process(ap_sig_bdd_292)
    begin
    ...
    ap_sig_cseq_ST_st2_fsm_1_assign_proc : process(ap_sig_bdd_253)
    begin
    ...
    ap_sig_cseq_ST_st3_fsm_2_assign_proc : process(ap_sig_bdd_269)
    begin
    ...
    ap_sig_cseq_ST_st8_fsm_7_assign_proc : process(ap_sig_bdd_318)
    begin
    ...
    buff_address0_assign_proc : process(ap_reg_ppiten_pp0_it2, ap_sig_cseq_ST_pp1_stg0_fsm_9, ap_reg_ppiten_pp1_it0, tmp_2_fu_222_p1, tmp_4_fu_238_p1)
    begin
        if ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2)) then 
            buff_address0 <= tmp_2_fu_222_p1(8 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0))) then 
            buff_address0 <= tmp_4_fu_238_p1(8 - 1 downto 0);
        else 
    ...
    buff_ce0_assign_proc : process(ap_sig_bdd_223, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond_reg_307, ap_sig_cseq_ST_pp1_stg0_fsm_9, ap_reg_ppiten_pp1_it0, ap_sig_ioackin_stream_V_TREADY, ap_reg_ppiten_pp1_it1)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_0 = ap_sig_ioackin_stream_V_TREADY) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))))) then 
    ...
    buff_d0 <= memory_map_addr_read_reg_302;

    -- buff_we0 assign process. --
    buff_we0_assign_proc : process(ap_sig_bdd_223, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, ap_reg_ppstg_exitcond4_reg_293_pp0_it1)
    begin
        if ((((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond4_reg_293_pp0_it1)))) then 
    ...
    exitcond3_fu_185_p2 <= "1" when (i_reg_127 = num_of_burst_read_reg_254) else "0";
    exitcond4_fu_211_p2 <= "1" when (indvar_phi_fu_153_p4 = tmp_reg_259) else "0";
    exitcond_fu_227_p2 <= "1" when (j_reg_161 = burst_size_read_reg_248) else "0";
    i_1_fu_190_p2 <= std_logic_vector(unsigned(i_reg_127) + unsigned(ap_const_lv32_1));
    indvar_next_fu_216_p2 <= std_logic_vector(unsigned(indvar_phi_fu_153_p4) + unsigned(ap_const_lv30_1));

    -- indvar_phi_fu_153_p4 assign process. --
    indvar_phi_fu_153_p4_assign_proc : process(indvar_reg_149, ap_sig_cseq_ST_pp0_stg0_fsm_8, exitcond4_reg_293, ap_reg_ppiten_pp0_it1, indvar_next_reg_297)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (exitcond4_reg_293 = ap_const_lv1_0) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) then 
            indvar_phi_fu_153_p4 <= indvar_next_reg_297;
        else 
            indvar_phi_fu_153_p4 <= indvar_reg_149;
        end if; 
    end process;

    j_1_fu_232_p2 <= std_logic_vector(unsigned(j_reg_161) + unsigned(ap_const_lv32_1));
    memory_map_ARADDR <= tmp_3_fu_201_p1(32 - 1 downto 0);
    memory_map_ARBURST <= ap_const_lv2_0;
    memory_map_ARCACHE <= ap_const_lv4_0;
    memory_map_ARID <= ap_const_lv1_0;
    memory_map_ARLEN <= p_add_i32_shr_cast3_reg_264;
    ...
    memory_map_ARVALID_assign_proc : process(ap_sig_cseq_ST_st3_fsm_2, ap_reg_ioackin_memory_map_ARREADY)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (ap_const_logic_0 = ap_reg_ioackin_memory_map_ARREADY))) then 
    ...
    memory_map_RREADY_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_8, exitcond4_reg_293, ap_sig_bdd_223, ap_reg_ppiten_pp0_it1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_8) and (exitcond4_reg_293 = ap_const_lv1_0) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and not((ap_sig_bdd_223 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then 
    ...
    next_mul_fu_180_p2 <= std_logic_vector(unsigned(phi_mul_reg_138) + unsigned(burst_size_read_reg_248));
    p_add_i32_shr_cast3_fu_176_p1 <= std_logic_vector(resize(unsigned(tmp_fu_172_p1),32));
    stream_V_TDATA <= buff_q0;

    -- stream_V_TVALID assign process. --
    stream_V_TVALID_assign_proc : process(exitcond_reg_307, ap_sig_cseq_ST_pp1_stg0_fsm_9, ap_reg_ppiten_pp1_it1, ap_reg_ioackin_stream_V_TREADY)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_9) and (ap_const_lv1_0 = exitcond_reg_307) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_logic_0 = ap_reg_ioackin_stream_V_TREADY))) then 
    ...
    tmp_1_fu_196_p2 <= std_logic_vector(unsigned(offset_read_reg_243) + unsigned(phi_mul_reg_138));
    tmp_2_fu_222_p1 <= std_logic_vector(resize(unsigned(ap_reg_ppstg_indvar_reg_149_pp0_it1),64));
        tmp_3_fu_201_p1 <= std_logic_vector(resize(signed(tmp_1_reg_282),64));

        tmp_4_fu_238_p1 <= std_logic_vector(resize(signed(j_reg_161),64));

    tmp_fu_172_p1 <= burst_size(30 - 1 downto 0);
end behav;
