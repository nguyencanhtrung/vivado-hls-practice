...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/testing/mm2s_dma/mm2s_dma.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log mm2s_sys_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mm2s_sys_wrapper.tcl -notrace
