...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/testing/mm2s_dma/mm2s_dma.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log mm2s_sys_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mm2s_sys_wrapper.tcl
