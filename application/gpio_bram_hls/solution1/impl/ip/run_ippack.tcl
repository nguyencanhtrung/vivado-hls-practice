...
set Library     "hls"
set IPName      "gpio_bram_hls"
set Version     "1.0"
set DisplayName "Gpio_bram_hls"
set Revision    "1605251515"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "gpio_bram_hls"
...
set Interfaces {
    s_axi_cpuControl {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_cpuControl"
        param_prefix "C_S_AXI_CPUCONTROL"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 C0 W 0x0 "Data signal of C0" {{0 32 C0 W 0 "Bit 31 to 0 Data signal of C0"}}} {0x18 rep W 0x0 "Data signal of rep" {{0 32 rep W 0 "Bit 31 to 0 Data signal of rep"}}} {0x20 inc W 0x0 "Data signal of inc" {{0 32 inc W 0 "Bit 31 to 0 Data signal of inc"}}} {0x28 index R 0x0 "Data signal of index" {{0 32 index R 0 "Bit 31 to 0 Data signal of index"}}} {0x2c index_ctrl R 0x0 "Control signal of index" {{0 1 index_ap_vld R 0 "Control signal index_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 counter R 0x0 "Data signal of counter" {{0 32 counter R 0 "Bit 31 to 0 Data signal of counter"}}} {0x34 counter_ctrl R 0x0 "Control signal of counter" {{0 1 counter_ap_vld R 0 "Control signal counter_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/home/ctnguyen/work/vivadohls/gpio_bram_hls/src/gpio_bram_hls.cpp}
if {$enable_xo_gen} {
