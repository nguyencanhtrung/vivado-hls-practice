...
//------------------------Instantiation------------------
// memcpyHW_m_request_preprocessor
memcpyHW_m_request_preprocessor #(
...
module memcpyHW_m_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module memcpyHW_m_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
