...
module memcpyHW_DATA_S_if (
    ...
    // User signals
    output wire [31:0] dataStream_V_dout,
    output wire        dataStream_V_empty_n,
    input  wire        dataStream_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [31:0] dataStream_V_din;
wire [0:0]  dataStream_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
// dataStream_V_fifo
memcpyHW_DATA_S_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) dataStream_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( dataStream_V_empty_n ),
    .full_n     ( dataStream_V_full_n ),
    .read       ( dataStream_V_read ),
    .write      ( fifo_write ),
    .dout       ( dataStream_V_dout ),
    .din        ( dataStream_V_din )
);
...
assign dataStream_V_din = m_data[31:0];
assign fifo_full_n      = dataStream_V_full_n;
...
module memcpyHW_DATA_S_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
