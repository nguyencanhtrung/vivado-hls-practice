...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 index R 0x0 "Data signal of index" {{0 32 index R 0 "Bit 31 to 0 Data signal of index"}}} {0x14 index_ctrl R 0x0 "Control signal of index" {{0 1 index_ap_vld R 0 "Control signal index_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_cpuControl {
        ...
        registers {{0x10 init W 0x0 "Data signal of init" {{0 32 init W 0 "Bit 31 to 0 Data signal of init"}}} {0x18 resolution W 0x0 "Data signal of resolution" {{0 32 resolution W 0 "Bit 31 to 0 Data signal of resolution"}}} {0x20 numWord W 0x0 "Data signal of numWord" {{0 32 numWord W 0 "Bit 31 to 0 Data signal of numWord"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_cpuControl counter"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
set enable_xo_gen 0
set kernel_files {/home/ctnguyen/work/vivadohls/counter_stream_hls/src/counter_stream_hls.cpp}
if {$enable_xo_gen} {
