...
.reset:                                           ; preds = %1
  ...
  %tmp_6 = add i5 %tmp_2_cast, %tmp_5
  %tmp_13_cast = sext i5 %tmp_6 to i64
  %res_addr = getelementptr [9 x i16]* %res, i64 0, i64 %tmp_13_cast
  %a_addr = getelementptr [3 x i24]* %a, i64 0, i64 %tmp
  %a_load = load i24* %a_addr, align 4
  %tmp_12 = trunc i24 %a_load to i8
  %tmp_s = sext i8 %tmp_12 to i16
  %b_addr = getelementptr [3 x i24]* %b, i64 0, i64 %tmp_2
  %b_load = load i24* %b_addr, align 4
  %tmp_13 = trunc i24 %b_load to i8
  %tmp_4 = sext i8 %tmp_13 to i16
  ...
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str3, i32 %tmp_3) nounwind
  %j_1 = add i2 1, %j_mid2
  br label %1
