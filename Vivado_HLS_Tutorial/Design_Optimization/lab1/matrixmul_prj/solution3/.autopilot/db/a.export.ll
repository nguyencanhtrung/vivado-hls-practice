...
.reset:                                           ; preds = %1
  ...
  %tmp_2_cast1 = zext i2 %j_mid2 to i5
  %tmp_2_cast9 = zext i2 %j_mid2 to i4
  %tmp_2_cast = zext i2 %j_mid2 to i3
  %b_addr = getelementptr [9 x i8]* %b, i64 0, i64 %tmp_2
  %tmp_s = add i3 %tmp_2_cast, 3
  %tmp_10_cast = zext i3 %tmp_s to i64
  %b_addr_1 = getelementptr [9 x i8]* %b, i64 0, i64 %tmp_10_cast
  %tmp_10 = add i4 %tmp_2_cast9, 6
  %tmp_11_cast = zext i4 %tmp_10 to i64
  %b_addr_2 = getelementptr [9 x i8]* %b, i64 0, i64 %tmp_11_cast
  %tmp_11 = add i5 %tmp_4, %tmp_2_cast1
  %tmp_12_cast = sext i5 %tmp_11 to i64
  %res_addr = getelementptr [9 x i16]* %res, i64 0, i64 %tmp_12_cast
  %a_addr = getelementptr [9 x i8]* %a, i64 0, i64 %tmp_4_cast
  ...
  %a_addr_1 = getelementptr [9 x i8]* %a, i64 0, i64 %tmp_8_cast
  ...
  %a_addr_2 = getelementptr [9 x i8]* %a, i64 0, i64 %tmp_9_cast
