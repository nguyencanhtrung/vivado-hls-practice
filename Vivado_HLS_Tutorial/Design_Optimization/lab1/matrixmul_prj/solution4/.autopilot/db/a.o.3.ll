; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution4/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  %exitcond = icmp eq i2 %j, -1, !dbg !70         ; [#uses=2 type=i1] [debug line = 56:25]
  ...
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str3) nounwind, !dbg !75 ; [debug line = 56:40]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str3) nounwind, !dbg !75 ; [#uses=1 type=i32] [debug line = 56:40]
  ...
  %j_1 = add i2 1, %j_mid2, !dbg !81              ; [#uses=1 type=i2] [debug line = 56:34]
  call void @llvm.dbg.value(metadata !{i2 %j_1}, i64 0, metadata !82), !dbg !81 ; [debug line = 56:34] [debug variable = j]
  br label %1
...
!70 = metadata !{i32 56, i32 25, metadata !71, null}
!71 = metadata !{i32 786443, metadata !72, i32 56, i32 12, metadata !37, i32 3} ; [ DW_TAG_lexical_block ]
...
!74 = metadata !{i32 786443, metadata !71, i32 56, i32 39, metadata !37, i32 4} ; [ DW_TAG_lexical_block ]
!75 = metadata !{i32 56, i32 40, metadata !74, null}
...
!81 = metadata !{i32 56, i32 34, metadata !71, null}
