; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution1/.autopilot/db/a.g.1.bc'
...
; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !50 ; [debug line = 59:47]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !50 ; [#uses=1 type=i32] [debug line = 59:47]
  %tmp.4 = sext i32 %k to i64, !dbg !52           ; [#uses=2 type=i64] [debug line = 60:13]
  %a.addr = getelementptr inbounds [3 x i8]* %a, i64 %tmp, i64 %tmp.4, !dbg !52 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load = load i8* %a.addr, align 1, !dbg !52   ; [#uses=2 type=i8] [debug line = 60:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %a.load) nounwind
  %tmp.5 = sext i8 %a.load to i16, !dbg !52       ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr = getelementptr inbounds [3 x i8]* %b, i64 %tmp.4, i64 %tmp.2, !dbg !52 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load = load i8* %b.addr, align 1, !dbg !52   ; [#uses=2 type=i8] [debug line = 60:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %b.load) nounwind
  %tmp.6 = sext i8 %b.load to i16, !dbg !52       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7 = mul i16 %tmp.6, %tmp.5, !dbg !52       ; [#uses=1 type=i16] [debug line = 60:13]
  %res.load = load i16* %res.addr, align 2, !dbg !52 ; [#uses=2 type=i16] [debug line = 60:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %res.load) nounwind
  %tmp.8 = add i16 %res.load, %tmp.7, !dbg !52    ; [#uses=1 type=i16] [debug line = 60:13]
  store i16 %tmp.8, i16* %res.addr, align 2, !dbg !52 ; [debug line = 60:13]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !53 ; [#uses=0 type=i32] [debug line = 61:10]
...
; <label>:7                                       ; preds = %5
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !56 ; [#uses=0 type=i32] [debug line = 62:7]
  %j.1 = add nsw i32 %j, 1, !dbg !57              ; [#uses=1 type=i32] [debug line = 56:34]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !58), !dbg !57 ; [debug line = 56:34] [debug variable = j]
  br label %3, !dbg !57                           ; [debug line = 56:34]

; <label>:8                                       ; preds = %3
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !59 ; [#uses=0 type=i32] [debug line = 63:4]
  %i.1 = add nsw i32 %i, 1, !dbg !60              ; [#uses=1 type=i32] [debug line = 54:31]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !61), !dbg !60 ; [debug line = 54:31] [debug variable = i]
  br label %1, !dbg !60                           ; [debug line = 54:31]

; <label>:9                                       ; preds = %1
  ret void, !dbg !62                              ; [debug line = 65:1]
}
...
!49 = metadata !{i32 786443, metadata !44, i32 59, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
...
!52 = metadata !{i32 60, i32 13, metadata !51, null}
!53 = metadata !{i32 61, i32 10, metadata !51, null}
...
!56 = metadata !{i32 62, i32 7, metadata !44, null}
!57 = metadata !{i32 56, i32 34, metadata !45, null}
!58 = metadata !{i32 786688, metadata !45, metadata !"j", metadata !6, i32 56, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!59 = metadata !{i32 63, i32 4, metadata !42, null}
!60 = metadata !{i32 54, i32 31, metadata !40, null}
!61 = metadata !{i32 786688, metadata !40, metadata !"i", metadata !6, i32 54, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!62 = metadata !{i32 65, i32 1, metadata !36, null}
