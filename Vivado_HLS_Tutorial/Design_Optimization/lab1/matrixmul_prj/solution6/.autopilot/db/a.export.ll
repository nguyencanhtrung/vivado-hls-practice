...
define void @matrixmul([3 x i24]* %a, [3 x i24]* %b, [9 x i16]* %res) {
  ...
  %tmp_2 = trunc i24 %a_load to i8
  %tmp_s = sext i8 %tmp_2 to i16
  %b_addr = getelementptr [3 x i24]* %b, i64 0, i64 0
  %b_load = load i24* %b_addr, align 4
  %tmp_3 = trunc i24 %b_load to i8
  %tmp_7 = sext i8 %tmp_3 to i16
  %tmp_12 = mul i16 %tmp_7, %tmp_s
  %tmp_5 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %a_load, i32 8, i32 15)
  %tmp_5_0_0_1 = sext i8 %tmp_5 to i16
  %tmp_6 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b_load, i32 8, i32 15)
  %tmp_6_0_0_1 = sext i8 %tmp_6 to i16
  %tmp_7_0_0_1 = mul i16 %tmp_6_0_0_1, %tmp_5_0_0_1
  %tmp_8 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %a_load, i32 16, i32 23)
  %tmp_5_0_0_2 = sext i8 %tmp_8 to i16
  %tmp_9 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b_load, i32 16, i32 23)
  %tmp_6_0_0_2 = sext i8 %tmp_9 to i16
  ...
  %tmp_7_0_1 = mul i16 %tmp_6_0_1, %tmp_s
  %tmp_1 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b_load_1, i32 8, i32 15)
  %tmp_6_0_1_1 = sext i8 %tmp_1 to i16
  %tmp_7_0_1_1 = mul i16 %tmp_6_0_1_1, %tmp_5_0_0_1
  %tmp_4 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b_load_1, i32 16, i32 23)
  %tmp_6_0_1_2 = sext i8 %tmp_4 to i16
  ...
  %tmp_7_0_2 = mul i16 %tmp_6_0_2, %tmp_s
