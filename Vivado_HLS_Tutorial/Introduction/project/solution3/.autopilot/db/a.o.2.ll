; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Introduction/project/solution3/.autopilot/db/a.o.2.bc'
...
define void @fir(i32* %y, [11 x i32]* %c, i32 %x) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !53), !dbg !54 ; [debug line = 68:7] [debug variable = data]
...
!2 = metadata !{i32 786473, metadata !"lab1/fir.c", metadata !"/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Introduction", null} ; [ DW_TAG_file_type ]
...
!14 = metadata !{i32 786484, i32 0, metadata !1, metadata !"shift_reg", metadata !"shift_reg", metadata !"", metadata !2, i32 57, metadata !15, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!48 = metadata !{i32 786443, metadata !49, i32 64, i32 44, metadata !2, i32 2} ; [ DW_TAG_lexical_block ]
!49 = metadata !{i32 786443, metadata !44, i32 64, i32 21, metadata !2, i32 1} ; [ DW_TAG_lexical_block ]
...
!53 = metadata !{i32 786688, metadata !44, metadata !"data", metadata !2, i32 60, metadata !6, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!54 = metadata !{i32 68, i32 7, metadata !52, null}
