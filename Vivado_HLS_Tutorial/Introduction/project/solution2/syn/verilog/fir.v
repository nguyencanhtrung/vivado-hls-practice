...
(* CORE_GENERATION_INFO="fir,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.520000,HLS_SYN_LAT=89,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=213,HLS_SYN_LUT=193}" *)
...
reg  signed [31:0] i_cast_reg_203;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_bdd_75;
wire   [0:0] tmp_1_fu_150_p2;
reg   [0:0] tmp_1_reg_212;
wire   [0:0] tmp_fu_142_p3;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_bdd_94;
wire   [4:0] i_1_fu_179_p2;
reg   [4:0] i_1_reg_231;
wire   [31:0] acc_1_fu_191_p2;
...
/// assign process. ///
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & (tmp_1_reg_212 == ap_const_lv1_0))) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_fu_142_p3) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(tmp_fu_142_p3 == ap_const_lv1_0))) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_150_p2 or tmp_fu_142_p3 or ap_sig_cseq_ST_st3_fsm_2 or tmp_3_fu_166_p1 or tmp_4_fu_171_p1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_150_p2 or tmp_fu_142_p3 or ap_sig_cseq_ST_st3_fsm_2) begin
...
always @ (x_in_sig or shift_reg_q0 or ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_150_p2 or tmp_fu_142_p3 or ap_sig_cseq_ST_st3_fsm_2) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_150_p2 or tmp_1_reg_212 or tmp_fu_142_p3 or ap_sig_cseq_ST_st3_fsm_2) begin
    if ((((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & (tmp_1_reg_212 == ap_const_lv1_0)) | ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_142_p3 == ap_const_lv1_0) & ~(tmp_1_fu_150_p2 == ap_const_lv1_0)))) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_65 or tmp_fu_142_p3) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
...
assign acc_1_fu_191_p2 = (grp_fu_185_p2 + acc_reg_103);

/// ap_sig_bdd_117 assign process. ///
always @ (ap_CS_fsm) begin
    ap_sig_bdd_117 = (ap_const_lv1_1 == ap_CS_fsm[ap_const_lv32_8]);
end
...
always @ (ap_start or x_ap_vld_in_sig) begin
    ap_sig_bdd_65 = ((x_ap_vld_in_sig == ap_const_logic_0) | (ap_start == ap_const_logic_0));
end
...
assign tmp_3_fu_166_p1 = tmp_2_fu_160_p2;
assign tmp_4_fu_171_p1 = $unsigned(i_cast_reg_203);
assign tmp_5_fu_175_p1 = $unsigned(i_cast_reg_203);
