...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_6_U1->din0(c_q0);
    fir_mul_32s_32s_32_6_U1->din1(data1_reg_128);
    fir_mul_32s_32s_32_6_U1->ce(grp_fu_185_ce);
    fir_mul_32s_32s_32_6_U1->dout(grp_fu_185_p2);
    ...
    sc_trace(mVcdFile, i_cast_reg_203, "i_cast_reg_203");
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_212.read(), ap_const_lv1_0))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        i_1_reg_231 = i_1_fu_179_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        i_cast_reg_203 = i_cast_fu_138_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_142_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_212 = tmp_1_fu_150_p2.read();
    }
}

void fir::thread_acc_1_fu_191_p2() {
    acc_1_fu_191_p2 = (!grp_fu_185_p2.read().is_01() || !acc_reg_103.read().is_01())? sc_lv<32>(): (sc_biguint<32>(grp_fu_185_p2.read()) + sc_biguint<32>(acc_reg_103.read()));
}
...
void fir::thread_ap_sig_bdd_117() {
    ap_sig_bdd_117 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(8, 8));
}
...
void fir::thread_ap_sig_bdd_65() {
    ap_sig_bdd_65 = (esl_seteq<1,1,1>(x_ap_vld_in_sig.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0));
}
...
void fir::thread_tmp_4_fu_171_p1() {
    tmp_4_fu_171_p1 = esl_zext<64,32>(i_cast_reg_203.read());
}

void fir::thread_tmp_5_fu_175_p1() {
    tmp_5_fu_175_p1 = esl_zext<64,32>(i_cast_reg_203.read());
}
