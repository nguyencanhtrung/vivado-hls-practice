; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/C_Validation/proj_c_valid/solution1/.autopilot/db/a.o.2.bc'
...
.preheader:                                       ; preds = %0, %.preheader.preheader
  %i_1 = phi i9 [ %i, %0 ], [ 0, %.preheader.preheader ]
...
; <label>:0                                       ; preds = %.preheader
  ...
  %tmp_s = zext i9 %i_1 to i64
  %window_coeff_addr = getelementptr [256 x i14]* @window_coeff, i64 0, i64 %tmp_s
  %window_coeff_load = load i14* %window_coeff_addr, align 2
  %tmp_3 = zext i14 %window_coeff_load to i32
  %indata_addr = getelementptr [256 x i16]* %indata, i64 0, i64 %tmp_s
  %indata_load = load i16* %indata_addr, align 2
  %tmp_4 = sext i16 %indata_load to i32
  %tmp_5 = mul nsw i32 %tmp_4, %tmp_3
  %outdata_addr = getelementptr [256 x i32]* %outdata, i64 0, i64 %tmp_s
  store i32 %tmp_5, i32* %outdata_addr, align 4
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str2, i32 %tmp_2) nounwind
  br label %.preheader
