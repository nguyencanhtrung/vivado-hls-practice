; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %p_shl_cast = zext i4 %tmp_9 to i5, !dbg !49    ; [#uses=1 type=i5] [debug line = 60:13]
  %tmp_s = sub i5 %p_shl_cast, %tmp_cast, !dbg !49 ; [#uses=2 type=i5] [debug line = 60:13]
  br label %3, !dbg !54                           ; [debug line = 56:25]

; <label>:3                                       ; preds = %7, %2
  %j = phi i2 [ 0, %2 ], [ %j_1, %7 ]             ; [#uses=3 type=i2]
  %exitcond1 = icmp eq i2 %j, -1, !dbg !54        ; [#uses=1 type=i1] [debug line = 56:25]
  %empty_2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  %j_1 = add i2 %j, 1, !dbg !55                   ; [#uses=1 type=i2] [debug line = 56:34]
  br i1 %exitcond1, label %8, label %4, !dbg !54  ; [debug line = 56:25]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_2_cast = zext i2 %j to i5, !dbg !57        ; [#uses=2 type=i5] [debug line = 57:10]
  %tmp_2 = add i5 %tmp_s, %tmp_2_cast, !dbg !57   ; [#uses=1 type=i5] [debug line = 57:10]
  %tmp_11_cast = sext i5 %tmp_2 to i64, !dbg !57  ; [#uses=1 type=i64] [debug line = 57:10]
  %res_addr = getelementptr [9 x i16]* %res, i64 0, i64 %tmp_11_cast, !dbg !57 ; [#uses=1 type=i16*] [debug line = 57:10]
  br label %5, !dbg !58                           ; [debug line = 59:32]

; <label>:5                                       ; preds = %6, %4
  %res_load = phi i16 [ 0, %4 ], [ %tmp_8, %6 ]   ; [#uses=2 type=i16]
  %k = phi i2 [ 0, %4 ], [ %k_1, %6 ]             ; [#uses=4 type=i2]
  store i16 %res_load, i16* %res_addr, align 2, !dbg !49 ; [debug line = 60:13]
  ...
  br i1 %exitcond, label %7, label %6, !dbg !58   ; [debug line = 59:32]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @p_str2) nounwind, !dbg !60 ; [debug line = 59:47]
  %tmp_4_cast = zext i2 %k to i5, !dbg !49        ; [#uses=2 type=i5] [debug line = 60:13]
  %tmp_4 = add i5 %tmp_s, %tmp_4_cast, !dbg !49   ; [#uses=1 type=i5] [debug line = 60:13]
  %tmp_12_cast = sext i5 %tmp_4 to i64, !dbg !49  ; [#uses=1 type=i64] [debug line = 60:13]
  %a_addr = getelementptr [9 x i8]* %a, i64 0, i64 %tmp_12_cast, !dbg !49 ; [#uses=1 type=i8*] [debug line = 60:13]
  %tmp_10 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %k, i2 0) ; [#uses=1 type=i4]
  %p_shl1_cast = zext i4 %tmp_10 to i5, !dbg !49  ; [#uses=1 type=i5] [debug line = 60:13]
  %tmp_11 = sub i5 %p_shl1_cast, %tmp_4_cast, !dbg !49 ; [#uses=1 type=i5] [debug line = 60:13]
  %tmp_12 = add i5 %tmp_11, %tmp_2_cast, !dbg !49 ; [#uses=1 type=i5] [debug line = 60:13]
  %tmp_15_cast = sext i5 %tmp_12 to i64, !dbg !49 ; [#uses=1 type=i64] [debug line = 60:13]
  %b_addr = getelementptr [9 x i8]* %b, i64 0, i64 %tmp_15_cast, !dbg !49 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a_load = load i8* %a_addr, align 1, !dbg !49   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp_5 = sext i8 %a_load to i16, !dbg !49       ; [#uses=1 type=i16] [debug line = 60:13]
  %b_load = load i8* %b_addr, align 1, !dbg !49   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp_6 = sext i8 %b_load to i16, !dbg !49       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp_7 = mul i16 %tmp_6, %tmp_5, !dbg !49       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp_8 = add i16 %tmp_7, %res_load, !dbg !49    ; [#uses=1 type=i16] [debug line = 60:13]
...
; <label>:7                                       ; preds = %5
  ...
  call void @llvm.dbg.value(metadata !{i2 %j_1}, i64 0, metadata !64), !dbg !55 ; [debug line = 56:34] [debug variable = j]
...
!49 = metadata !{i32 60, i32 13, metadata !50, null}
!50 = metadata !{i32 786443, metadata !51, i32 59, i32 46, metadata !16, i32 6} ; [ DW_TAG_lexical_block ]
!51 = metadata !{i32 786443, metadata !52, i32 59, i32 19, metadata !16, i32 5} ; [ DW_TAG_lexical_block ]
!52 = metadata !{i32 786443, metadata !53, i32 56, i32 39, metadata !16, i32 4} ; [ DW_TAG_lexical_block ]
!53 = metadata !{i32 786443, metadata !48, i32 56, i32 12, metadata !16, i32 3} ; [ DW_TAG_lexical_block ]
!54 = metadata !{i32 56, i32 25, metadata !53, null}
!55 = metadata !{i32 56, i32 34, metadata !53, null}
!56 = metadata !{i32 56, i32 40, metadata !52, null}
!57 = metadata !{i32 57, i32 10, metadata !52, null}
!58 = metadata !{i32 59, i32 32, metadata !51, null}
!59 = metadata !{i32 59, i32 41, metadata !51, null}
!60 = metadata !{i32 59, i32 47, metadata !50, null}
!61 = metadata !{i32 786688, metadata !51, metadata !"k", metadata !16, i32 59, metadata !62, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!62 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!63 = metadata !{i32 62, i32 7, metadata !52, null}
!64 = metadata !{i32 786688, metadata !53, metadata !"j", metadata !16, i32 56, metadata !62, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
