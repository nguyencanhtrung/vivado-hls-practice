; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution2/.autopilot/db/a.o.2.bc'
...
; <label>:3                                       ; preds = %1
  ...
  br label %4, !dbg !85                           ; [debug line = 56:24]

; <label>:4                                       ; preds = %6, %3
  %j = phi i2 [ 0, %3 ], [ %j.1, %6 ]             ; [#uses=3 type=i2]
  %exitcond1 = icmp eq i2 %j, -1, !dbg !85        ; [#uses=1 type=i1] [debug line = 56:24]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1, label %8, label %6, !dbg !85  ; [debug line = 56:24]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @.str3) nounwind, !dbg !86 ; [debug line = 56:39]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str3) nounwind, !dbg !86 ; [#uses=1 type=i32] [debug line = 56:39]
  ...
  %j.1 = add i2 %j, 1, !dbg !89                   ; [#uses=1 type=i2] [debug line = 56:33]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !90), !dbg !89 ; [debug line = 56:33] [debug variable = j]
  br label %4, !dbg !89                           ; [debug line = 56:33]
...
!80 = metadata !{i32 786443, metadata !81, i32 56, i32 38, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!81 = metadata !{i32 786443, metadata !78, i32 56, i32 11, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
...
!85 = metadata !{i32 56, i32 24, metadata !81, null}
!86 = metadata !{i32 56, i32 39, metadata !80, null}
!87 = metadata !{i32 57, i32 1, metadata !80, null}
!88 = metadata !{i32 64, i32 7, metadata !80, null}
!89 = metadata !{i32 56, i32 33, metadata !81, null}
