; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution3/.autopilot/db/a.o.2.bc'
...
; <label>:1                                       ; preds = %8, %0
  ...
  br i1 %exitcond2, label %10, label %3, !dbg !53 ; [debug line = 54:22]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i2 %i to i64, !dbg !58              ; [#uses=4 type=i64] [debug line = 57:10]
  %a.addr = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 0, !dbg !61 ; [#uses=1 type=i8*] [debug line = 62:13]
  %a.addr.1 = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 1, !dbg !61 ; [#uses=1 type=i8*] [debug line = 62:13]
  %a.addr.2 = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 2, !dbg !61 ; [#uses=1 type=i8*] [debug line = 62:13]
  br label %4, !dbg !64                           ; [debug line = 56:25]

; <label>:4                                       ; preds = %6, %3
  %j = phi i2 [ 0, %3 ], [ %j.1, %6 ]             ; [#uses=3 type=i2]
  %exitcond1 = icmp eq i2 %j, -1, !dbg !64        ; [#uses=1 type=i1] [debug line = 56:25]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1, label %8, label %6, !dbg !64  ; [debug line = 56:25]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @.str1) nounwind, !dbg !65 ; [debug line = 56:40]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str1) nounwind, !dbg !65 ; [#uses=1 type=i32] [debug line = 56:40]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !66 ; [debug line = 57:1]
  %tmp.2 = zext i2 %j to i64, !dbg !58            ; [#uses=4 type=i64] [debug line = 57:10]
  %res.addr = getelementptr [3 x [3 x i16]]* %res, i64 0, i64 %tmp, i64 %tmp.2, !dbg !58 ; [#uses=1 type=i16*] [debug line = 57:10]
  %a.load = load i8* %a.addr, align 1, !dbg !61   ; [#uses=1 type=i8] [debug line = 62:13]
  %tmp.5 = sext i8 %a.load to i16, !dbg !61       ; [#uses=1 type=i16] [debug line = 62:13]
  %b.addr = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 0, i64 %tmp.2, !dbg !61 ; [#uses=1 type=i8*] [debug line = 62:13]
  %b.load = load i8* %b.addr, align 1, !dbg !61   ; [#uses=1 type=i8] [debug line = 62:13]
  %tmp.6 = sext i8 %b.load to i16, !dbg !61       ; [#uses=1 type=i16] [debug line = 62:13]
  %tmp.7 = mul i16 %tmp.6, %tmp.5, !dbg !61       ; [#uses=1 type=i16] [debug line = 62:13]
  %a.load.1 = load i8* %a.addr.1, align 1, !dbg !61 ; [#uses=1 type=i8] [debug line = 62:13]
  %tmp.5.1 = sext i8 %a.load.1 to i16, !dbg !61   ; [#uses=1 type=i16] [debug line = 62:13]
  %b.addr.1 = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 1, i64 %tmp.2, !dbg !61 ; [#uses=1 type=i8*] [debug line = 62:13]
  %b.load.1 = load i8* %b.addr.1, align 1, !dbg !61 ; [#uses=1 type=i8] [debug line = 62:13]
  %tmp.6.1 = sext i8 %b.load.1 to i16, !dbg !61   ; [#uses=1 type=i16] [debug line = 62:13]
  %tmp.7.1 = mul i16 %tmp.6.1, %tmp.5.1, !dbg !61 ; [#uses=1 type=i16] [debug line = 62:13]
  %a.load.2 = load i8* %a.addr.2, align 1, !dbg !61 ; [#uses=1 type=i8] [debug line = 62:13]
  %tmp.5.2 = sext i8 %a.load.2 to i16, !dbg !61   ; [#uses=1 type=i16] [debug line = 62:13]
  %b.addr.2 = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 2, i64 %tmp.2, !dbg !61 ; [#uses=1 type=i8*] [debug line = 62:13]
  %b.load.2 = load i8* %b.addr.2, align 1, !dbg !61 ; [#uses=1 type=i8] [debug line = 62:13]
  %tmp.6.2 = sext i8 %b.load.2 to i16, !dbg !61   ; [#uses=1 type=i16] [debug line = 62:13]
  %tmp.7.2 = mul i16 %tmp.6.2, %tmp.5.2, !dbg !61 ; [#uses=1 type=i16] [debug line = 62:13]
  %tmp1 = add i16 %tmp.7.2, %tmp.7, !dbg !61      ; [#uses=1 type=i16] [debug line = 62:13]
  %tmp.8.2 = add i16 %tmp.7.1, %tmp1, !dbg !61    ; [#uses=1 type=i16] [debug line = 62:13]
  store i16 %tmp.8.2, i16* %res.addr, align 2, !dbg !61 ; [debug line = 62:13]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.3) nounwind, !dbg !67 ; [#uses=0 type=i32] [debug line = 64:7]
  %j.1 = add i2 %j, 1, !dbg !68                   ; [#uses=1 type=i2] [debug line = 56:34]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !69), !dbg !68 ; [debug line = 56:34] [debug variable = j]
  br label %4, !dbg !68                           ; [debug line = 56:34]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str, i32 %tmp.1) nounwind, !dbg !70 ; [#uses=0 type=i32] [debug line = 65:4]
  %i.1 = add i2 %i, 1, !dbg !71                   ; [#uses=1 type=i2] [debug line = 54:31]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !72), !dbg !71 ; [debug line = 54:31] [debug variable = i]
  br label %1, !dbg !71                           ; [debug line = 54:31]

; <label>:10                                      ; preds = %1
  ret void, !dbg !73                              ; [debug line = 67:1]
}
...
!61 = metadata !{i32 62, i32 13, metadata !62, null}
!62 = metadata !{i32 786443, metadata !63, i32 59, i32 46, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!63 = metadata !{i32 786443, metadata !59, i32 59, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!64 = metadata !{i32 56, i32 25, metadata !60, null}
!65 = metadata !{i32 56, i32 40, metadata !59, null}
!66 = metadata !{i32 57, i32 1, metadata !59, null}
!67 = metadata !{i32 64, i32 7, metadata !59, null}
!68 = metadata !{i32 56, i32 34, metadata !60, null}
!69 = metadata !{i32 786688, metadata !60, metadata !"j", metadata !6, i32 56, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!70 = metadata !{i32 65, i32 4, metadata !57, null}
!71 = metadata !{i32 54, i32 31, metadata !54, null}
!72 = metadata !{i32 786688, metadata !54, metadata !"i", metadata !6, i32 54, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!73 = metadata !{i32 67, i32 1, metadata !55, null}
