...
duc_imf2::duc_imf2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    duc_mac_muladd_18s_18s_38ns_38_4_U1 = new duc_mac_muladd_18s_18s_38ns_38_4<1,4,18,18,38,38>("duc_mac_muladd_18s_18s_38ns_38_4_U1");
    duc_mac_muladd_18s_18s_38ns_38_4_U1->clk(ap_clk);
    duc_mac_muladd_18s_18s_38ns_38_4_U1->reset(ap_rst);
    duc_mac_muladd_18s_18s_38ns_38_4_U1->din0(in_2);
    duc_mac_muladd_18s_18s_38ns_38_4_U1->din1(c_2_load_reg_278);
    duc_mac_muladd_18s_18s_38ns_38_4_U1->din2(s_assign_reg_330);
    duc_mac_muladd_18s_18s_38ns_38_4_U1->ce(grp_fu_250_ce);
    duc_mac_muladd_18s_18s_38ns_38_4_U1->dout(grp_fu_250_p3);
    ...
    sensitive << ( ap_sig_cseq_ST_st2_fsm_1 );
    sensitive << ( tmp_16_fu_122_p1 );
    sensitive << ( tmp_14_fu_185_p1 );
    sensitive << ( ap_sig_cseq_ST_st7_fsm_6 );
    ...
    SC_METHOD(thread_tmp_13_fu_179_p3);
    sensitive << ( i_2_load_reg_257 );
    sensitive << ( ch_2_load_reg_283 );

    SC_METHOD(thread_tmp_14_fu_185_p1);
    sensitive << ( tmp_13_fu_179_p3 );

    SC_METHOD(thread_tmp_15_fu_115_p3);
    sensitive << ( ch_2 );
    sensitive << ( inc_reg_267 );

    SC_METHOD(thread_tmp_16_fu_122_p1);
    sensitive << ( tmp_15_fu_115_p3 );
    ...
    sc_trace(mVcdFile, tmp_16_fu_122_p1, "tmp_16_fu_122_p1");
    sc_trace(mVcdFile, tmp_14_fu_185_p1, "tmp_14_fu_185_p1");
    ...
    sc_trace(mVcdFile, tmp_15_fu_115_p3, "tmp_15_fu_115_p3");
    ...
    sc_trace(mVcdFile, tmp_13_fu_179_p3, "tmp_13_fu_179_p3");
...
duc_imf2::~duc_imf2() {
    ...
    delete duc_mac_muladd_18s_18s_38ns_38_4_U1;
}
...
void duc_imf2::thread_s_assign_fu_172_p3() {
    s_assign_fu_172_p3 = (!tmp_20_fu_168_p2.read()[0].is_01())? sc_lv<38>(): ((tmp_20_fu_168_p2.read()[0].to_bool())? ap_const_lv38_0: shift_reg_p_2_load_reg_310.read());
}
...
void duc_imf2::thread_shift_reg_p_2_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st7_fsm_6.read())) {
        shift_reg_p_2_address0 =  (sc_lv<5>) (tmp_14_fu_185_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        shift_reg_p_2_address0 =  (sc_lv<5>) (tmp_16_fu_122_p1.read());
    } else {
...
void duc_imf2::thread_tmp_13_fu_179_p3() {
    tmp_13_fu_179_p3 = esl_concat<4,1>(i_2_load_reg_257.read(), ch_2_load_reg_283.read());
}

void duc_imf2::thread_tmp_14_fu_185_p1() {
    tmp_14_fu_185_p1 = esl_zext<64,5>(tmp_13_fu_179_p3.read());
}

void duc_imf2::thread_tmp_15_fu_115_p3() {
    tmp_15_fu_115_p3 = esl_concat<4,1>(inc_reg_267.read(), ch_2.read());
}

void duc_imf2::thread_tmp_16_fu_122_p1() {
    tmp_16_fu_122_p1 = esl_zext<64,5>(tmp_15_fu_115_p3.read());
}

void duc_imf2::thread_tmp_20_fu_168_p2() {
    tmp_20_fu_168_p2 = (sel_tmp5_reg_315.read() | init_2.read());
}

void duc_imf2::thread_tmp_21_fu_194_p2() {
    tmp_21_fu_194_p2 = (!cnt_1.read().is_01() || !ap_const_lv2_3.is_01())? sc_lv<1>(): sc_lv<1>(cnt_1.read() == ap_const_lv2_3);
}
...
void duc_imf2::thread_tmp_23_fu_217_p2() {
    tmp_23_fu_217_p2 = (!cnt_1.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(cnt_1.read()) + sc_biguint<2>(ap_const_lv2_1));
}
