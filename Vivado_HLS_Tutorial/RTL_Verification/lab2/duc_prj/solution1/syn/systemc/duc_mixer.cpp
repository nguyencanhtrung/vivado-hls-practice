...
duc_mixer::duc_mixer(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U10->din0(grp_fu_335_p0);
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U10->din1(grp_fu_335_p1);
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U10->din2(sine_reg_419);
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U10->din3(tmp_2_reg_456);
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U10->ce(grp_fu_335_ce);
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U10->dout(grp_fu_335_p4);
    ...
    duc_am_submul_16s_16s_18s_32_4_U11->din0(sine_reg_419);
    duc_am_submul_16s_16s_18s_32_4_U11->din1(cosine_reg_425);
    duc_am_submul_16s_16s_18s_32_4_U11->din2(Din);
    duc_am_submul_16s_16s_18s_32_4_U11->ce(grp_fu_344_ce);
    duc_am_submul_16s_16s_18s_32_4_U11->dout(grp_fu_344_p3);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12 = new duc_ama_addmuladd_18s_18s_16s_32s_32_3<1,3,18,18,16,32,32>("duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12");
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->clk(ap_clk);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->reset(ap_rst);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->din0(grp_fu_352_p0);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->din1(grp_fu_352_p1);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->din2(cosine_reg_425);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->din3(tmp_2_reg_456);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->ce(grp_fu_352_ce);
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12->dout(grp_fu_352_p4);
    ...
    sc_trace(mVcdFile, grp_fu_352_p4, "grp_fu_352_p4");
...
duc_mixer::~duc_mixer() {
    ...
    delete duc_ama_addmuladd_18s_18s_16s_32s_32_3_U12;
}
...
void duc_mixer::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st8_fsm_7.read())) {
        tmp_2_reg_456 = grp_fu_344_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        tmp_3_reg_467 = grp_fu_352_p4.read();
        tmp_7_reg_462 = grp_fu_335_p4.read();
    }
}
...
void duc_mixer::thread_grp_fu_335_p0() {
    grp_fu_335_p0 =  (sc_lv<18>) (tmp_i5_fu_247_p1.read());
}

void duc_mixer::thread_grp_fu_335_p1() {
    grp_fu_335_p1 =  (sc_lv<18>) (tmp_i6_fu_250_p1.read());
}
...
void duc_mixer::thread_grp_fu_352_ce() {
    grp_fu_352_ce = ap_const_logic_1;
}

void duc_mixer::thread_grp_fu_352_p0() {
    grp_fu_352_p0 =  (sc_lv<18>) (tmp_i6_fu_250_p1.read());
}

void duc_mixer::thread_grp_fu_352_p1() {
    grp_fu_352_p1 =  (sc_lv<18>) (tmp_i5_fu_247_p1.read());
}
