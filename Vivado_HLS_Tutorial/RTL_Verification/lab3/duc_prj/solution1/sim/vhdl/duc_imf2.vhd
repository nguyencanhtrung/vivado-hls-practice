...
architecture behav of duc_imf2 is 
    ...
    signal tmp_16_fu_122_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_14_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_15_fu_115_p3 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_13_fu_179_p3 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    duc_mac_muladd_18s_18s_38ns_38_4_U1 : component duc_mac_muladd_18s_18s_38ns_38_4
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 18,
    ...
    shift_reg_p_2_address0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_16_fu_122_p1, tmp_14_fu_185_p1, ap_sig_cseq_ST_st7_fsm_6)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then 
            shift_reg_p_2_address0 <= tmp_14_fu_185_p1(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
            shift_reg_p_2_address0 <= tmp_16_fu_122_p1(5 - 1 downto 0);
        else 
    ...
    tmp_13_fu_179_p3 <= (i_2_load_reg_257 & ch_2_load_reg_283);
    tmp_14_fu_185_p1 <= std_logic_vector(resize(unsigned(tmp_13_fu_179_p3),64));
    tmp_15_fu_115_p3 <= (inc_reg_267 & ch_2);
    tmp_16_fu_122_p1 <= std_logic_vector(resize(unsigned(tmp_15_fu_115_p3),64));
    tmp_20_fu_168_p2 <= (sel_tmp5_reg_315 or init_2);
    tmp_21_fu_194_p2 <= "1" when (cnt_1 = ap_const_lv2_3) else "0";
    tmp_22_fu_206_p2 <= (ch_2_load_reg_283 xor ap_const_lv1_1);
    tmp_23_fu_217_p2 <= std_logic_vector(unsigned(cnt_1) + unsigned(ap_const_lv2_1));
