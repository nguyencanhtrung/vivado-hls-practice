...
define internal fastcc void @duc_mixer(i16 zeroext %freq, i18 signext %Din, i18* nocapture %Dout_I, i18* nocapture %Dout_Q) nounwind uwtable {
  ...
  %tmp_14 = call i2 @_ssdm_op_PartSelect.i2.i3.i32.i32(i3 %i_4_load, i32 1, i32 2)
...
; <label>:3                                       ; preds = %2
  ...
  %tmp_58_i = zext i5 %phase2 to i64
  %dds_table_addr_1 = getelementptr inbounds [32 x i16]* @dds_table, i64 0, i64 %tmp_58_i
  ...
  %tmp_1 = sub i17 %tmp_i3_cast, %tmp_i4_cast
  %tmp_i_i = sext i18 %Din_read to i32
  %tmp_i_i_10 = sext i17 %tmp_1 to i32
  %tmp_2 = mul i32 %tmp_i_i_10, %tmp_i_i
  %tmp_i5 = sext i18 %Din_re to i19
  %tmp_i6 = sext i18 %Din_read to i19
  %tmp_4 = sub i19 %tmp_i5, %tmp_i6
  %tmp_i_i8_cast = sext i16 %sine to i32
  %tmp_i_i9_cast = sext i19 %tmp_4 to i32
  %m = mul i32 %tmp_i_i9_cast, %tmp_i_i8_cast
  %tmp_7 = add i32 %m, %tmp_2
  %tmp_9 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_7, i32 14, i32 31)
  call void @_ssdm_op_Write.ap_auto.i18P(i18* %Dout_I, i18 %tmp_9) nounwind
  %tmp_5 = add i19 %tmp_i6, %tmp_i5
  %tmp_i_i1_cast = sext i16 %cosine to i32
  %tmp_i_i1_cast_11 = sext i19 %tmp_5 to i32
  %m_i_i = mul i32 %tmp_i_i1_cast_11, %tmp_i_i1_cast
  %tmp_3 = add i32 %m_i_i, %tmp_2
  %tmp_6 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_3, i32 14, i32 31)
  call void @_ssdm_op_Write.ap_auto.i18P(i18* %Dout_Q, i18 %tmp_6) nounwind
  %tmp_8 = icmp eq i4 %index_load, -1
  br i1 %tmp_8, label %4, label %._crit_edge2
...
; <label>:6                                       ; preds = %5
  %tmp_11 = xor i1 %ch_3_load, true
  store i1 %tmp_11, i1* @ch_3, align 1
...
._crit_edge4:                                     ; preds = %7, %._crit_edge3
  %tmp_13 = icmp eq i3 %i_4_load, -3
  %inc_1 = select i1 %tmp_13, i3 0, i3 %inc
  store i3 %inc_1, i3* @i_4, align 1
  ret void
}
...
._crit_edge_ifconv:                               ; preds = %1, %0
  ...
  %tmp_14 = icmp eq i6 %i_3_load, 5
  %or_cond = or i1 %init_3_load, %tmp_14
  %tmp_6 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %i_3_load, i1 %ch_4)
  %tmp_7 = zext i7 %tmp_6 to i64
  %shift_reg_p0_addr_1 = getelementptr [12 x i38]* @shift_reg_p0, i64 0, i64 %tmp_7
  %shift_reg_p1_addr_1 = getelementptr [12 x i38]* @shift_reg_p1, i64 0, i64 %tmp_7
  %tmp_8 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %inc, i1 %ch_4)
  %tmp_9 = zext i7 %tmp_8 to i64
  %shift_reg_p0_addr = getelementptr [12 x i38]* @shift_reg_p0, i64 0, i64 %tmp_9
  %shift_reg_p1_addr = getelementptr [12 x i38]* @shift_reg_p1, i64 0, i64 %tmp_9
  ...
  %m = mul nsw i36 %tmp_i, %tmp_i_12
  %tmp_23_i = sext i36 %m to i38
  %acc0 = add i38 %tmp_23_i, %tmp_15
  ...
  %tmp_23_i6 = sext i35 %m_1 to i38
  %acc1 = add i38 %tmp_23_i6, %tmp_16
  store i38 %acc0, i38* %shift_reg_p0_addr_1, align 8
  store i38 %acc1, i38* %shift_reg_p1_addr_1, align 8
  %tmp_10 = call i18 @_ssdm_op_PartSelect.i18.i38.i32.i32(i38 %acc0, i32 17, i32 34)
  %tmp_11 = call i18 @_ssdm_op_PartSelect.i18.i38.i32.i32(i38 %acc1, i32 17, i32 34)
  %tmp_12 = select i1 %tmp, i18 %tmp_10, i18 %tmp_11
...
._crit_edge_ifconv:                               ; preds = %1, %0
  ...
  %tmp_13 = call i5 @_ssdm_op_BitConcatenate.i5.i4.i1(i4 %i_2_load, i1 %ch_2_load)
  %tmp_14 = zext i5 %tmp_13 to i64
  %shift_reg_p_2_addr_1 = getelementptr [26 x i38]* @shift_reg_p_2, i64 0, i64 %tmp_14
  %tmp_15 = call i5 @_ssdm_op_BitConcatenate.i5.i4.i1(i4 %inc, i1 %ch_2_load)
  %tmp_16 = zext i5 %tmp_15 to i64
  %shift_reg_p_2_addr = getelementptr [26 x i38]* @shift_reg_p_2, i64 0, i64 %tmp_16
  ...
  %tmp_20 = or i1 %sel_tmp5, %init_2_load
  %s_assign = select i1 %tmp_20, i38 0, i38 %shift_reg_p_2_load
  %tmp_i = sext i18 %c_2_load to i36
  %tmp_i_13 = sext i18 %in_2_load to i36
  %m = mul nsw i36 %tmp_i_13, %tmp_i
  %tmp_21_i = sext i36 %m to i38
  %sum = add nsw i38 %s_assign, %tmp_21_i
...
; <label>:2                                       ; preds = %._crit_edge_ifconv
  ...
  %tmp_21 = icmp eq i2 %cnt_1_load, -1
...
._crit_edge9:                                     ; preds = %._crit_edge10, %2
  %tmp_23 = add i2 %cnt_1_load, 1
  store i2 %tmp_23, i2* @cnt_1, align 1
...
._crit_edge_ifconv.i:                             ; preds = %1, %0
  %inc = add i6 %i_load, 1
  %tmp_6_i = zext i6 %i_load to i64
  %c_addr = getelementptr inbounds [48 x i18]* @c, i64 0, i64 %tmp_6_i
  %c_load = load i18* %c_addr, align 4
  %in_load = load i18* @in_r, align 4
  %init_load = load i1* @init, align 1
  %ch_load = load i1* @ch, align 1
  %tmp_17 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %i_load, i1 %ch_load)
  %tmp_18 = zext i7 %tmp_17 to i64
  %shift_reg_p_addr_1 = getelementptr [96 x i38]* @shift_reg_p, i64 0, i64 %tmp_18
  %tmp_19 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %inc, i1 %ch_load)
  %tmp_20 = zext i7 %tmp_19 to i64
  %shift_reg_p_addr = getelementptr [96 x i38]* @shift_reg_p, i64 0, i64 %tmp_20
  ...
  %tmp_9_i = select i1 %tmp, i38 0, i38 %shift_reg_p_load
  %tmp_i_i = sext i18 %c_load to i36
  %tmp_1_i_i = sext i18 %in_load to i36
  %m = mul nsw i36 %tmp_1_i_i, %tmp_i_i
  %tmp_2_i_i = sext i36 %m to i38
  %acc_1 = add i38 %tmp_9_i, %tmp_2_i_i
...
._crit_edge9.i:                                   ; preds = %3, %2
  %tmp_4_i = xor i1 %ch_load, true
  store i1 %tmp_4_i, i1* @ch, align 1
  br label %srrc.exit
...
srrc.exit:                                        ; preds = %._crit_edge9.i, %._crit_edge_ifconv.i
  ...
  br i1 %tmp_i1, label %4, label %._crit_edge_ifconv.i13

; <label>:4                                       ; preds = %srrc.exit
  store i18 %srrc_o, i18* @in_1, align 4
  br label %._crit_edge_ifconv.i13

._crit_edge_ifconv.i13:                           ; preds = %4, %srrc.exit
  %inc_5 = add i5 %i_1_load, 1
  %tmp_i_14 = zext i5 %i_1_load to i64
  %c_1_addr = getelementptr inbounds [24 x i18]* @c_1, i64 0, i64 %tmp_i_14
  ...
  %tmp_21 = call i6 @_ssdm_op_BitConcatenate.i6.i5.i1(i5 %i_1_load, i1 %ch_1_load)
  %tmp_23 = zext i6 %tmp_21 to i64
  %shift_reg_p_1_addr = getelementptr [50 x i38]* @shift_reg_p_1, i64 0, i64 %tmp_23
  %tmp_s = call i6 @_ssdm_op_BitConcatenate.i6.i5.i1(i5 %inc_5, i1 %ch_1_load)
  %tmp_24 = zext i6 %tmp_s to i64
  %shift_reg_p_1_addr_1 = getelementptr [50 x i38]* @shift_reg_p_1, i64 0, i64 %tmp_24
  %shift_reg_p_1_load = load i38* %shift_reg_p_1_addr_1, align 8
  %sel_tmp1_i6 = icmp eq i5 %i_1_load, -9
  %sel_tmp2_i7 = icmp eq i5 %i_1_load, 11
  %sel_tmp3_i8 = xor i1 %init_1_load, true
  %sel_tmp4_i9 = or i1 %sel_tmp1_i6, %sel_tmp2_i7
  %sel_tmp5_i1 = and i1 %sel_tmp4_i9, %sel_tmp3_i8
  %tmp_22 = or i1 %sel_tmp5_i1, %init_1_load
  %s_assign = select i1 %tmp_22, i38 0, i38 %shift_reg_p_1_load
  %tmp_i_i1 = sext i18 %c_1_load to i36
  %tmp_i_i_15 = sext i18 %in_1_load to i36
  %m_2 = mul nsw i36 %tmp_i_i_15, %tmp_i_i1
  %tmp_22_i_i = sext i36 %m_2 to i38
  %sum = add nsw i38 %s_assign, %tmp_22_i_i
  store i38 %sum, i38* %shift_reg_p_1_addr, align 8
  br i1 %sel_tmp1_i6, label %5, label %imf1.exit

; <label>:5                                       ; preds = %._crit_edge_ifconv.i13
  br i1 %ch_1_load, label %6, label %._crit_edge9.i14

; <label>:6                                       ; preds = %5
  store i1 false, i1* @init_1, align 1
  br label %._crit_edge9.i14

._crit_edge9.i14:                                 ; preds = %6, %5
  %cnt_load = load i1* @cnt, align 1
  %tmp_41_i = xor i1 %ch_1_load, %cnt_load
  store i1 %tmp_41_i, i1* @ch_1, align 1
  %tmp_42_i = xor i1 %cnt_load, true
  store i1 %tmp_42_i, i1* @cnt, align 1
  br label %imf1.exit
...
imf1.exit:                                        ; preds = %._crit_edge9.i14, %._crit_edge_ifconv.i13
  ...
  %inc_6 = select i1 %sel_tmp1_i6, i5 0, i5 %inc_5
  store i5 %inc_6, i5* @i_1, align 1
...
entry:
  ...
  %empty_16 = trunc i16 %empty to i5
  ret i5 %empty_16
}
...
entry:
  ...
  %empty_18 = trunc i38 %empty to i18
  ret i18 %empty_18
}
...
entry:
  ...
  %empty_19 = trunc i32 %empty to i18
  ret i18 %empty_19
}
...
entry:
  ...
  %empty_20 = shl i6 1, %empty
  %empty_21 = and i6 %0, %empty_20
  %empty_22 = icmp ne i6 %empty_21, 0
  ret i1 %empty_22
}
...
entry:
  ...
  %empty_26 = zext i1 %1 to i6
  %empty_27 = shl i6 %empty, 1
  %empty_28 = or i6 %empty_27, %empty_26
  ret i6 %empty_28
}
...
entry:
  ...
  %empty_29 = zext i1 %1 to i5
  %empty_30 = shl i5 %empty, 1
...
entry:
  ...
  %empty_32 = zext i17 %1 to i35
  %empty_33 = shl i35 %empty, 17
  %empty_34 = or i35 %empty_33, %empty_32
  ret i35 %empty_34
}
