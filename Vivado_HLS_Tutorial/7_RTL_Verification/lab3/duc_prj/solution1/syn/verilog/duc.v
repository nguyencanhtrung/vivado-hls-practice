...
(* CORE_GENERATION_INFO="duc,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=2.710000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.710000,HLS_SYN_LAT=32,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=7,HLS_SYN_FF=1601,HLS_SYN_LUT=630}" *)
...
reg    ap_sig_bdd_33;
reg   [5:0] i = 6'b000000;
reg  signed [17:0] in_r = 18'b000000000000000000;
wire   [5:0] c_address0;
reg    c_ce0;
wire   [17:0] c_q0;
reg   [0:0] init = 1'b1;
...
reg  signed [17:0] in_1 = 18'b000000000000000000;
...
reg   [5:0] inc_reg_603;
reg  signed [17:0] c_load_reg_614;
...
wire   [37:0] tmp_9_i_fu_357_p3;
reg   [37:0] tmp_9_i_reg_666;
...
reg  signed [17:0] c_1_load_reg_698;
reg    ap_sig_cseq_ST_st8_fsm_7;
reg    ap_sig_bdd_173;
reg   [0:0] ch_1_load_reg_703;
wire   [0:0] sel_tmp1_i6_fu_456_p2;
reg   [0:0] sel_tmp1_i6_reg_714;
wire   [0:0] sel_tmp2_i7_fu_461_p2;
reg   [0:0] sel_tmp2_i7_reg_720;
...
wire   [63:0] tmp_6_i_fu_291_p1;
wire   [63:0] tmp_20_fu_307_p1;
wire   [63:0] tmp_18_fu_370_p1;
wire   [63:0] tmp_i_14_fu_435_p1;
wire   [63:0] tmp_24_fu_451_p1;
wire   [63:0] tmp_23_fu_514_p1;
wire   [5:0] inc_4_fu_401_p3;
wire   [0:0] tmp_i_fu_273_p2;
wire   [0:0] tmp_4_i_fu_381_p2;
wire   [4:0] inc_6_fu_562_p3;
wire   [0:0] tmp_i1_fu_417_p2;
wire   [0:0] tmp_41_i_fu_529_p2;
wire   [0:0] tmp_42_i_fu_540_p2;
wire   [6:0] tmp_19_fu_300_p3;
wire   [0:0] sel_tmp4_i_fu_336_p2;
wire   [0:0] sel_tmp3_i_fu_330_p2;
wire   [0:0] tmp_fu_353_p2;
wire   [6:0] tmp_17_fu_364_p3;
wire   [5:0] tmp_s_fu_444_p3;
wire   [0:0] sel_tmp4_i9_fu_480_p2;
wire   [0:0] sel_tmp3_i8_fu_474_p2;
wire   [0:0] tmp_22_fu_497_p2;
wire   [5:0] tmp_21_fu_508_p3;
wire    grp_fu_574_ce;
wire    grp_fu_581_ce;
reg   [16:0] ap_NS_fsm;
...
duc_mac_muladd_18s_18s_38ns_38_4_U19(
    ...
    .reset( ap_rst ),
    .din0( in_1 ),
    .din1( c_1_load_reg_698 ),
    .din2( s_assign_reg_750 ),
    .ce( grp_fu_574_ce ),
    .dout( grp_fu_574_p3 )
);
...
duc_mac_muladd_18s_18s_38ns_38_4 #(
    ...
    .din2_WIDTH( 38 ),
    .dout_WIDTH( 38 ))
duc_mac_muladd_18s_18s_38ns_38_4_U20(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( in_r ),
    .din1( c_load_reg_614 ),
    .din2( tmp_9_i_reg_666 ),
    .ce( grp_fu_581_ce ),
    .dout( grp_fu_581_p3 )
);
...
always @ (posedge ap_clk) begin : ap_ret_grp_duc_imf2_fu_249_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin : ap_ret_grp_duc_imf3_fu_204_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin : ap_ret_grp_duc_mixer_fu_225_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st8_fsm_7)) begin
        ...
        sel_tmp1_i6_reg_714 <= sel_tmp1_i6_fu_456_p2;
        sel_tmp2_i7_reg_720 <= sel_tmp2_i7_fu_461_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6) & ~(ap_const_lv1_0 == sel_tmp1_i_reg_630))) begin
        ch <= tmp_4_i_fu_381_p2;
    end
end

/// assign process. ///
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st13_fsm_12) & ~(ap_const_lv1_0 == sel_tmp1_i6_reg_714))) begin
        ch_1 <= tmp_41_i_fu_529_p2;
        cnt <= tmp_42_i_fu_540_p2;
    end
end
...
/// assign process. ///
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st13_fsm_12) & ~(ap_const_lv1_0 == sel_tmp1_i6_reg_714) & ~(ap_const_lv1_0 == ch_1_load_reg_703))) begin
...
always @ (posedge ap_clk) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3)) begin
        tmp_9_i_reg_666 <= tmp_9_i_fu_357_p3;
    end
end

/// ap_done assign process. ///
always @ (grp_duc_mixer_fu_225_ap_done or ap_sig_cseq_ST_st17_fsm_16) begin
...
always @ (ap_sig_cseq_ST_st8_fsm_7 or ap_sig_cseq_ST_st13_fsm_12 or tmp_24_fu_451_p1 or tmp_23_fu_514_p1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st13_fsm_12)) begin
        shift_reg_p_1_address0 = tmp_23_fu_514_p1;
    end else if ((ap_const_logic_1 == ap_sig_cseq_ST_st8_fsm_7)) begin
        shift_reg_p_1_address0 = tmp_24_fu_451_p1;
    end else begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or ap_sig_cseq_ST_st7_fsm_6 or tmp_20_fu_307_p1 or tmp_18_fu_370_p1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6)) begin
        shift_reg_p_address0 = tmp_18_fu_370_p1;
    end else if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
        shift_reg_p_address0 = tmp_20_fu_307_p1;
    end else begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or ap_sig_cseq_ST_st7_fsm_6) begin
...
always @ (ap_start or ap_CS_fsm or grp_duc_imf2_fu_249_ap_done or grp_duc_imf3_fu_204_ap_done or grp_duc_mixer_fu_225_ap_done) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
...
assign c_1_address0 = tmp_i_14_fu_435_p1;
assign c_address0 = tmp_6_i_fu_291_p1;
...
assign inc_5_fu_429_p2 = (i_1 + ap_const_lv5_1);
assign inc_6_fu_562_p3 = ((sel_tmp1_i6_reg_714[0:0] === 1'b1) ? ap_const_lv5_0 : inc_5_reg_687);
assign inc_fu_285_p2 = (i + ap_const_lv6_1);
assign s_assign_fu_501_p3 = ((tmp_22_fu_497_p2[0:0] === 1'b1) ? ap_const_lv38_0 : shift_reg_p_1_load_reg_730);
assign sel_tmp1_i6_fu_456_p2 = (i_1_load_reg_677 == ap_const_lv5_17? 1'b1: 1'b0);
assign sel_tmp1_i_fu_312_p2 = (i_load_reg_593 == ap_const_lv6_2F? 1'b1: 1'b0);
assign sel_tmp2_i7_fu_461_p2 = (i_1_load_reg_677 == ap_const_lv5_B? 1'b1: 1'b0);
assign sel_tmp2_i_fu_317_p2 = (i_load_reg_593 == ap_const_lv6_17? 1'b1: 1'b0);
assign sel_tmp3_i8_fu_474_p2 = (init_1 ^ ap_const_lv1_1);
assign sel_tmp3_i_fu_330_p2 = (init ^ ap_const_lv1_1);
assign sel_tmp4_i9_fu_480_p2 = (sel_tmp1_i6_reg_714 | sel_tmp2_i7_reg_720);
assign sel_tmp4_i_fu_336_p2 = (sel_tmp1_i_reg_630 | sel_tmp2_i_reg_636);
assign sel_tmp5_i1_fu_484_p2 = (sel_tmp4_i9_fu_480_p2 & sel_tmp3_i8_fu_474_p2);
...
assign tmp_17_fu_364_p3 = {{i_load_reg_593}, {ch_load_reg_619}};
assign tmp_18_fu_370_p1 = tmp_17_fu_364_p3;
assign tmp_19_fu_300_p3 = {{inc_reg_603}, {ch}};
assign tmp_20_fu_307_p1 = tmp_19_fu_300_p3;
assign tmp_21_fu_508_p3 = {{i_1_load_reg_677}, {ch_1_load_reg_703}};
assign tmp_22_fu_497_p2 = (sel_tmp5_i1_reg_735 | init_1);
assign tmp_23_fu_514_p1 = tmp_21_fu_508_p3;
assign tmp_24_fu_451_p1 = tmp_s_fu_444_p3;
assign tmp_41_i_fu_529_p2 = (ch_1_load_reg_703 ^ cnt);
assign tmp_42_i_fu_540_p2 = (cnt ^ ap_const_lv1_1);
assign tmp_4_i_fu_381_p2 = (ch_load_reg_619 ^ ap_const_lv1_1);
assign tmp_6_i_fu_291_p1 = i;
assign tmp_9_i_fu_357_p3 = ((tmp_fu_353_p2[0:0] === 1'b1) ? ap_const_lv38_0 : shift_reg_p_load_reg_646);
assign tmp_fu_353_p2 = (sel_tmp5_i_reg_651 | init);
assign tmp_i1_fu_417_p2 = (i_1 == ap_const_lv5_0? 1'b1: 1'b0);
assign tmp_i_14_fu_435_p1 = i_1;
assign tmp_i_fu_273_p2 = (i == ap_const_lv6_0? 1'b1: 1'b0);
assign tmp_s_fu_444_p3 = {{inc_5_reg_687}, {ch_1}};
