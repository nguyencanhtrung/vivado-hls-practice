; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Design_Analysis/lab1/dct_prj/solution3/.autopilot/db/a.o.2.bc'
...
.preheader7:                                      ; preds = %.preheader7.preheader
  ...
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_mid2, i3 0)
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_mid2, i3 0)
...
define internal fastcc void @dct_dct_1d2([64 x i16]* nocapture %src, i4 %tmp_2, [64 x i16]* nocapture %dst, i4 %tmp_21) {
  ...
  %src_addr = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_9
  %tmp_10 = or i7 %tmp_8, 1
  %tmp_11 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_10)
  %src_addr_1 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_11
  %tmp_12 = or i7 %tmp_8, 2
  %tmp_13 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_12)
  %src_addr_2 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_13
  %tmp_14 = or i7 %tmp_8, 3
  %tmp_15 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_14)
  %src_addr_3 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_15
  %tmp_16 = or i7 %tmp_8, 4
  %tmp_17 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_16)
  %src_addr_4 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_17
  %tmp_18 = or i7 %tmp_8, 5
  %tmp_19 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_18)
  %src_addr_5 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_19
  %tmp_20 = or i7 %tmp_8, 6
  %tmp_22 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_20)
  %src_addr_6 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_22
  %tmp_23 = or i7 %tmp_8, 7
  %tmp_24 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_23)
  %src_addr_7 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_24
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_25 = add i8 %tmp_18_cast, %tmp_cast
  %tmp_36_cast = zext i8 %tmp_25 to i64
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_36_cast
...
.reset:                                           ; preds = %1
  ...
  %tmp_s = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i_mid2, i3 0)
  %tmp_38_cast = zext i7 %tmp_s to i8
  ...
  %tmp_i_11 = zext i6 %tmp_9_i to i64
  %input_addr = getelementptr [64 x i16]* %input_r, i64 0, i64 %tmp_i_11
  %input_load = load i16* %input_addr, align 2
  %tmp_1_i_cast = zext i4 %c_i_mid2 to i8
  %tmp_26 = add i8 %tmp_38_cast, %tmp_1_i_cast
  %tmp_39_cast = zext i8 %tmp_26 to i64
  %buf_2d_in_addr = getelementptr [64 x i16]* %buf_2d_in, i64 0, i64 %tmp_39_cast
  store i16 %input_load, i16* %buf_2d_in_addr, align 2
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_10_i) nounwind
  %c = add i4 1, %c_i_mid2
  br label %1
...
; <label>:2                                       ; preds = %read_data.exit, %.reset11
  %indvar_flatten2 = phi i7 [ 0, %read_data.exit ], [ %indvar_flatten_next2, %.reset11 ]
  %r_i2 = phi i4 [ 0, %read_data.exit ], [ %r_i2_mid2, %.reset11 ]
  %c_i6 = phi i4 [ 0, %read_data.exit ], [ %c_1, %.reset11 ]
...
.reset11:                                         ; preds = %2
  ...
  %r_i2_mid2 = select i1 %exitcond_i1, i4 %r_1, i4 %r_i2
  %tmp_27 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i2_mid2, i3 0)
  %tmp_41_cast = zext i7 %tmp_27 to i8
  %tmp_1 = trunc i4 %r_i2_mid2 to i3
  %tmp_1_i5 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_1, i3 0)
  ...
  %tmp_28 = add i8 %tmp_41_cast, %tmp_3_i_cast
  %tmp_43_cast = zext i8 %tmp_28 to i64
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i64 0, i64 %tmp_43_cast
  ...
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str12, i32 %tmp_6_i) nounwind
...
entry:
  ...
  %empty_19 = zext i7 %1 to i64
  %empty_20 = shl i64 %empty, 7
