...
(* CORE_GENERATION_INFO="dct,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.930000,HLS_SYN_LAT=508,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=8,HLS_SYN_FF=1243,HLS_SYN_LUT=634}" *)
...
wire   [5:0] tmp_4_i_fu_301_p2;
reg   [5:0] tmp_4_i_reg_336;
...
reg    ap_sig_bdd_338;
wire   [63:0] tmp_20_cast_fu_296_p1;
wire   [63:0] tmp_5_i_fu_313_p1;
wire   [0:0] exitcond_i3_fu_236_p2;
wire   [3:0] r_fu_230_p2;
wire   [6:0] tmp_fu_258_p3;
wire   [2:0] tmp_5_fu_270_p1;
wire   [3:0] c_i_mid2_fu_242_p3;
wire   [7:0] tmp_18_cast_fu_266_p1;
wire   [7:0] tmp_3_i_cast_fu_286_p1;
wire   [7:0] tmp_s_fu_290_p2;
wire   [5:0] c_i_cast2_fu_282_p1;
wire   [5:0] tmp_1_i_fu_274_p3;
...
always @ (posedge ap_clk) begin : ap_ret_grp_dct_dct_2d_fu_167_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin : ap_ret_grp_dct_read_data_fu_196_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (exitcond_flatten_fu_218_p2 == ap_const_lv1_0))) begin
        tmp_4_i_reg_336 <= tmp_4_i_fu_301_p2;
    end
end
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_0_address0 or grp_dct_read_data_fu_196_buf_0_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_0_ce0 or grp_dct_read_data_fu_196_buf_0_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_0_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_1_address0 or grp_dct_read_data_fu_196_buf_1_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_1_ce0 or grp_dct_read_data_fu_196_buf_1_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_1_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_2_address0 or grp_dct_read_data_fu_196_buf_2_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_2_ce0 or grp_dct_read_data_fu_196_buf_2_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_2_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_3_address0 or grp_dct_read_data_fu_196_buf_3_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_3_ce0 or grp_dct_read_data_fu_196_buf_3_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_3_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_4_address0 or grp_dct_read_data_fu_196_buf_4_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_4_ce0 or grp_dct_read_data_fu_196_buf_4_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_4_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_5_address0 or grp_dct_read_data_fu_196_buf_5_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_5_ce0 or grp_dct_read_data_fu_196_buf_5_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_5_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_6_address0 or grp_dct_read_data_fu_196_buf_6_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_6_ce0 or grp_dct_read_data_fu_196_buf_6_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_6_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_7_address0 or grp_dct_read_data_fu_196_buf_7_address0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_in_block_7_ce0 or grp_dct_read_data_fu_196_buf_7_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (grp_dct_read_data_fu_196_buf_7_we0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
...
always @ (ap_sig_cseq_ST_pp0_stg0_fsm_4 or ap_reg_ppiten_pp0_it0 or ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_out_block_address0 or tmp_20_cast_fu_296_p1) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it0))) begin
        buf_2d_out_address0 = tmp_20_cast_fu_296_p1;
    end else if ((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3)) begin
...
always @ (ap_sig_cseq_ST_pp0_stg0_fsm_4 or ap_reg_ppiten_pp0_it0 or ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_out_block_ce0) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it0))) begin
...
always @ (ap_sig_cseq_ST_st4_fsm_3 or grp_dct_dct_2d_fu_167_out_block_we0) begin
...
always @ (grp_dct_read_data_fu_196_input_r_ce0 or ap_sig_cseq_ST_st2_fsm_1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1)) begin
        input_r_ce0 = grp_dct_read_data_fu_196_input_r_ce0;
    end else begin
...
always @ (ap_sig_cseq_ST_pp0_stg0_fsm_4 or ap_reg_ppiten_pp0_it1) begin
...
always @ (exitcond_flatten_reg_317 or ap_sig_cseq_ST_pp0_stg0_fsm_4 or ap_reg_ppiten_pp0_it1) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & (exitcond_flatten_reg_317 == ap_const_lv1_0))) begin
...
always @ (r_i_reg_145 or exitcond_flatten_reg_317 or ap_sig_cseq_ST_pp0_stg0_fsm_4 or ap_reg_ppiten_pp0_it1 or r_i_mid2_reg_326) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & (exitcond_flatten_reg_317 == ap_const_lv1_0))) begin
...
always @ (ap_start or ap_CS_fsm or exitcond_flatten_fu_218_p2 or ap_reg_ppiten_pp0_it0 or grp_dct_dct_2d_fu_167_ap_done or grp_dct_read_data_fu_196_ap_done) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
...
assign c_fu_307_p2 = (ap_const_lv4_1 + c_i_mid2_fu_242_p3);
assign c_i_cast2_fu_282_p1 = c_i_mid2_fu_242_p3;
assign c_i_mid2_fu_242_p3 = ((exitcond_i3_fu_236_p2[0:0] === 1'b1) ? ap_const_lv4_0 : c_i_reg_156);
assign exitcond_flatten_fu_218_p2 = (indvar_flatten_reg_134 == ap_const_lv7_40? 1'b1: 1'b0);
assign exitcond_i3_fu_236_p2 = (c_i_reg_156 == ap_const_lv4_8? 1'b1: 1'b0);
...
assign output_r_address0 = tmp_5_i_fu_313_p1;
assign output_r_d0 = buf_2d_out_q0;
assign r_fu_230_p2 = (ap_const_lv4_1 + r_i_phi_fu_149_p4);
assign r_i_mid2_fu_250_p3 = ((exitcond_i3_fu_236_p2[0:0] === 1'b1) ? r_fu_230_p2 : r_i_phi_fu_149_p4);
assign tmp_18_cast_fu_266_p1 = tmp_fu_258_p3;
assign tmp_1_i_fu_274_p3 = {{tmp_5_fu_270_p1}, {ap_const_lv3_0}};
assign tmp_20_cast_fu_296_p1 = tmp_s_fu_290_p2;
assign tmp_3_i_cast_fu_286_p1 = c_i_mid2_fu_242_p3;
assign tmp_4_i_fu_301_p2 = (c_i_cast2_fu_282_p1 + tmp_1_i_fu_274_p3);
assign tmp_5_fu_270_p1 = r_i_mid2_fu_250_p3[2:0];
assign tmp_5_i_fu_313_p1 = tmp_4_i_reg_336;
assign tmp_fu_258_p3 = {{r_i_mid2_fu_250_p3}, {ap_const_lv3_0}};
assign tmp_s_fu_290_p2 = (tmp_18_cast_fu_266_p1 + tmp_3_i_cast_fu_286_p1);
