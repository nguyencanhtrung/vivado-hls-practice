...
architecture behav of dct_dct_2d is 
    ...
    signal tmp_4_fu_483_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_4_reg_643 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal i_3_mid2_fu_540_p3 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal grp_dct_dct_1d_fu_361_tmp_2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal grp_dct_dct_1d_fu_361_tmp_21 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_6_cast_fu_478_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_493_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_14_cast_fu_578_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_11_cast_fu_609_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond_fu_434_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_2_fu_428_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_1_mid2_fu_440_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_fu_460_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_3_cast_fu_468_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_cast_fu_456_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_6_fu_472_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal exitcond1_fu_534_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_3_fu_528_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_2_fu_560_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_4_cast_fu_556_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_13_cast_fu_568_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_fu_572_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_8_fu_589_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_cast_fu_600_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_10_cast_fu_596_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_603_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    col_inbuf_0_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_0)))) then 
    ...
    col_inbuf_1_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_1)))) then 
    ...
    col_inbuf_2_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_2)))) then 
    ...
    col_inbuf_3_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_3)))) then 
    ...
    col_inbuf_4_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_4)))) then 
    ...
    col_inbuf_5_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_5)))) then 
    ...
    col_inbuf_6_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_643 = ap_const_lv3_6)))) then 
    ...
    col_inbuf_7_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and not((tmp_4_reg_643 = ap_const_lv3_6)) and not((tmp_4_reg_643 = ap_const_lv3_5)) and not((tmp_4_reg_643 = ap_const_lv3_4)) and not((tmp_4_reg_643 = ap_const_lv3_3)) and not((tmp_4_reg_643 = ap_const_lv3_2)) and not((tmp_4_reg_643 = ap_const_lv3_1)) and not((tmp_4_reg_643 = ap_const_lv3_0))))) then 
    ...
    col_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_pp1_stg0_fsm_6, ap_reg_ppiten_pp1_it0, grp_dct_dct_1d_fu_361_dst_address0, ap_sig_cseq_ST_st7_fsm_5, tmp_14_cast_fu_578_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0))) then 
            col_outbuf_address0 <= tmp_14_cast_fu_578_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_5)) then 
    ...
    exitcond1_fu_534_p2 <= "1" when (i_3_reg_350 = ap_const_lv4_8) else "0";
    ...
    exitcond_fu_434_p2 <= "1" when (i_1_reg_305 = ap_const_lv4_8) else "0";
    ...
    grp_dct_dct_1d_fu_361_tmp_2_assign_proc : process(i_reg_271, ap_sig_cseq_ST_st3_fsm_2, i_2_reg_316, ap_sig_cseq_ST_st7_fsm_5)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_5)) then 
            ...
            grp_dct_dct_1d_fu_361_tmp_2 <= "XXXX";
        end if; 
    end process;


    -- grp_dct_dct_1d_fu_361_tmp_21 assign process. --
    grp_dct_dct_1d_fu_361_tmp_21_assign_proc : process(i_reg_271, ap_sig_cseq_ST_st3_fsm_2, i_2_reg_316, ap_sig_cseq_ST_st7_fsm_5)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_5)) then 
            ...
            grp_dct_dct_1d_fu_361_tmp_21 <= "XXXX";
        end if; 
    end process;

    i_1_mid2_fu_440_p3 <= 
        ap_const_lv4_0 when (exitcond_fu_434_p2(0) = '1') else 
        i_1_reg_305;
    i_3_mid2_fu_540_p3 <= 
        ap_const_lv4_0 when (exitcond1_fu_534_p2(0) = '1') else 
        i_3_reg_350;
    ...
    i_6_fu_487_p2 <= std_logic_vector(unsigned(i_1_mid2_fu_440_p3) + unsigned(ap_const_lv4_1));
    i_7_fu_583_p2 <= std_logic_vector(unsigned(i_3_mid2_fu_540_p3) + unsigned(ap_const_lv4_1));
    ...
    j_1_mid2_fu_548_p3 <= 
        j_3_fu_528_p2 when (exitcond1_fu_534_p2(0) = '1') else 
        j_1_phi_fu_343_p4;
    ...
    j_2_fu_428_p2 <= std_logic_vector(unsigned(ap_const_lv4_1) + unsigned(j_phi_fu_298_p4));
    j_3_fu_528_p2 <= std_logic_vector(unsigned(j_1_phi_fu_343_p4) + unsigned(ap_const_lv4_1));
    j_mid2_fu_448_p3 <= 
        j_2_fu_428_p2 when (exitcond_fu_434_p2(0) = '1') else 
        j_phi_fu_298_p4;
    ...
    out_block_address0 <= tmp_11_cast_fu_609_p1(6 - 1 downto 0);
    ...
    row_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it0, grp_dct_dct_1d_fu_361_dst_address0, ap_sig_cseq_ST_st3_fsm_2, tmp_6_cast_fu_478_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0))) then 
            row_outbuf_address0 <= tmp_6_cast_fu_478_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
    ...
    tmp_10_cast_fu_596_p1 <= std_logic_vector(resize(unsigned(tmp_8_fu_589_p3),8));
    tmp_11_cast_fu_609_p1 <= std_logic_vector(resize(unsigned(tmp_1_fu_603_p2),64));
    tmp_13_cast_fu_568_p1 <= std_logic_vector(resize(unsigned(tmp_2_fu_560_p3),8));
    tmp_14_cast_fu_578_p1 <= std_logic_vector(resize(unsigned(tmp_3_fu_572_p2),64));
    tmp_1_fu_603_p2 <= std_logic_vector(unsigned(tmp_5_cast_fu_600_p1) + unsigned(tmp_10_cast_fu_596_p1));
    tmp_2_fu_560_p3 <= (i_3_mid2_fu_540_p3 & ap_const_lv3_0);
    tmp_3_cast_fu_468_p1 <= std_logic_vector(resize(unsigned(tmp_fu_460_p3),8));
    tmp_3_fu_572_p2 <= std_logic_vector(unsigned(tmp_4_cast_fu_556_p1) + unsigned(tmp_13_cast_fu_568_p1));
    tmp_4_cast_fu_556_p1 <= std_logic_vector(resize(unsigned(j_1_mid2_fu_548_p3),8));
    tmp_4_fu_483_p1 <= i_1_mid2_fu_440_p3(3 - 1 downto 0);
    tmp_5_cast_fu_600_p1 <= std_logic_vector(resize(unsigned(i_3_mid2_reg_670),8));
    tmp_6_cast_fu_478_p1 <= std_logic_vector(resize(unsigned(tmp_6_fu_472_p2),64));
    tmp_6_fu_472_p2 <= std_logic_vector(unsigned(tmp_3_cast_fu_468_p1) + unsigned(tmp_cast_fu_456_p1));
    tmp_8_fu_589_p3 <= (j_1_mid2_reg_675 & ap_const_lv3_0);
    tmp_cast_fu_456_p1 <= std_logic_vector(resize(unsigned(j_mid2_fu_448_p3),8));
    tmp_fu_460_p3 <= (i_1_mid2_fu_440_p3 & ap_const_lv3_0);
