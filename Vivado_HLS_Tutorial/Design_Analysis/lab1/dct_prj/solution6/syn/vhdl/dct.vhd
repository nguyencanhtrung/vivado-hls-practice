...
architecture behav of dct is 
    ...
    "dct,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.930000,HLS_SYN_LAT=479,HLS_SYN_TPT=106,HLS_SYN_MEM=6,HLS_SYN_DSP=16,HLS_SYN_FF=2367,HLS_SYN_LUT=566}";
...
begin
    ...
    dct_Loop_Xpose_Row_Outer_Loop_proc_U0_ap_continue_assign_proc : process(ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_0_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_1_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_2_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_3_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_4_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_5_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_6_pipo_status, ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_7_pipo_status)
    begin
        if (((ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_0_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_1_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_2_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_3_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_4_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_5_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_6_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_Loop_Xpose_Row_Outer_Loop_proc_U0_col_inbuf_7_pipo_status))) then 
    ...
    dct_read_data_U0_ap_continue_assign_proc : process(ap_sig_ready_dct_read_data_U0_buf_0_pipo_status, ap_sig_ready_dct_read_data_U0_buf_1_pipo_status, ap_sig_ready_dct_read_data_U0_buf_2_pipo_status, ap_sig_ready_dct_read_data_U0_buf_3_pipo_status, ap_sig_ready_dct_read_data_U0_buf_4_pipo_status, ap_sig_ready_dct_read_data_U0_buf_5_pipo_status, ap_sig_ready_dct_read_data_U0_buf_6_pipo_status, ap_sig_ready_dct_read_data_U0_buf_7_pipo_status)
    begin
        if (((ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_0_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_1_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_2_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_3_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_4_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_5_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_6_pipo_status) and (ap_const_logic_1 = ap_sig_ready_dct_read_data_U0_buf_7_pipo_status))) then 
