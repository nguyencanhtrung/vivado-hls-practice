...
architecture behav of dct_dct_2d is 
    ...
    signal tmp_cast_fu_210_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_cast_reg_376 : STD_LOGIC_VECTOR (7 downto 0);
    signal exitcond4_fu_198_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_cast_fu_222_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_cast_reg_381 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_2_fu_264_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_reg_399 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_4_cast_fu_297_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_cast_reg_420 : STD_LOGIC_VECTOR (7 downto 0);
    signal exitcond1_fu_285_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_12_cast_fu_309_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_12_cast_reg_425 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_3_fu_329_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_reg_438 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_dct_dct_1d2_fu_171_ap_start : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_ap_done : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_ap_idle : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_ap_ready : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_src_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_dct_dct_1d2_fu_171_src_ce0 : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_src_q0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_dct_dct_1d2_fu_171_tmp_2 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dct_dct_1d2_fu_171_dst_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_dct_dct_1d2_fu_171_dst_ce0 : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_dst_we0 : STD_LOGIC;
    signal grp_dct_dct_1d2_fu_171_dst_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_dct_dct_1d2_fu_171_tmp_21 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal grp_dct_dct_1d2_fu_171_ap_start_ap_start_reg : STD_LOGIC := '0';
    signal tmp_9_cast_fu_259_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_10_cast_fu_269_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_8_cast_fu_250_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_9_fu_254_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_cast_fu_238_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_301_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_cast_fu_325_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_fu_334_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_15_cast_fu_342_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_5_fu_346_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    grp_dct_dct_1d2_fu_171 : component dct_dct_1d2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    -- grp_dct_dct_1d2_fu_171_ap_start_ap_start_reg assign process. --
    grp_dct_dct_1d2_fu_171_ap_start_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((ap_const_logic_1 = grp_dct_dct_1d2_fu_171_ap_ready)) then 
                    grp_dct_dct_1d2_fu_171_ap_start_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not((ap_const_logic_0 = grp_dct_dct_1d2_fu_171_ap_done)) and (ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((ap_const_logic_0 = grp_dct_dct_1d2_fu_171_ap_done)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st9_fsm_8) and (ap_const_lv1_0 = exitcond1_fu_285_p2))) then
                    tmp_12_cast_reg_425(6 downto 3) <= tmp_12_cast_fu_309_p1(6 downto 3);
                    tmp_4_cast_reg_420(3 downto 0) <= tmp_4_cast_fu_297_p1(3 downto 0);
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (exitcond4_fu_198_p2 = ap_const_lv1_0))) then
                    tmp_2_cast_reg_381(6 downto 3) <= tmp_2_cast_fu_222_p1(6 downto 3);
                    tmp_cast_reg_376(3 downto 0) <= tmp_cast_fu_210_p1(3 downto 0);
            end if;
        end if;
    end process;
    ...
    tmp_cast_reg_376(7 downto 4) <= "0000";
    tmp_2_cast_reg_381(2 downto 0) <= "000";
    tmp_2_cast_reg_381(7) <= '0';
    tmp_4_cast_reg_420(7 downto 4) <= "0000";
    tmp_12_cast_reg_425(2 downto 0) <= "000";
    tmp_12_cast_reg_425(7) <= '0';

    -- the next state (ap_NS_fsm) of the state machine. --
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond4_fu_198_p2, exitcond3_fu_226_p2, exitcond1_fu_285_p2, exitcond_fu_313_p2, grp_dct_dct_1d2_fu_171_ap_done, exitcond5_fu_186_p2, exitcond2_fu_273_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st3_fsm_2 => 
                if (not((ap_const_logic_0 = grp_dct_dct_1d2_fu_171_ap_done))) then
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                else
                    ap_NS_fsm <= ap_ST_st3_fsm_2;
                end if;
    ...
    col_inbuf_address0_assign_proc : process(grp_dct_dct_1d2_fu_171_src_address0, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7, tmp_10_cast_fu_269_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5)) then 
            col_inbuf_address0 <= tmp_10_cast_fu_269_p1(6 - 1 downto 0);
    ...
    col_inbuf_ce0_assign_proc : process(grp_dct_dct_1d2_fu_171_src_ce0, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5)) then 
    ...
    col_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_st10_fsm_9, grp_dct_dct_1d2_fu_171_dst_address0, ap_sig_cseq_ST_st8_fsm_7, tmp_16_cast_fu_351_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9)) then 
            col_outbuf_address0 <= tmp_16_cast_fu_351_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
    ...
    col_outbuf_ce0_assign_proc : process(ap_sig_cseq_ST_st10_fsm_9, grp_dct_dct_1d2_fu_171_dst_ce0, ap_sig_cseq_ST_st8_fsm_7)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9)) then 
    ...
    col_outbuf_d0 <= grp_dct_dct_1d2_fu_171_dst_d0;

    -- col_outbuf_we0 assign process. --
    col_outbuf_we0_assign_proc : process(grp_dct_dct_1d2_fu_171_dst_we0, ap_sig_cseq_ST_st8_fsm_7)
    begin
    ...
    grp_dct_dct_1d2_fu_171_ap_start <= grp_dct_dct_1d2_fu_171_ap_start_ap_start_reg;

    -- grp_dct_dct_1d2_fu_171_src_q0 assign process. --
    grp_dct_dct_1d2_fu_171_src_q0_assign_proc : process(in_block_q0, col_inbuf_q0, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_st8_fsm_7)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            ...
            grp_dct_dct_1d2_fu_171_src_q0 <= "XXXXXXXXXXXXXXXX";
        end if; 
    end process;


    -- grp_dct_dct_1d2_fu_171_tmp_2 assign process. --
    grp_dct_dct_1d2_fu_171_tmp_2_assign_proc : process(i_reg_103, ap_sig_cseq_ST_st3_fsm_2, i_2_reg_137, ap_sig_cseq_ST_st8_fsm_7)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            ...
            grp_dct_dct_1d2_fu_171_tmp_2 <= "XXXX";
        end if; 
    end process;


    -- grp_dct_dct_1d2_fu_171_tmp_21 assign process. --
    grp_dct_dct_1d2_fu_171_tmp_21_assign_proc : process(i_reg_103, ap_sig_cseq_ST_st3_fsm_2, i_2_reg_137, ap_sig_cseq_ST_st8_fsm_7)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            ...
            grp_dct_dct_1d2_fu_171_tmp_21 <= "XXXX";
        end if; 
    end process;
    ...
    in_block_address0 <= grp_dct_dct_1d2_fu_171_src_address0;

    -- in_block_ce0 assign process. --
    in_block_ce0_assign_proc : process(grp_dct_dct_1d2_fu_171_src_ce0, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
            in_block_ce0 <= grp_dct_dct_1d2_fu_171_src_ce0;
        else 
    ...
    out_block_address0 <= tmp_13_cast_fu_356_p1(6 - 1 downto 0);
    ...
    row_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_st5_fsm_4, grp_dct_dct_1d2_fu_171_dst_address0, ap_sig_cseq_ST_st3_fsm_2, tmp_9_cast_fu_259_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4)) then 
            row_outbuf_address0 <= tmp_9_cast_fu_259_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
    ...
    row_outbuf_ce0_assign_proc : process(ap_sig_cseq_ST_st5_fsm_4, grp_dct_dct_1d2_fu_171_dst_ce0, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4)) then 
    ...
    row_outbuf_d0 <= grp_dct_dct_1d2_fu_171_dst_d0;

    -- row_outbuf_we0 assign process. --
    row_outbuf_we0_assign_proc : process(grp_dct_dct_1d2_fu_171_dst_we0, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
    ...
    tmp_10_cast_fu_269_p1 <= std_logic_vector(resize(unsigned(tmp_2_reg_399),64));
    tmp_12_cast_fu_309_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_301_p3),8));
    tmp_13_cast_fu_356_p1 <= std_logic_vector(resize(unsigned(tmp_3_reg_438),64));
    tmp_15_cast_fu_342_p1 <= std_logic_vector(resize(unsigned(tmp_4_fu_334_p3),8));
    tmp_16_cast_fu_351_p1 <= std_logic_vector(resize(unsigned(tmp_5_fu_346_p2),64));
    tmp_2_cast_fu_222_p1 <= std_logic_vector(resize(unsigned(tmp_fu_214_p3),8));
    tmp_2_fu_264_p2 <= std_logic_vector(unsigned(tmp_3_cast_fu_238_p1) + unsigned(tmp_2_cast_reg_381));
    tmp_3_cast_fu_238_p1 <= std_logic_vector(resize(unsigned(i_1_reg_126),8));
    tmp_3_fu_329_p2 <= std_logic_vector(unsigned(tmp_5_cast_fu_325_p1) + unsigned(tmp_12_cast_reg_425));
    tmp_4_cast_fu_297_p1 <= std_logic_vector(resize(unsigned(j_1_reg_149),8));
    tmp_4_fu_334_p3 <= (i_3_reg_160 & ap_const_lv3_0);
    tmp_5_cast_fu_325_p1 <= std_logic_vector(resize(unsigned(i_3_reg_160),8));
    tmp_5_fu_346_p2 <= std_logic_vector(unsigned(tmp_4_cast_reg_420) + unsigned(tmp_15_cast_fu_342_p1));
    tmp_7_fu_242_p3 <= (i_1_reg_126 & ap_const_lv3_0);
    tmp_8_cast_fu_250_p1 <= std_logic_vector(resize(unsigned(tmp_7_fu_242_p3),8));
    tmp_9_cast_fu_259_p1 <= std_logic_vector(resize(unsigned(tmp_9_fu_254_p2),64));
    tmp_9_fu_254_p2 <= std_logic_vector(unsigned(tmp_cast_reg_376) + unsigned(tmp_8_cast_fu_250_p1));
    tmp_cast_fu_210_p1 <= std_logic_vector(resize(unsigned(j_reg_115),8));
