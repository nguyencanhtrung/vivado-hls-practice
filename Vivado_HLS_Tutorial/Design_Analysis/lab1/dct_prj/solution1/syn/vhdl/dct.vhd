...
architecture behav of dct is 
    ...
    "dct,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.790000,HLS_SYN_LAT=3959,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=1,HLS_SYN_FF=278,HLS_SYN_LUT=354}";
    ...
    signal tmp_28_cast_fu_188_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_28_cast_reg_319 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_14_fu_222_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_14_reg_337 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_30_cast_fu_251_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_30_cast_reg_350 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_32_cast_fu_227_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_33_cast_fu_292_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_13_fu_243_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_4_fu_255_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_3_i_cast_fu_283_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_15_fu_287_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5) and (ap_const_lv1_0 = exitcond1_i3_fu_231_p2))) then
                    ...
                    tmp_30_cast_reg_350(6 downto 3) <= tmp_30_cast_fu_251_p1(6 downto 3);
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_i_fu_156_p2 = ap_const_lv1_0))) then
                    tmp_28_cast_reg_319(6 downto 3) <= tmp_28_cast_fu_188_p1(6 downto 3);
    ...
    tmp_28_cast_reg_319(2 downto 0) <= "000";
    tmp_28_cast_reg_319(7) <= '0';
    tmp_30_cast_reg_350(2 downto 0) <= "000";
    tmp_30_cast_reg_350(7) <= '0';
    ...
    buf_2d_in_address0_assign_proc : process(grp_dct_dct_2d_fu_148_in_block_address0, ap_sig_cseq_ST_st4_fsm_3, ap_sig_cseq_ST_st5_fsm_4, tmp_32_cast_fu_227_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
            buf_2d_in_address0 <= tmp_32_cast_fu_227_p1(6 - 1 downto 0);
    ...
    buf_2d_out_address0_assign_proc : process(ap_sig_cseq_ST_st7_fsm_6, grp_dct_dct_2d_fu_148_out_block_address0, ap_sig_cseq_ST_st5_fsm_4, tmp_33_cast_fu_292_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then 
            buf_2d_out_address0 <= tmp_33_cast_fu_292_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4)) then 
    ...
    tmp_13_fu_243_p3 <= (r_i2_reg_126 & ap_const_lv3_0);
    tmp_14_fu_222_p2 <= std_logic_vector(unsigned(tmp_28_cast_reg_319) + unsigned(tmp_1_i_cast_fu_218_p1));
    tmp_15_fu_287_p2 <= std_logic_vector(unsigned(tmp_30_cast_reg_350) + unsigned(tmp_3_i_cast_fu_283_p1));
    tmp_1_i5_fu_259_p3 <= (tmp_4_fu_255_p1 & ap_const_lv3_0);
    tmp_1_i_cast_fu_218_p1 <= std_logic_vector(resize(unsigned(c_i_reg_115),8));
    tmp_28_cast_fu_188_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_180_p3),8));
    tmp_30_cast_fu_251_p1 <= std_logic_vector(resize(unsigned(tmp_13_fu_243_p3),8));
    tmp_32_cast_fu_227_p1 <= std_logic_vector(resize(unsigned(tmp_14_reg_337),64));
    tmp_33_cast_fu_292_p1 <= std_logic_vector(resize(unsigned(tmp_15_fu_287_p2),64));
    tmp_3_i_cast_fu_283_p1 <= std_logic_vector(resize(unsigned(c_i6_reg_137),8));
    tmp_4_fu_255_p1 <= r_i2_reg_126(3 - 1 downto 0);
    tmp_4_i_fu_297_p2 <= std_logic_vector(unsigned(c_i6_cast2_fu_267_p1) + unsigned(tmp_1_i5_reg_355));
    tmp_5_i_fu_302_p1 <= std_logic_vector(resize(unsigned(tmp_4_i_reg_373),64));
    ...
    tmp_i_15_fu_213_p1 <= std_logic_vector(resize(unsigned(tmp_9_i_fu_208_p2),64));
