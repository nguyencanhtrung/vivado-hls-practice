...
(* CORE_GENERATION_INFO="dct,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.790000,HLS_SYN_LAT=3959,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=1,HLS_SYN_FF=278,HLS_SYN_LUT=354}" *)
...
always @ (posedge ap_clk) begin : ap_ret_grp_dct_dct_2d_fu_148_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
...
always @ (ap_sig_cseq_ST_st6_fsm_5 or exitcond1_i3_fu_231_p2) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st6_fsm_5) & ~(ap_const_lv1_0 == exitcond1_i3_fu_231_p2))) begin
...
always @ (grp_dct_dct_2d_fu_148_in_block_address0 or ap_sig_cseq_ST_st4_fsm_3 or ap_sig_cseq_ST_st5_fsm_4 or tmp_32_cast_fu_227_p1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3)) begin
...
always @ (grp_dct_dct_2d_fu_148_in_block_ce0 or ap_sig_cseq_ST_st4_fsm_3 or ap_sig_cseq_ST_st5_fsm_4) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3)) begin
...
always @ (ap_sig_cseq_ST_st7_fsm_6 or grp_dct_dct_2d_fu_148_out_block_address0 or ap_sig_cseq_ST_st5_fsm_4 or tmp_33_cast_fu_292_p1) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6)) begin
...
always @ (ap_sig_cseq_ST_st7_fsm_6 or grp_dct_dct_2d_fu_148_out_block_ce0 or ap_sig_cseq_ST_st5_fsm_4) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6)) begin
...
always @ (grp_dct_dct_2d_fu_148_out_block_we0 or ap_sig_cseq_ST_st5_fsm_4) begin
...
always @ (ap_start or ap_CS_fsm or exitcond1_i_fu_156_p2 or exitcond_i_fu_196_p2 or exitcond1_i3_fu_231_p2 or exitcond_i7_fu_271_p2 or grp_dct_dct_2d_fu_148_ap_done) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
