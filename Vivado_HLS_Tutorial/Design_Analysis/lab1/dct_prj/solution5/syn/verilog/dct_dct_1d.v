...
reg   [3:0] k_reg_288;
wire   [7:0] tmp_20_cast_fu_307_p1;
reg   [7:0] tmp_20_cast_reg_490;
reg   [2:0] src_addr_reg_495;
reg   [2:0] src1_addr_reg_500;
reg   [2:0] src2_addr_reg_505;
reg   [2:0] src3_addr_reg_510;
reg   [2:0] src4_addr_reg_515;
reg   [2:0] src5_addr_reg_520;
reg   [2:0] src6_addr_reg_525;
reg   [2:0] src7_addr_reg_530;
...
wire   [7:0] tmp_10_fu_351_p2;
reg   [7:0] tmp_10_reg_544;
reg   [7:0] ap_reg_ppstg_tmp_10_reg_544_pp0_it1;
reg   [7:0] ap_reg_ppstg_tmp_10_reg_544_pp0_it2;
reg   [7:0] ap_reg_ppstg_tmp_10_reg_544_pp0_it3;
reg   [13:0] dct_coeff_table_0_load_reg_589;
reg   [13:0] ap_reg_ppstg_dct_coeff_table_0_load_reg_589_pp0_it2;
reg  signed [14:0] dct_coeff_table_1_load_reg_594;
reg  signed [15:0] src1_load_reg_599;
reg   [14:0] dct_coeff_table_2_load_reg_604;
reg  signed [14:0] ap_reg_ppstg_dct_coeff_table_2_load_reg_604_pp0_it2;
reg  signed [14:0] dct_coeff_table_3_load_reg_609;
reg  signed [15:0] src3_load_reg_614;
reg   [14:0] dct_coeff_table_4_load_reg_619;
reg  signed [14:0] ap_reg_ppstg_dct_coeff_table_4_load_reg_619_pp0_it2;
reg  signed [14:0] dct_coeff_table_5_load_reg_624;
reg  signed [15:0] src5_load_reg_629;
reg  signed [14:0] dct_coeff_table_6_load_reg_634;
reg  signed [15:0] src6_load_reg_639;
reg  signed [14:0] dct_coeff_table_7_load_reg_644;
reg  signed [15:0] src7_load_reg_649;
reg  signed [15:0] src_load_reg_654;
wire  signed [28:0] tmp_10_1_fu_476_p2;
reg  signed [28:0] tmp_10_1_reg_659;
reg  signed [15:0] src2_load_reg_664;
wire  signed [28:0] tmp_10_3_fu_470_p2;
reg  signed [28:0] tmp_10_3_reg_669;
reg  signed [15:0] src4_load_reg_674;
wire  signed [28:0] tmp_10_5_fu_448_p2;
reg  signed [28:0] tmp_10_5_reg_679;
wire  signed [28:0] grp_fu_482_p3;
reg  signed [28:0] tmp6_reg_684;
reg   [15:0] tmp_7_reg_689;
wire   [63:0] tmp_2_cast_fu_311_p1;
wire   [63:0] tmp_fu_335_p1;
wire   [63:0] tmp_22_cast_fu_428_p1;
wire   [6:0] tmp_8_fu_299_p3;
wire   [7:0] tmp_cast_fu_347_p1;
wire  signed [28:0] grp_fu_440_p3;
wire  signed [28:0] grp_fu_432_p3;
wire  signed [28:0] grp_fu_454_p3;
(* use_dsp48 = "no" *) wire   [28:0] tmp1_fu_404_p2;
(* use_dsp48 = "no" *) wire   [28:0] tmp4_fu_408_p2;
wire   [28:0] tmp_s_fu_412_p2;
wire   [13:0] grp_fu_440_p0;
wire   [13:0] grp_fu_462_p2;
wire  signed [28:0] grp_fu_462_p3;
reg    ap_sig_cseq_ST_st7_fsm_2;
reg    ap_sig_bdd_403;
reg   [2:0] ap_NS_fsm;
wire   [28:0] grp_fu_440_p00;
...
dct_mac_muladd_15s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_U10(
...
dct_mac_muladd_14ns_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_14ns_16s_29s_29_1_U11(
    .din0( grp_fu_440_p0 ),
...
dct_mac_muladd_15s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_U13(
...
dct_mac_muladd_15s_16s_14ns_29_1 #(
    ...
    .din2_WIDTH( 14 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_14ns_29_1_U14(
...
dct_mac_muladd_15s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_U17(
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_start == ap_const_logic_0))) begin
        src1_addr_reg_500 <= tmp_2_cast_fu_311_p1;
        src2_addr_reg_505 <= tmp_2_cast_fu_311_p1;
        src3_addr_reg_510 <= tmp_2_cast_fu_311_p1;
        src4_addr_reg_515 <= tmp_2_cast_fu_311_p1;
        src5_addr_reg_520 <= tmp_2_cast_fu_311_p1;
        src6_addr_reg_525 <= tmp_2_cast_fu_311_p1;
        src7_addr_reg_530 <= tmp_2_cast_fu_311_p1;
        src_addr_reg_495 <= tmp_2_cast_fu_311_p1;
        tmp_20_cast_reg_490[6 : 3] <= tmp_20_cast_fu_307_p1[6 : 3];
    end
end
...
/// assign process. ///
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_reg_ppiten_pp0_it2) & (ap_reg_ppstg_exitcond1_reg_535_pp0_it1 == ap_const_lv1_0))) begin
...
always @ (posedge ap_clk) begin
    if ((ap_reg_ppstg_exitcond1_reg_535_pp0_it2 == ap_const_lv1_0)) begin
        tmp_7_reg_689 <= {{tmp_s_fu_412_p2[ap_const_lv32_1C : ap_const_lv32_D]}};
    end
end

/// ap_done assign process. ///
always @ (ap_start or ap_sig_cseq_ST_st1_fsm_0 or ap_sig_cseq_ST_st7_fsm_2) begin
...
always @ (ap_sig_cseq_ST_st7_fsm_2) begin
...
always @ (ap_reg_ppiten_pp0_it4 or ap_reg_ppstg_exitcond1_reg_535_pp0_it3) begin
...
always @ (ap_start or ap_CS_fsm or exitcond1_fu_323_p2 or ap_reg_ppiten_pp0_it0 or ap_reg_ppiten_pp0_it1 or ap_reg_ppiten_pp0_it3 or ap_reg_ppiten_pp0_it4) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
...
always @ (ap_CS_fsm) begin
    ap_sig_bdd_403 = (ap_const_lv1_1 == ap_CS_fsm[ap_const_lv32_2]);
end
...
assign dst_address0 = tmp_22_cast_fu_428_p1;
assign dst_d0 = tmp_7_reg_689;
assign exitcond1_fu_323_p2 = (k_reg_288 == ap_const_lv4_8? 1'b1: 1'b0);
assign grp_fu_440_p0 = grp_fu_440_p00;
assign grp_fu_440_p00 = ap_reg_ppstg_dct_coeff_table_0_load_reg_589_pp0_it2;
assign grp_fu_462_p2 = ap_const_lv29_1000;
assign k_1_fu_329_p2 = (k_reg_288 + ap_const_lv4_1);
assign src1_address0 = src1_addr_reg_500;
assign src2_address0 = src2_addr_reg_505;
assign src3_address0 = src3_addr_reg_510;
assign src4_address0 = src4_addr_reg_515;
assign src5_address0 = src5_addr_reg_520;
assign src6_address0 = src6_addr_reg_525;
assign src7_address0 = src7_addr_reg_530;
assign src_address0 = src_addr_reg_495;
assign tmp1_fu_404_p2 = ($signed(grp_fu_440_p3) + $signed(grp_fu_432_p3));
assign tmp4_fu_408_p2 = ($signed(grp_fu_454_p3) + $signed(tmp6_reg_684));
assign tmp_10_fu_351_p2 = (tmp_20_cast_reg_490 + tmp_cast_fu_347_p1);
assign tmp_20_cast_fu_307_p1 = tmp_8_fu_299_p3;
assign tmp_22_cast_fu_428_p1 = ap_reg_ppstg_tmp_10_reg_544_pp0_it3;
assign tmp_2_cast_fu_311_p1 = tmp_2;
assign tmp_8_fu_299_p3 = {{tmp_21}, {ap_const_lv3_0}};
assign tmp_cast_fu_347_p1 = k_reg_288;
assign tmp_fu_335_p1 = k_reg_288;
assign tmp_s_fu_412_p2 = (tmp1_fu_404_p2 + tmp4_fu_408_p2);
always @ (posedge ap_clk) begin
    tmp_20_cast_reg_490[2:0] <= 3'b000;
    tmp_20_cast_reg_490[7] <= 1'b0;
end
