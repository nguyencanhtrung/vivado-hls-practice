...
.reset:                                           ; preds = %1
  ...
  %tmp_i_13 = zext i6 %tmp_9_i to i64
  %input_addr = getelementptr [64 x i16]* %input_r, i64 0, i64 %tmp_i_13
  %input_load = load i16* %input_addr, align 2
  %tmp_1_i_cast = zext i4 %c_i_mid2 to i8
  %tmp_13 = add i8 %tmp_28_cast, %tmp_1_i_cast
  %tmp_29_cast = zext i8 %tmp_13 to i64
  %buf_2d_in_addr = getelementptr [64 x i16]* %buf_2d_in, i64 0, i64 %tmp_29_cast
  store i16 %input_load, i16* %buf_2d_in_addr, align 2
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_10_i) nounwind
  %c = add i4 1, %c_i_mid2
  br label %1
...
.reset11:                                         ; preds = %2
  ...
  %empty_15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) nounwind
  %exitcond_i1 = icmp eq i4 %c_i6, -8
  %c_i6_mid2 = select i1 %exitcond_i1, i4 0, i4 %c_i6
  %r_i2_mid2 = select i1 %exitcond_i1, i4 %r_1, i4 %r_i2
  %tmp_14 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i2_mid2, i3 0)
  %tmp_31_cast = zext i7 %tmp_14 to i8
  %tmp_4 = trunc i4 %r_i2_mid2 to i3
  ...
  %tmp_15 = add i8 %tmp_31_cast, %tmp_3_i_cast
  ...
  %empty_16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str12, i32 %tmp_6_i) nounwind
...
entry:
  ...
  %empty_17 = trunc i29 %empty to i16
  ret i16 %empty_17
}
...
entry:
  ...
  %empty_18 = zext i3 %1 to i7
  %empty_19 = shl i7 %empty, 3
