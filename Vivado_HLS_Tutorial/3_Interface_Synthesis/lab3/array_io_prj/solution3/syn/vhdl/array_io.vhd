...
architecture behav of array_io is 
    ...
    "array_io,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.400000,HLS_SYN_LAT=11,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1228,HLS_SYN_LUT=1191}";
...
begin
    ...
    acc_0_loc_assign_1_fu_468_p2 <= std_logic_vector(unsigned(acc_0_loc_assign_2_reg_968) + unsigned(tmp_2_8_fu_464_p1));
    acc_0_loc_assign_2_fu_436_p2 <= std_logic_vector(unsigned(acc_0) + unsigned(tmp_2_fu_432_p1));
    acc_0_loc_fu_481_p2 <= std_logic_vector(unsigned(acc_0_loc_assign_1_fu_468_p2) + unsigned(tmp_2_15_fu_477_p1));
    acc_1_loc_assign_1_fu_513_p2 <= std_logic_vector(unsigned(acc_1_loc_assign_2_reg_998) + unsigned(tmp_2_9_fu_509_p1));
    acc_1_loc_assign_2_fu_454_p2 <= std_logic_vector(unsigned(acc_1) + unsigned(tmp_2_1_fu_450_p1));
    acc_1_loc_fu_526_p2 <= std_logic_vector(unsigned(acc_1_loc_assign_1_fu_513_p2) + unsigned(tmp_2_16_fu_522_p1));
    acc_2_loc_assign_1_fu_578_p2 <= std_logic_vector(unsigned(acc_2_loc_assign_2_reg_1043) + unsigned(tmp_2_s_fu_574_p1));
    acc_2_loc_assign_2_fu_499_p2 <= std_logic_vector(unsigned(acc_2) + unsigned(tmp_2_2_fu_495_p1));
    acc_2_loc_fu_591_p2 <= std_logic_vector(unsigned(acc_2_loc_assign_1_fu_578_p2) + unsigned(tmp_2_17_fu_587_p1));
    acc_3_loc_assign_1_fu_643_p2 <= std_logic_vector(unsigned(acc_3_loc_assign_2_reg_1088) + unsigned(tmp_2_10_fu_639_p1));
    acc_3_loc_assign_2_fu_564_p2 <= std_logic_vector(unsigned(acc_3) + unsigned(tmp_2_3_fu_560_p1));
    acc_3_loc_fu_656_p2 <= std_logic_vector(unsigned(acc_3_loc_assign_1_fu_643_p2) + unsigned(tmp_2_18_fu_652_p1));
    acc_4_loc_assign_1_fu_708_p2 <= std_logic_vector(unsigned(acc_4_loc_assign_2_reg_1133) + unsigned(tmp_2_11_fu_704_p1));
    acc_4_loc_assign_2_fu_629_p2 <= std_logic_vector(unsigned(acc_4) + unsigned(tmp_2_4_fu_625_p1));
    acc_4_loc_fu_721_p2 <= std_logic_vector(unsigned(acc_4_loc_assign_1_fu_708_p2) + unsigned(tmp_2_19_fu_717_p1));
    acc_5_loc_assign_1_fu_773_p2 <= std_logic_vector(unsigned(acc_5_loc_assign_2_reg_1178) + unsigned(tmp_2_12_fu_769_p1));
    acc_5_loc_assign_2_fu_694_p2 <= std_logic_vector(unsigned(acc_5) + unsigned(tmp_2_5_fu_690_p1));
    acc_5_loc_fu_786_p2 <= std_logic_vector(unsigned(acc_5_loc_assign_1_fu_773_p2) + unsigned(tmp_2_20_fu_782_p1));
    acc_6_loc_assign_1_fu_838_p2 <= std_logic_vector(unsigned(acc_6_loc_assign_2_reg_1223) + unsigned(tmp_2_13_fu_834_p1));
    acc_6_loc_assign_2_fu_759_p2 <= std_logic_vector(unsigned(acc_6) + unsigned(tmp_2_6_fu_755_p1));
    acc_6_loc_fu_851_p2 <= std_logic_vector(unsigned(acc_6_loc_assign_1_fu_838_p2) + unsigned(tmp_2_21_fu_847_p1));
    acc_7_loc_assign_1_fu_885_p2 <= std_logic_vector(unsigned(acc_7_loc_assign_2_reg_1263) + unsigned(tmp_2_14_fu_881_p1));
    acc_7_loc_assign_2_fu_824_p2 <= std_logic_vector(unsigned(acc_7) + unsigned(tmp_2_7_fu_820_p1));
    acc_7_loc_fu_898_p2 <= std_logic_vector(unsigned(acc_7_loc_assign_1_fu_885_p2) + unsigned(tmp_2_22_fu_894_p1));
    ...
    temp_1_fu_605_p2 <= std_logic_vector(unsigned(acc_1_loc_reg_1068) + unsigned(tmp_2_24_fu_601_p1));
    temp_2_fu_670_p2 <= std_logic_vector(unsigned(acc_2_loc_reg_1113) + unsigned(tmp_2_25_fu_666_p1));
    temp_3_fu_735_p2 <= std_logic_vector(unsigned(acc_3_loc_reg_1158) + unsigned(tmp_2_26_fu_731_p1));
    temp_4_fu_800_p2 <= std_logic_vector(unsigned(acc_4_loc_reg_1203) + unsigned(tmp_2_27_fu_796_p1));
    temp_5_fu_865_p2 <= std_logic_vector(unsigned(acc_5_loc_reg_1243) + unsigned(tmp_2_28_fu_861_p1));
    temp_6_fu_912_p2 <= std_logic_vector(unsigned(acc_6_loc_reg_1278) + unsigned(tmp_2_29_fu_908_p1));
    temp_7_fu_932_p2 <= std_logic_vector(unsigned(acc_7_loc_reg_1298) + unsigned(tmp_2_30_fu_928_p1));
    temp_s_fu_540_p2 <= std_logic_vector(unsigned(acc_0_loc_reg_1023) + unsigned(tmp_2_23_fu_536_p1));
