; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/a.o.2.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable readnone {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [11 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !38 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, [8 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !40 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [8 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !41 ; [debug line = 54:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [8 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !42 ; [debug line = 55:1]
  %tmp1 = add i32 %in3, %in1, !dbg !43            ; [#uses=1 type=i32] [debug line = 60:2]
  %sum = add i32 %tmp1, %in2, !dbg !43            ; [#uses=1 type=i32] [debug line = 60:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !44), !dbg !43 ; [debug line = 60:2] [debug variable = sum]
  ret i32 %sum, !dbg !45                          ; [debug line = 62:2]
}
...
!38 = metadata !{i32 50, i32 1, metadata !39, null}
!39 = metadata !{i32 786443, metadata !5, i32 48, i32 39, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!40 = metadata !{i32 53, i32 1, metadata !39, null}
!41 = metadata !{i32 54, i32 1, metadata !39, null}
!42 = metadata !{i32 55, i32 1, metadata !39, null}
!43 = metadata !{i32 60, i32 2, metadata !39, null}
!44 = metadata !{i32 786688, metadata !39, metadata !"sum", metadata !6, i32 58, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!45 = metadata !{i32 62, i32 2, metadata !39, null}
