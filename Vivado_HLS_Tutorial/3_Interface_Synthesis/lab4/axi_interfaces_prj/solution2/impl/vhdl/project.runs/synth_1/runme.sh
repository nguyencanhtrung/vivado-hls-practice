...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab4/axi_interfaces_prj/solution2/impl/vhdl/project.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log axi_interfaces.vds -m64 -mode batch -messageDb vivado.pb -notrace -source axi_interfaces.tcl
