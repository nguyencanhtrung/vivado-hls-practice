...
struct dct_dct_2d : public sc_module {
    ...
    sc_signal< sc_lv<7> > indvar_flatten1_reg_176;
    ...
    sc_signal< sc_lv<4> > i_1_mid2_fu_260_p3;
    ...
    sc_signal< sc_lv<1> > exitcond_flatten1_fu_346_p2;
    sc_signal< sc_lv<1> > exitcond_flatten1_reg_492;
    ...
    sc_signal< sc_lv<7> > indvar_flatten_next1_fu_352_p2;
    sc_signal< sc_lv<4> > i_3_mid2_fu_370_p3;
    ...
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_ap_start;
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_ap_done;
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_ap_idle;
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_ap_ready;
    sc_signal< sc_lv<6> > grp_dct_dct_1d2_fu_209_src_address0;
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_src_ce0;
    sc_signal< sc_lv<16> > grp_dct_dct_1d2_fu_209_src_q0;
    sc_signal< sc_lv<4> > grp_dct_dct_1d2_fu_209_tmp_2;
    sc_signal< sc_lv<6> > grp_dct_dct_1d2_fu_209_dst_address0;
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_dst_ce0;
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_dst_we0;
    sc_signal< sc_lv<16> > grp_dct_dct_1d2_fu_209_dst_d0;
    sc_signal< sc_lv<4> > grp_dct_dct_1d2_fu_209_tmp_21;
    ...
    sc_signal< sc_logic > grp_dct_dct_1d2_fu_209_ap_start_ap_start_reg;
    sc_signal< sc_lv<64> > tmp_9_cast_fu_298_p1;
    sc_signal< sc_lv<64> > tmp_10_cast_fu_329_p1;
    sc_signal< sc_lv<64> > tmp_16_cast_fu_408_p1;
    sc_signal< sc_lv<64> > tmp_13_cast_fu_439_p1;
    sc_signal< sc_lv<1> > exitcond_fu_254_p2;
    sc_signal< sc_lv<4> > j_2_fu_248_p2;
    sc_signal< sc_lv<7> > tmp_2_fu_280_p3;
    sc_signal< sc_lv<8> > tmp_cast_fu_276_p1;
    sc_signal< sc_lv<8> > tmp_7_cast_fu_288_p1;
    sc_signal< sc_lv<8> > tmp_9_fu_292_p2;
    sc_signal< sc_lv<7> > tmp_fu_309_p3;
    sc_signal< sc_lv<8> > tmp_3_cast_fu_320_p1;
    sc_signal< sc_lv<8> > tmp_1_cast_fu_316_p1;
    sc_signal< sc_lv<8> > tmp_s_fu_323_p2;
    sc_signal< sc_lv<1> > exitcond1_fu_364_p2;
    sc_signal< sc_lv<4> > j_3_fu_358_p2;
    sc_signal< sc_lv<7> > tmp_4_fu_390_p3;
    sc_signal< sc_lv<8> > tmp_4_cast_fu_386_p1;
    sc_signal< sc_lv<8> > tmp_15_cast_fu_398_p1;
    sc_signal< sc_lv<8> > tmp_5_fu_402_p2;
    sc_signal< sc_lv<7> > tmp_1_fu_419_p3;
    sc_signal< sc_lv<8> > tmp_5_cast_fu_430_p1;
    sc_signal< sc_lv<8> > tmp_12_cast_fu_426_p1;
    sc_signal< sc_lv<8> > tmp_3_fu_433_p2;
    ...
    void thread_exitcond_flatten1_fu_346_p2();
    void thread_exitcond_flatten_fu_236_p2();
    void thread_exitcond_fu_254_p2();
    void thread_grp_dct_dct_1d2_fu_209_ap_start();
    void thread_grp_dct_dct_1d2_fu_209_src_q0();
    void thread_grp_dct_dct_1d2_fu_209_tmp_2();
    void thread_grp_dct_dct_1d2_fu_209_tmp_21();
    void thread_i_1_mid2_fu_260_p3();
    void thread_i_3_mid2_fu_370_p3();
