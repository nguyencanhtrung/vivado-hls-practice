...
entity dct_dct_1d2_dct_coeff_table_rom is 
    generic(
             dwidth     : integer := 15; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of dct_dct_1d2_dct_coeff_table_rom is 
...
entity dct_dct_1d2_dct_coeff_table is
    generic (
...
architecture arch of dct_dct_1d2_dct_coeff_table is
    component dct_dct_1d2_dct_coeff_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dct_dct_1d2_dct_coeff_table_rom_U :  component dct_dct_1d2_dct_coeff_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
