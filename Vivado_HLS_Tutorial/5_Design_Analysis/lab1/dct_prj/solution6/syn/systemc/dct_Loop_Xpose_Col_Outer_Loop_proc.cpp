...
dct_Loop_Xpose_Col_Outer_Loop_proc::dct_Loop_Xpose_Col_Outer_Loop_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_17_cast_fu_195_p1 );
    ...
    sensitive << ( tmp_16_cast_fu_164_p1 );
    ...
    SC_METHOD(thread_tmp_13_cast_fu_182_p1);
    sensitive << ( tmp_fu_175_p3 );

    SC_METHOD(thread_tmp_15_cast_fu_154_p1);
    sensitive << ( tmp_s_fu_146_p3 );

    SC_METHOD(thread_tmp_16_cast_fu_164_p1);
    sensitive << ( tmp_2_fu_158_p2 );

    SC_METHOD(thread_tmp_17_cast_fu_195_p1);
    ...
    sensitive << ( tmp_15_cast_fu_154_p1 );

    SC_METHOD(thread_tmp_4_fu_189_p2);
    sensitive << ( tmp_2_cast_fu_186_p1 );
    sensitive << ( tmp_13_cast_fu_182_p1 );
    ...
    sc_trace(mVcdFile, tmp_16_cast_fu_164_p1, "tmp_16_cast_fu_164_p1");
    sc_trace(mVcdFile, tmp_17_cast_fu_195_p1, "tmp_17_cast_fu_195_p1");
    ...
    sc_trace(mVcdFile, tmp_15_cast_fu_154_p1, "tmp_15_cast_fu_154_p1");
    ...
    sc_trace(mVcdFile, tmp_13_cast_fu_182_p1, "tmp_13_cast_fu_182_p1");
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_buf_2d_out_address0() {
    buf_2d_out_address0 =  (sc_lv<6>) (tmp_17_cast_fu_195_p1.read());
}
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_col_outbuf_i_address0() {
    col_outbuf_i_address0 =  (sc_lv<6>) (tmp_16_cast_fu_164_p1.read());
}
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_exitcond_i3_fu_120_p2() {
    exitcond_i3_fu_120_p2 = (!i_3_i_reg_91.read().is_01() || !ap_const_lv4_8.is_01())? sc_lv<1>(): sc_lv<1>(i_3_i_reg_91.read() == ap_const_lv4_8);
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_i_3_i_mid2_fu_126_p3() {
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_j_fu_114_p2() {
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_13_cast_fu_182_p1() {
    tmp_13_cast_fu_182_p1 = esl_zext<8,7>(tmp_fu_175_p3.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_15_cast_fu_154_p1() {
    tmp_15_cast_fu_154_p1 = esl_zext<8,7>(tmp_s_fu_146_p3.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_16_cast_fu_164_p1() {
    tmp_16_cast_fu_164_p1 = esl_zext<64,8>(tmp_2_fu_158_p2.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_17_cast_fu_195_p1() {
    tmp_17_cast_fu_195_p1 = esl_zext<64,8>(tmp_4_fu_189_p2.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_1_cast_fu_142_p1() {
    tmp_1_cast_fu_142_p1 = esl_zext<8,4>(j_1_i_mid2_fu_134_p3.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_2_cast_fu_186_p1() {
    tmp_2_cast_fu_186_p1 = esl_zext<8,4>(i_3_i_mid2_reg_209.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_2_fu_158_p2() {
    tmp_2_fu_158_p2 = (!tmp_1_cast_fu_142_p1.read().is_01() || !tmp_15_cast_fu_154_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_1_cast_fu_142_p1.read()) + sc_biguint<8>(tmp_15_cast_fu_154_p1.read()));
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_4_fu_189_p2() {
    tmp_4_fu_189_p2 = (!tmp_2_cast_fu_186_p1.read().is_01() || !tmp_13_cast_fu_182_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_2_cast_fu_186_p1.read()) + sc_biguint<8>(tmp_13_cast_fu_182_p1.read()));
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_fu_175_p3() {
    tmp_fu_175_p3 = esl_concat<4,3>(j_1_i_mid2_reg_214.read(), ap_const_lv3_0);
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_s_fu_146_p3() {
    tmp_s_fu_146_p3 = esl_concat<4,3>(i_3_i_mid2_fu_126_p3.read(), ap_const_lv3_0);
}
