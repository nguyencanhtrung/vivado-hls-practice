...
architecture behav of dct_Loop_Xpose_Row_Outer_Loop_proc is 
    ...
    signal tmp_12_cast_fu_281_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_296_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond3_i_fu_237_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_11_cast_fu_271_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_cast_fu_259_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_275_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    col_inbuf_0_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_1_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_2_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_3_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_4_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_5_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_6_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    col_inbuf_7_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_5_reg_327)
    begin
    ...
    exitcond3_i_fu_237_p2 <= "1" when (i_1_i_reg_208 = ap_const_lv4_8) else "0";
    exitcond_flatten_fu_219_p2 <= "1" when (indvar_flatten_reg_186 = ap_const_lv7_40) else "0";
    i_1_i_mid2_fu_243_p3 <= 
        ap_const_lv4_0 when (exitcond3_i_fu_237_p2(0) = '1') else 
        i_1_i_reg_208;
    i_fu_290_p2 <= std_logic_vector(unsigned(i_1_i_mid2_fu_243_p3) + unsigned(ap_const_lv4_1));
    ...
    j_0_i_mid2_fu_251_p3 <= 
        j_fu_231_p2 when (exitcond3_i_fu_237_p2(0) = '1') else 
        j_0_i_phi_fu_201_p4;
    ...
    row_outbuf_i_address0 <= tmp_12_cast_fu_281_p1(6 - 1 downto 0);
    ...
    tmp_11_cast_fu_271_p1 <= std_logic_vector(resize(unsigned(tmp_fu_263_p3),8));
    tmp_12_cast_fu_281_p1 <= std_logic_vector(resize(unsigned(tmp_1_fu_275_p2),64));
    tmp_1_fu_275_p2 <= std_logic_vector(unsigned(tmp_11_cast_fu_271_p1) + unsigned(tmp_cast_fu_259_p1));
    tmp_5_fu_286_p1 <= i_1_i_mid2_fu_243_p3(3 - 1 downto 0);
    tmp_cast_fu_259_p1 <= std_logic_vector(resize(unsigned(j_0_i_mid2_fu_251_p3),8));
    tmp_fu_263_p3 <= (i_1_i_mid2_fu_243_p3 & ap_const_lv3_0);
