...
void dct_col_inbuf_0::proc_i_q0() {
    i_q0.write(buf_q0[iptr.read()].read());
}

void dct_col_inbuf_0::proc_t_q0() {
    t_q0.write(buf_q0[tptr.read()].read());
}

void dct_col_inbuf_0::proc_i_q1() {
    i_q1.write(buf_q1[iptr.read()].read());
}

void dct_col_inbuf_0::proc_t_q1() {
    t_q1.write(buf_q1[tptr.read()].read());
}

void dct_col_inbuf_0::proc_buffer_signals() {
    for (unsigned i = 0; i < BufferCount; i++) {
        if (iptr.read() == i) {
