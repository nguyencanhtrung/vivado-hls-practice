...
architecture behav of dct is 
    ...
    "dct,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.930000,HLS_SYN_LAT=508,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=8,HLS_SYN_FF=1243,HLS_SYN_LUT=634}";
    ...
    signal tmp_4_i_fu_301_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_4_i_reg_336 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_20_cast_fu_296_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_5_i_fu_313_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond_i3_fu_236_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal r_fu_230_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_fu_258_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_fu_270_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal c_i_mid2_fu_242_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_18_cast_fu_266_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_i_cast_fu_286_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_290_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal c_i_cast2_fu_282_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_1_i_fu_274_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    buf_2d_out_address0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it0, ap_sig_cseq_ST_st4_fsm_3, grp_dct_dct_2d_fu_167_out_block_address0, tmp_20_cast_fu_296_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0))) then 
            buf_2d_out_address0 <= tmp_20_cast_fu_296_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
    ...
    c_fu_307_p2 <= std_logic_vector(unsigned(ap_const_lv4_1) + unsigned(c_i_mid2_fu_242_p3));
    c_i_cast2_fu_282_p1 <= std_logic_vector(resize(unsigned(c_i_mid2_fu_242_p3),6));
    c_i_mid2_fu_242_p3 <= 
        ap_const_lv4_0 when (exitcond_i3_fu_236_p2(0) = '1') else 
        c_i_reg_156;
    exitcond_flatten_fu_218_p2 <= "1" when (indvar_flatten_reg_134 = ap_const_lv7_40) else "0";
    exitcond_i3_fu_236_p2 <= "1" when (c_i_reg_156 = ap_const_lv4_8) else "0";
    ...
    output_r_address0 <= tmp_5_i_fu_313_p1(6 - 1 downto 0);
    ...
    r_fu_230_p2 <= std_logic_vector(unsigned(ap_const_lv4_1) + unsigned(r_i_phi_fu_149_p4));
    r_i_mid2_fu_250_p3 <= 
        r_fu_230_p2 when (exitcond_i3_fu_236_p2(0) = '1') else 
        r_i_phi_fu_149_p4;
    ...
    tmp_18_cast_fu_266_p1 <= std_logic_vector(resize(unsigned(tmp_fu_258_p3),8));
    tmp_1_i_fu_274_p3 <= (tmp_5_fu_270_p1 & ap_const_lv3_0);
    tmp_20_cast_fu_296_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_290_p2),64));
    tmp_3_i_cast_fu_286_p1 <= std_logic_vector(resize(unsigned(c_i_mid2_fu_242_p3),8));
    tmp_4_i_fu_301_p2 <= std_logic_vector(unsigned(c_i_cast2_fu_282_p1) + unsigned(tmp_1_i_fu_274_p3));
    tmp_5_fu_270_p1 <= r_i_mid2_fu_250_p3(3 - 1 downto 0);
    tmp_5_i_fu_313_p1 <= std_logic_vector(resize(unsigned(tmp_4_i_reg_336),64));
    tmp_fu_258_p3 <= (r_i_mid2_fu_250_p3 & ap_const_lv3_0);
    tmp_s_fu_290_p2 <= std_logic_vector(unsigned(tmp_18_cast_fu_266_p1) + unsigned(tmp_3_i_cast_fu_286_p1));
end behav;
