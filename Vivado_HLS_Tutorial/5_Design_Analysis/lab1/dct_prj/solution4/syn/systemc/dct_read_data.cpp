...
void dct_read_data::thread_c_1_fu_290_p2() {
    c_1_fu_290_p2 = (!c_mid2_fu_243_p3.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(c_mid2_fu_243_p3.read()) + sc_biguint<4>(ap_const_lv4_1));
}
...
void dct_read_data::thread_r_1_fu_231_p2() {
...
void dct_read_data::thread_r_mid2_fu_251_p3() {
    r_mid2_fu_251_p3 = (!exitcond_fu_237_p2.read()[0].is_01())? sc_lv<4>(): ((exitcond_fu_237_p2.read()[0].to_bool())? r_1_fu_231_p2.read(): r_phi_fu_201_p4.read());
}
...
void dct_read_data::thread_tmp_3_fu_286_p1() {
    tmp_3_fu_286_p1 = c_mid2_fu_243_p3.read().range(3-1, 0);
}
...
void dct_read_data::thread_tmp_9_fu_275_p2() {
    tmp_9_fu_275_p2 = (!c_cast2_fu_271_p1.read().is_01() || !tmp_fu_263_p3.read().is_01())? sc_lv<6>(): (sc_biguint<6>(c_cast2_fu_271_p1.read()) + sc_biguint<6>(tmp_fu_263_p3.read()));
}
