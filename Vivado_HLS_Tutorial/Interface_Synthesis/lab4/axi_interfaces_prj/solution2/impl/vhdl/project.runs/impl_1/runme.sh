...
HD_PWD=/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab4/axi_interfaces_prj/solution2/impl/vhdl/project.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log axi_interfaces.vdi -applog -m64 -messageDb vivado.pb -mode batch -source axi_interfaces.tcl -notrace
