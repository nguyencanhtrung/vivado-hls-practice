; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab3/array_io_prj/solution1/.autopilot/db/a.o.2.bc'
...
define void @array_io([32 x i16]* %d_o, [32 x i16]* %d_i) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecMemCore([32 x i16]* %d_i, [1 x i8]* @.str, [12 x i8]* @.str1, [1 x i8]* @.str, i32 -1, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str) nounwind
  call void (...)* @_ssdm_op_SpecMemCore([32 x i16]* %d_o, [1 x i8]* @.str, [12 x i8]* @.str1, [1 x i8]* @.str, i32 -1, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str) nounwind
  br label %1, !dbg !45                           ; [debug line = 67:17]

; <label>:1                                       ; preds = %3, %0
  %i = phi i6 [ 0, %0 ], [ %i.1, %3 ]             ; [#uses=4 type=i6]
  %rem = trunc i6 %i to i3, !dbg !45              ; [#uses=1 type=i3] [debug line = 67:17]
  %exitcond = icmp eq i6 %i, -32, !dbg !45        ; [#uses=1 type=i1] [debug line = 67:17]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 32, i64 32, i64 32) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond, label %4, label %3, !dbg !45   ; [debug line = 67:17]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @.str2) nounwind, !dbg !48 ; [debug line = 67:35]
  call void @llvm.dbg.value(metadata !{i3 %rem}, i64 0, metadata !50), !dbg !51 ; [debug line = 68:3] [debug variable = rem]
  %tmp = zext i3 %rem to i64, !dbg !52            ; [#uses=1 type=i64] [debug line = 69:3]
  %acc.addr = getelementptr inbounds [8 x i32]* @acc, i64 0, i64 %tmp, !dbg !52 ; [#uses=2 type=i32*] [debug line = 69:3]
  %acc.load = load i32* %acc.addr, align 4, !dbg !52 ; [#uses=1 type=i32] [debug line = 69:3]
  %tmp.1 = zext i6 %i to i64, !dbg !52            ; [#uses=2 type=i64] [debug line = 69:3]
  %d_i.addr = getelementptr [32 x i16]* %d_i, i64 0, i64 %tmp.1, !dbg !52 ; [#uses=1 type=i16*] [debug line = 69:3]
  %d_i.load = load i16* %d_i.addr, align 2, !dbg !52 ; [#uses=1 type=i16] [debug line = 69:3]
  %tmp.2 = sext i16 %d_i.load to i32, !dbg !52    ; [#uses=1 type=i32] [debug line = 69:3]
  %temp = add nsw i32 %tmp.2, %acc.load, !dbg !52 ; [#uses=2 type=i32] [debug line = 69:3]
  call void @llvm.dbg.value(metadata !{i32 %temp}, i64 0, metadata !53), !dbg !52 ; [debug line = 69:3] [debug variable = temp]
  store i32 %temp, i32* %acc.addr, align 4, !dbg !54 ; [debug line = 70:3]
  %tmp.3 = trunc i32 %temp to i16, !dbg !55       ; [#uses=1 type=i16] [debug line = 71:3]
  %d_o.addr = getelementptr [32 x i16]* %d_o, i64 0, i64 %tmp.1, !dbg !55 ; [#uses=1 type=i16*] [debug line = 71:3]
  store i16 %tmp.3, i16* %d_o.addr, align 2, !dbg !55 ; [debug line = 71:3]
  %i.1 = add i6 %i, 1, !dbg !56                   ; [#uses=1 type=i6] [debug line = 67:29]
  call void @llvm.dbg.value(metadata !{i6 %i.1}, i64 0, metadata !57), !dbg !56 ; [debug line = 67:29] [debug variable = i]
  br label %1, !dbg !56                           ; [debug line = 67:29]

; <label>:4                                       ; preds = %1
  ret void, !dbg !58                              ; [debug line = 73:1]
}
...
!5 = metadata !{i32 786473, metadata !"array_io.c", metadata !"/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab3", null} ; [ DW_TAG_file_type ]
...
!21 = metadata !{i32 786473, metadata !"/usr/include/libio.h", metadata !"/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab3", null} ; [ DW_TAG_file_type ]
!22 = metadata !{i32 786451, null, metadata !"_IO_FILE_plus", metadata !21, i32 344, i32 0, i32 0, i32 0, i32 4, null, null, i32 0} ; [ DW_TAG_structure_type ]
...
!25 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !26, i32 27, metadata !17, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!26 = metadata !{i32 786473, metadata !"/usr/include/bits/sys_errlist.h", metadata !"/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab3", null} ; [ DW_TAG_file_type ]
...
!45 = metadata !{i32 67, i32 17, metadata !46, null}
!46 = metadata !{i32 786443, metadata !47, i32 67, i32 12, metadata !5, i32 1} ; [ DW_TAG_lexical_block ]
!47 = metadata !{i32 786443, metadata !4, i32 57, i32 53, metadata !5, i32 0} ; [ DW_TAG_lexical_block ]
!48 = metadata !{i32 67, i32 35, metadata !49, null}
!49 = metadata !{i32 786443, metadata !46, i32 67, i32 34, metadata !5, i32 2} ; [ DW_TAG_lexical_block ]
!50 = metadata !{i32 786688, metadata !47, metadata !"rem", metadata !5, i32 58, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!51 = metadata !{i32 68, i32 3, metadata !49, null}
!52 = metadata !{i32 69, i32 3, metadata !49, null}
!53 = metadata !{i32 786688, metadata !47, metadata !"temp", metadata !5, i32 64, metadata !16, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!54 = metadata !{i32 70, i32 3, metadata !49, null}
!55 = metadata !{i32 71, i32 3, metadata !49, null}
!56 = metadata !{i32 67, i32 29, metadata !46, null}
!57 = metadata !{i32 786688, metadata !47, metadata !"i", metadata !5, i32 58, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!58 = metadata !{i32 73, i32 1, metadata !47, null}
