...
(* CORE_GENERATION_INFO="array_io,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.400000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1155,HLS_SYN_LUT=1026}" *)
...
always @ (ap_sig_cseq_ST_st3_fsm_2 or ap_sig_bdd_355) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & ~ap_sig_bdd_355)) begin
...
always @ (ap_start or ap_CS_fsm or ap_sig_bdd_355) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
