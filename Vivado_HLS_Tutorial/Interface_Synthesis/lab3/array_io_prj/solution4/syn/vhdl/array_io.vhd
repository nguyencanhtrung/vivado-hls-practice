...
architecture behav of array_io is 
    ...
    "array_io,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.400000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1155,HLS_SYN_LUT=1026}";
...
begin
    ...
    acc_0_loc_assign_1_fu_726_p2 <= std_logic_vector(unsigned(acc_0_loc_assign_2_reg_1098) + unsigned(tmp_2_8_fu_722_p1));
    acc_0_loc_assign_2_fu_586_p2 <= std_logic_vector(unsigned(acc_0) + unsigned(tmp_2_fu_582_p1));
    acc_0_loc_fu_830_p2 <= std_logic_vector(unsigned(acc_0_loc_assign_1_fu_726_p2) + unsigned(tmp_2_15_fu_826_p1));
    acc_1_loc_assign_1_fu_739_p2 <= std_logic_vector(unsigned(acc_1_loc_assign_2_reg_1108) + unsigned(tmp_2_9_fu_735_p1));
    acc_1_loc_assign_2_fu_604_p2 <= std_logic_vector(unsigned(acc_1) + unsigned(tmp_2_1_fu_600_p1));
    acc_1_loc_fu_844_p2 <= std_logic_vector(unsigned(acc_1_loc_assign_1_fu_739_p2) + unsigned(tmp_2_16_fu_840_p1));
    acc_2_loc_assign_1_fu_752_p2 <= std_logic_vector(unsigned(acc_2_loc_assign_2_reg_1118) + unsigned(tmp_2_s_fu_748_p1));
    acc_2_loc_assign_2_fu_622_p2 <= std_logic_vector(unsigned(acc_2) + unsigned(tmp_2_2_fu_618_p1));
    acc_2_loc_fu_858_p2 <= std_logic_vector(unsigned(acc_2_loc_assign_1_fu_752_p2) + unsigned(tmp_2_17_fu_854_p1));
    acc_3_loc_assign_1_fu_765_p2 <= std_logic_vector(unsigned(acc_3_loc_assign_2_reg_1128) + unsigned(tmp_2_10_fu_761_p1));
    acc_3_loc_assign_2_fu_640_p2 <= std_logic_vector(unsigned(acc_3) + unsigned(tmp_2_3_fu_636_p1));
    acc_3_loc_fu_872_p2 <= std_logic_vector(unsigned(acc_3_loc_assign_1_fu_765_p2) + unsigned(tmp_2_18_fu_868_p1));
    acc_4_loc_assign_1_fu_778_p2 <= std_logic_vector(unsigned(acc_4_loc_assign_2_reg_1138) + unsigned(tmp_2_11_fu_774_p1));
    acc_4_loc_assign_2_fu_658_p2 <= std_logic_vector(unsigned(acc_4) + unsigned(tmp_2_4_fu_654_p1));
    acc_4_loc_fu_886_p2 <= std_logic_vector(unsigned(acc_4_loc_assign_1_fu_778_p2) + unsigned(tmp_2_19_fu_882_p1));
    acc_5_loc_assign_1_fu_791_p2 <= std_logic_vector(unsigned(acc_5_loc_assign_2_reg_1148) + unsigned(tmp_2_12_fu_787_p1));
    acc_5_loc_assign_2_fu_676_p2 <= std_logic_vector(unsigned(acc_5) + unsigned(tmp_2_5_fu_672_p1));
    acc_5_loc_fu_900_p2 <= std_logic_vector(unsigned(acc_5_loc_assign_1_fu_791_p2) + unsigned(tmp_2_20_fu_896_p1));
    acc_6_loc_assign_1_fu_804_p2 <= std_logic_vector(unsigned(acc_6_loc_assign_2_reg_1158) + unsigned(tmp_2_13_fu_800_p1));
    acc_6_loc_assign_2_fu_694_p2 <= std_logic_vector(unsigned(acc_6) + unsigned(tmp_2_6_fu_690_p1));
    acc_6_loc_fu_914_p2 <= std_logic_vector(unsigned(acc_6_loc_assign_1_fu_804_p2) + unsigned(tmp_2_21_fu_910_p1));
    acc_7_loc_assign_1_fu_817_p2 <= std_logic_vector(unsigned(acc_7_loc_assign_2_reg_1168) + unsigned(tmp_2_14_fu_813_p1));
    acc_7_loc_assign_2_fu_712_p2 <= std_logic_vector(unsigned(acc_7) + unsigned(tmp_2_7_fu_708_p1));
    acc_7_loc_fu_928_p2 <= std_logic_vector(unsigned(acc_7_loc_assign_1_fu_817_p2) + unsigned(tmp_2_22_fu_924_p1));
    ...
    temp_1_fu_962_p2 <= std_logic_vector(unsigned(acc_1_loc_reg_1228) + unsigned(tmp_2_24_fu_958_p1));
    temp_2_fu_982_p2 <= std_logic_vector(unsigned(acc_2_loc_reg_1238) + unsigned(tmp_2_25_fu_978_p1));
    temp_3_fu_1002_p2 <= std_logic_vector(unsigned(acc_3_loc_reg_1248) + unsigned(tmp_2_26_fu_998_p1));
    temp_4_fu_1022_p2 <= std_logic_vector(unsigned(acc_4_loc_reg_1258) + unsigned(tmp_2_27_fu_1018_p1));
    temp_5_fu_1042_p2 <= std_logic_vector(unsigned(acc_5_loc_reg_1268) + unsigned(tmp_2_28_fu_1038_p1));
    temp_6_fu_1062_p2 <= std_logic_vector(unsigned(acc_6_loc_reg_1278) + unsigned(tmp_2_29_fu_1058_p1));
    temp_7_fu_1082_p2 <= std_logic_vector(unsigned(acc_7_loc_reg_1288) + unsigned(tmp_2_30_fu_1078_p1));
    temp_s_fu_942_p2 <= std_logic_vector(unsigned(acc_0_loc_reg_1218) + unsigned(tmp_2_23_fu_938_p1));
