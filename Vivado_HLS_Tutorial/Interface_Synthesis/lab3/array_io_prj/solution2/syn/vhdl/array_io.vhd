...
architecture behav of array_io is 
    ...
    "array_io,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.700000,HLS_SYN_LAT=33,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1266,HLS_SYN_LUT=1321}";
...
begin
    ...
    acc_0_loc_assign_1_fu_582_p2 <= std_logic_vector(unsigned(acc_0_loc_assign_2_reg_963) + unsigned(tmp_2_8_fu_578_p1));
    acc_0_loc_assign_2_fu_434_p2 <= std_logic_vector(unsigned(acc_0) + unsigned(tmp_2_fu_430_p1));
    acc_0_loc_fu_694_p2 <= std_logic_vector(unsigned(acc_0_loc_assign_1_reg_1043) + unsigned(tmp_2_15_fu_690_p1));
    acc_1_loc_assign_1_fu_596_p2 <= std_logic_vector(unsigned(acc_1_loc_assign_2_reg_973) + unsigned(tmp_2_9_fu_592_p1));
    acc_1_loc_assign_2_fu_453_p2 <= std_logic_vector(unsigned(acc_1) + unsigned(tmp_2_1_fu_449_p1));
    acc_1_loc_fu_708_p2 <= std_logic_vector(unsigned(acc_1_loc_assign_1_reg_1053) + unsigned(tmp_2_16_fu_704_p1));
    acc_2_loc_assign_1_fu_610_p2 <= std_logic_vector(unsigned(acc_2_loc_assign_2_reg_983) + unsigned(tmp_2_s_fu_606_p1));
    acc_2_loc_assign_2_fu_472_p2 <= std_logic_vector(unsigned(acc_2) + unsigned(tmp_2_2_fu_468_p1));
    acc_2_loc_fu_722_p2 <= std_logic_vector(unsigned(acc_2_loc_assign_1_reg_1063) + unsigned(tmp_2_17_fu_718_p1));
    acc_3_loc_assign_1_fu_624_p2 <= std_logic_vector(unsigned(acc_3_loc_assign_2_reg_993) + unsigned(tmp_2_10_fu_620_p1));
    acc_3_loc_assign_2_fu_491_p2 <= std_logic_vector(unsigned(acc_3) + unsigned(tmp_2_3_fu_487_p1));
    acc_3_loc_fu_736_p2 <= std_logic_vector(unsigned(acc_3_loc_assign_1_reg_1073) + unsigned(tmp_2_18_fu_732_p1));
    acc_4_loc_assign_1_fu_638_p2 <= std_logic_vector(unsigned(acc_4_loc_assign_2_reg_1003) + unsigned(tmp_2_11_fu_634_p1));
    acc_4_loc_assign_2_fu_510_p2 <= std_logic_vector(unsigned(acc_4) + unsigned(tmp_2_4_fu_506_p1));
    acc_4_loc_fu_750_p2 <= std_logic_vector(unsigned(acc_4_loc_assign_1_reg_1083) + unsigned(tmp_2_19_fu_746_p1));
    acc_5_loc_assign_1_fu_652_p2 <= std_logic_vector(unsigned(acc_5_loc_assign_2_reg_1013) + unsigned(tmp_2_12_fu_648_p1));
    acc_5_loc_assign_2_fu_529_p2 <= std_logic_vector(unsigned(acc_5) + unsigned(tmp_2_5_fu_525_p1));
    acc_5_loc_fu_783_p2 <= std_logic_vector(unsigned(acc_5_loc_assign_1_reg_1093) + unsigned(tmp_2_20_fu_779_p1));
    acc_6_loc_assign_1_fu_666_p2 <= std_logic_vector(unsigned(acc_6_loc_assign_2_reg_1023) + unsigned(tmp_2_13_fu_662_p1));
    acc_6_loc_assign_2_fu_548_p2 <= std_logic_vector(unsigned(acc_6) + unsigned(tmp_2_6_fu_544_p1));
    acc_6_loc_fu_834_p2 <= std_logic_vector(unsigned(acc_6_loc_assign_1_reg_1103) + unsigned(tmp_2_21_fu_831_p1));
    acc_7_loc_assign_1_fu_680_p2 <= std_logic_vector(unsigned(acc_7_loc_assign_2_reg_1033) + unsigned(tmp_2_14_fu_676_p1));
    acc_7_loc_assign_2_fu_567_p2 <= std_logic_vector(unsigned(acc_7) + unsigned(tmp_2_7_fu_563_p1));
    acc_7_loc_fu_886_p2 <= std_logic_vector(unsigned(acc_7_loc_assign_1_reg_1113) + unsigned(tmp_2_22_fu_882_p1));
    ...
    temp_1_fu_797_p2 <= std_logic_vector(unsigned(acc_1_loc_reg_1143) + unsigned(tmp_2_24_fu_793_p1));
    temp_2_fu_816_p2 <= std_logic_vector(unsigned(acc_2_loc_reg_1158) + unsigned(tmp_2_25_fu_812_p1));
    temp_3_fu_848_p2 <= std_logic_vector(unsigned(acc_3_loc_reg_1178) + unsigned(tmp_2_26_fu_844_p1));
    temp_4_fu_867_p2 <= std_logic_vector(unsigned(acc_4_loc_reg_1193) + unsigned(tmp_2_27_fu_863_p1));
    temp_5_fu_900_p2 <= std_logic_vector(unsigned(acc_5_loc_reg_1213) + unsigned(tmp_2_28_fu_896_p1));
    temp_6_fu_919_p2 <= std_logic_vector(unsigned(acc_6_loc_reg_1238) + unsigned(tmp_2_29_fu_915_p1));
    temp_7_fu_938_p2 <= std_logic_vector(unsigned(acc_7_loc_reg_1258) + unsigned(tmp_2_30_fu_934_p1));
    temp_s_fu_764_p2 <= std_logic_vector(unsigned(acc_0_loc_reg_1128) + unsigned(tmp_2_23_fu_760_p1));
