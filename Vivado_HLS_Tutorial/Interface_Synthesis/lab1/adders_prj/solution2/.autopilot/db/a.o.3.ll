; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/a.o.3.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable readnone {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [11 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !33 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, [8 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !35 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [8 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !36 ; [debug line = 54:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [8 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !37 ; [debug line = 55:1]
  %tmp1 = add i32 %in1_read, %in3_read, !dbg !38  ; [#uses=1 type=i32] [debug line = 60:2]
  %sum = add i32 %tmp1, %in2_read, !dbg !38       ; [#uses=1 type=i32] [debug line = 60:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !39), !dbg !38 ; [debug line = 60:2] [debug variable = sum]
  ret i32 %sum, !dbg !40                          ; [debug line = 62:2]
}
...
!22 = metadata !{i32 786473, metadata !"adders.c", metadata !"/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Interface_Synthesis/lab1", null} ; [ DW_TAG_file_type ]
...
!33 = metadata !{i32 50, i32 1, metadata !34, null}
!34 = metadata !{i32 786443, metadata !21, i32 48, i32 39, metadata !22, i32 0} ; [ DW_TAG_lexical_block ]
!35 = metadata !{i32 53, i32 1, metadata !34, null}
!36 = metadata !{i32 54, i32 1, metadata !34, null}
!37 = metadata !{i32 55, i32 1, metadata !34, null}
!38 = metadata !{i32 60, i32 2, metadata !34, null}
!39 = metadata !{i32 786688, metadata !34, metadata !"sum", metadata !22, i32 58, metadata !25, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!40 = metadata !{i32 62, i32 2, metadata !34, null}
