...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_6_U1->din1(data1_reg_116);
    fir_mul_32s_32s_32_6_U1->ce(grp_fu_173_ce);
    fir_mul_32s_32s_32_6_U1->dout(grp_fu_173_p2);
...
void fir::thread_acc_1_fu_179_p2() {
    acc_1_fu_179_p2 = (!grp_fu_173_p2.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_biguint<32>(grp_fu_173_p2.read()) + sc_biguint<32>(acc_reg_91.read()));
}
