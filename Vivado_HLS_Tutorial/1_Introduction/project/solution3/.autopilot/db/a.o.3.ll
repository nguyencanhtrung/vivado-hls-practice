; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/Introduction/project/solution3/.autopilot/db/a.o.3.bc'
...
define void @fir(i32* %y, [11 x i32]* %c, i32 %x) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !48), !dbg !49 ; [debug line = 68:7] [debug variable = data]
...
!49 = metadata !{i32 68, i32 7, metadata !47, null}
