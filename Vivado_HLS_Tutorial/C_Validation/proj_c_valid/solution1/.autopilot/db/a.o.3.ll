; ModuleID = '/home/ctnguyen/work/tut_vivadohls/Vivado_HLS_Tutorial/C_Validation/proj_c_valid/solution1/.autopilot/db/a.o.3.bc'
...
.preheader.preheader:
  ...
  br label %.preheader, !dbg !39                  ; [debug line = 73:9]

.preheader:                                       ; preds = %0, %.preheader.preheader
  %i_1 = phi i9 [ %i, %0 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i9]
  %exitcond = icmp eq i9 %i_1, -256, !dbg !39     ; [#uses=1 type=i1] [debug line = 73:9]
  %i = add i9 %i_1, 1, !dbg !42                   ; [#uses=1 type=i9] [debug line = 73:25]
  br i1 %exitcond, label %1, label %0, !dbg !39   ; [debug line = 73:9]

; <label>:0                                       ; preds = %.preheader
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256) nounwind ; [#uses=0 type=i32]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str2) nounwind, !dbg !43 ; [#uses=1 type=i32] [debug line = 73:31]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !45 ; [debug line = 74:1]
  %tmp_s = zext i9 %i_1 to i64, !dbg !46          ; [#uses=3 type=i64] [debug line = 75:2]
  %window_coeff_addr = getelementptr [256 x i14]* @window_coeff, i64 0, i64 %tmp_s, !dbg !46 ; [#uses=1 type=i14*] [debug line = 75:2]
  %window_coeff_load = load i14* %window_coeff_addr, align 2, !dbg !46 ; [#uses=1 type=i14] [debug line = 75:2]
  %tmp_3 = zext i14 %window_coeff_load to i32, !dbg !46 ; [#uses=1 type=i32] [debug line = 75:2]
  %indata_addr = getelementptr [256 x i16]* %indata, i64 0, i64 %tmp_s, !dbg !46 ; [#uses=1 type=i16*] [debug line = 75:2]
  %indata_load = load i16* %indata_addr, align 2, !dbg !46 ; [#uses=1 type=i16] [debug line = 75:2]
  %tmp_4 = sext i16 %indata_load to i32, !dbg !46 ; [#uses=1 type=i32] [debug line = 75:2]
  %tmp_5 = mul nsw i32 %tmp_4, %tmp_3, !dbg !46   ; [#uses=1 type=i32] [debug line = 75:2]
  %outdata_addr = getelementptr [256 x i32]* %outdata, i64 0, i64 %tmp_s, !dbg !46 ; [#uses=1 type=i32*] [debug line = 75:2]
  store i32 %tmp_5, i32* %outdata_addr, align 4, !dbg !46 ; [debug line = 75:2]
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str2, i32 %tmp_2) nounwind, !dbg !47 ; [#uses=0 type=i32] [debug line = 76:4]
  call void @llvm.dbg.value(metadata !{i9 %i}, i64 0, metadata !48), !dbg !42 ; [debug line = 73:25] [debug variable = i]
  br label %.preheader, !dbg !42                  ; [debug line = 73:25]
...
!40 = metadata !{i32 786443, metadata !41, i32 73, i32 4, metadata !19, i32 3} ; [ DW_TAG_lexical_block ]
...
!44 = metadata !{i32 786443, metadata !40, i32 73, i32 30, metadata !19, i32 4} ; [ DW_TAG_lexical_block ]
