...
if {[file isfile hamming_window.autotvin.dat]} {
	file delete -force hamming_window.autotvin.dat
}

if {[file isfile hamming_window.autotvout.dat]} {
	file delete -force hamming_window.autotvout.dat
}
