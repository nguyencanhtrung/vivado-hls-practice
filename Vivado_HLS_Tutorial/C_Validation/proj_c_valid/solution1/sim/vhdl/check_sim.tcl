...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hamming_window.autotvin_outdata.dat"
         "c.hamming_window.autotvin_indata.dat"
         "c.hamming_window.autotvout_outdata.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hamming_window.autotvout_outdata.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
