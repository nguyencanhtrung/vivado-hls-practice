...
$(ObjDir)/hamming_window_test.c_pre.c.tb.o : hamming_window_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) hamming_window_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/hamming_window.c_pre.c.tb.o : hamming_window.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) hamming_window.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
