...
#include "hamming_window_mul_mul_14ns_16s_30_1.h"
...
struct hamming_window : public sc_module {
    ...
    hamming_window_mul_mul_14ns_16s_30_1<1,1,14,16,30>* hamming_window_mul_mul_14ns_16s_30_1_U1;
    ...
    sc_signal< sc_lv<1> > ap_reg_ppstg_exitcond_reg_119_pp0_it1;
    sc_signal< sc_lv<1> > ap_reg_ppstg_exitcond_reg_119_pp0_it2;
    sc_signal< sc_lv<9> > i_1_fu_91_p2;
    sc_signal< sc_lv<64> > tmp_fu_97_p1;
    sc_signal< sc_lv<64> > tmp_reg_128;
    sc_signal< sc_lv<64> > ap_reg_ppstg_tmp_reg_128_pp0_it1;
    sc_signal< sc_lv<64> > ap_reg_ppstg_tmp_reg_128_pp0_it2;
    sc_signal< sc_lv<14> > window_coeff_load_reg_143;
    sc_signal< sc_lv<16> > indata_load_reg_148;
    sc_signal< sc_lv<30> > tmp_3_fu_113_p2;
    sc_signal< sc_lv<30> > tmp_3_reg_153;
    sc_signal< sc_lv<14> > tmp_3_fu_113_p0;
    sc_signal< sc_logic > ap_sig_cseq_ST_st6_fsm_2;
    sc_signal< bool > ap_sig_bdd_131;
    sc_signal< sc_lv<3> > ap_NS_fsm;
    sc_signal< sc_lv<30> > tmp_3_fu_113_p00;
    ...
    void thread_tmp_3_fu_113_p0();
    void thread_tmp_3_fu_113_p00();
