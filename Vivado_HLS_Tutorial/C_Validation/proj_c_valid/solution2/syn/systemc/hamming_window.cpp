...
hamming_window::hamming_window(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    hamming_window_mul_mul_14ns_16s_30_1_U1 = new hamming_window_mul_mul_14ns_16s_30_1<1,1,14,16,30>("hamming_window_mul_mul_14ns_16s_30_1_U1");
    hamming_window_mul_mul_14ns_16s_30_1_U1->din0(tmp_3_fu_113_p0);
    hamming_window_mul_mul_14ns_16s_30_1_U1->din1(indata_load_reg_148);
    hamming_window_mul_mul_14ns_16s_30_1_U1->dout(tmp_3_fu_113_p2);
    ...
    sensitive << ( ap_reg_ppstg_tmp_reg_128_pp0_it2 );
    ...
    sensitive << ( ap_reg_ppiten_pp0_it3 );
    sensitive << ( tmp_3_reg_153 );

    SC_METHOD(thread_outdata_we0);
    sensitive << ( ap_reg_ppiten_pp0_it3 );
    sensitive << ( ap_reg_ppstg_exitcond_reg_119_pp0_it2 );

    SC_METHOD(thread_tmp_3_fu_113_p0);
    sensitive << ( ap_reg_ppiten_pp0_it2 );
    sensitive << ( tmp_3_fu_113_p00 );

    SC_METHOD(thread_tmp_3_fu_113_p00);
    sensitive << ( window_coeff_load_reg_143 );
    ...
    sc_trace(mVcdFile, ap_reg_ppstg_exitcond_reg_119_pp0_it1, "ap_reg_ppstg_exitcond_reg_119_pp0_it1");
    sc_trace(mVcdFile, ap_reg_ppstg_exitcond_reg_119_pp0_it2, "ap_reg_ppstg_exitcond_reg_119_pp0_it2");
    sc_trace(mVcdFile, i_1_fu_91_p2, "i_1_fu_91_p2");
    sc_trace(mVcdFile, tmp_fu_97_p1, "tmp_fu_97_p1");
    sc_trace(mVcdFile, tmp_reg_128, "tmp_reg_128");
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_128_pp0_it1, "ap_reg_ppstg_tmp_reg_128_pp0_it1");
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_128_pp0_it2, "ap_reg_ppstg_tmp_reg_128_pp0_it2");
    sc_trace(mVcdFile, window_coeff_load_reg_143, "window_coeff_load_reg_143");
    sc_trace(mVcdFile, indata_load_reg_148, "indata_load_reg_148");
    sc_trace(mVcdFile, tmp_3_fu_113_p2, "tmp_3_fu_113_p2");
    sc_trace(mVcdFile, tmp_3_reg_153, "tmp_3_reg_153");
    sc_trace(mVcdFile, tmp_3_fu_113_p0, "tmp_3_fu_113_p0");
    ...
    sc_trace(mVcdFile, tmp_3_fu_113_p00, "tmp_3_fu_113_p00");
#endif
...
hamming_window::~hamming_window() {
    ...
    delete hamming_window_mul_mul_14ns_16s_30_1_U1;
}
...
void hamming_window::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_pp0_stg0_fsm_1.read()) && 
         ...
         esl_seteq<1,1,1>(exitcond_fu_85_p2.read(), ap_const_lv1_0))) {
        i_reg_74 = i_1_fu_91_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        i_reg_74 = ap_const_lv9_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_pp0_stg0_fsm_1.read())) {
        ap_reg_ppstg_exitcond_reg_119_pp0_it1 = exitcond_reg_119.read();
        ap_reg_ppstg_tmp_reg_128_pp0_it1 = tmp_reg_128.read();
        exitcond_reg_119 = exitcond_fu_85_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_true, ap_true)) {
        ap_reg_ppstg_exitcond_reg_119_pp0_it2 = ap_reg_ppstg_exitcond_reg_119_pp0_it1.read();
        ap_reg_ppstg_tmp_reg_128_pp0_it2 = ap_reg_ppstg_tmp_reg_128_pp0_it1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_pp0_stg0_fsm_1.read()) && esl_seteq<1,1,1>(exitcond_reg_119.read(), ap_const_lv1_0))) {
        indata_load_reg_148 = indata_q0.read();
        window_coeff_load_reg_143 = window_coeff_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_reg_ppstg_exitcond_reg_119_pp0_it1.read(), ap_const_lv1_0)) {
        tmp_3_reg_153 = tmp_3_fu_113_p2.read();
    }
...
void hamming_window::thread_ap_sig_bdd_131() {
...
void hamming_window::thread_exitcond_fu_85_p2() {
    exitcond_fu_85_p2 = (!i_reg_74.read().is_01() || !ap_const_lv9_100.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_74.read() == ap_const_lv9_100);
}

void hamming_window::thread_i_1_fu_91_p2() {
    i_1_fu_91_p2 = (!i_reg_74.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_reg_74.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void hamming_window::thread_indata_address0() {
    indata_address0 =  (sc_lv<8>) (tmp_fu_97_p1.read());
}
...
void hamming_window::thread_outdata_address0() {
    outdata_address0 =  (sc_lv<8>) (ap_reg_ppstg_tmp_reg_128_pp0_it2.read());
}
...
void hamming_window::thread_outdata_d0() {
    outdata_d0 = esl_sext<32,30>(tmp_3_reg_153.read());
}

void hamming_window::thread_outdata_we0() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it3.read()) && 
          esl_seteq<1,1,1>(ap_reg_ppstg_exitcond_reg_119_pp0_it2.read(), ap_const_lv1_0)))) {
...
void hamming_window::thread_tmp_3_fu_113_p0() {
    tmp_3_fu_113_p0 =  (sc_lv<14>) (tmp_3_fu_113_p00.read());
}

void hamming_window::thread_tmp_3_fu_113_p00() {
    tmp_3_fu_113_p00 = esl_zext<30,14>(window_coeff_load_reg_143.read());
}

void hamming_window::thread_tmp_fu_97_p1() {
    tmp_fu_97_p1 = esl_zext<64,9>(i_reg_74.read());
}

void hamming_window::thread_window_coeff_address0() {
    window_coeff_address0 =  (sc_lv<8>) (tmp_fu_97_p1.read());
}
