...
architecture behav of duc_mixer is 
    ...
    signal grp_fu_352_p4 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_fu_343_p0 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_i6_fu_250_p1 : STD_LOGIC_VECTOR (18 downto 0);
    signal grp_fu_343_p1 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_i5_fu_247_p1 : STD_LOGIC_VECTOR (18 downto 0);
    signal grp_fu_352_p0 : STD_LOGIC_VECTOR (17 downto 0);
    signal grp_fu_352_p1 : STD_LOGIC_VECTOR (17 downto 0);
...
begin
    ...
    duc_am_submul_16s_16s_18s_32_4_U10 : component duc_am_submul_16s_16s_18s_32_4
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    duc_ama_addmuladd_18s_18s_16s_32s_32_3_U11 : component duc_ama_addmuladd_18s_18s_16s_32s_32_3
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 18,
    ...
    duc_ama_submuladd_18s_18s_16s_32s_32_3_U12 : component duc_ama_submuladd_18s_18s_16s_32s_32_3
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 18,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st9_fsm_8)) then
                tmp_3_reg_467 <= grp_fu_343_p4;
                tmp_7_reg_462 <= grp_fu_352_p4;
            end if;
        end if;
    end process;
    ...
    grp_fu_343_p0 <= tmp_i6_fu_250_p1(18 - 1 downto 0);
    grp_fu_343_p1 <= tmp_i5_fu_247_p1(18 - 1 downto 0);
    grp_fu_352_ce <= ap_const_logic_1;
    grp_fu_352_p0 <= tmp_i5_fu_247_p1(18 - 1 downto 0);
    grp_fu_352_p1 <= tmp_i6_fu_250_p1(18 - 1 downto 0);
    inc_1_fu_322_p3 <= 
