...
architecture behav of dct is 
    ...
    "dct,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.930000,HLS_SYN_LAT=507,HLS_SYN_TPT=374,HLS_SYN_MEM=4,HLS_SYN_DSP=8,HLS_SYN_FF=1509,HLS_SYN_LUT=621}";
