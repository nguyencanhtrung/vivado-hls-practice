...
struct dct_Loop_Col_DCT_Loop_proc : public sc_module {
    ...
    sc_out< sc_lv<4> > col_inbuf_0_address1;
    sc_out< sc_logic > col_inbuf_0_ce1;
    sc_in< sc_lv<16> > col_inbuf_0_q1;
    sc_out< sc_lv<4> > col_inbuf_1_address0;
    sc_out< sc_logic > col_inbuf_1_ce0;
    sc_in< sc_lv<16> > col_inbuf_1_q0;
    sc_out< sc_lv<4> > col_inbuf_1_address1;
    sc_out< sc_logic > col_inbuf_1_ce1;
    sc_in< sc_lv<16> > col_inbuf_1_q1;
    sc_out< sc_lv<4> > col_inbuf_2_address0;
    sc_out< sc_logic > col_inbuf_2_ce0;
    sc_in< sc_lv<16> > col_inbuf_2_q0;
    sc_out< sc_lv<4> > col_inbuf_2_address1;
    sc_out< sc_logic > col_inbuf_2_ce1;
    sc_in< sc_lv<16> > col_inbuf_2_q1;
    sc_out< sc_lv<4> > col_inbuf_3_address0;
    sc_out< sc_logic > col_inbuf_3_ce0;
    sc_in< sc_lv<16> > col_inbuf_3_q0;
    sc_out< sc_lv<4> > col_inbuf_3_address1;
    sc_out< sc_logic > col_inbuf_3_ce1;
    sc_in< sc_lv<16> > col_inbuf_3_q1;
    ...
    sc_out< sc_lv<6> > col_outbuf_i_address1;
    sc_out< sc_logic > col_outbuf_i_ce1;
    sc_out< sc_logic > col_outbuf_i_we1;
    sc_out< sc_lv<16> > col_outbuf_i_d1;
    ...
    sc_signal< sc_lv<4> > i_2_i_reg_38;
    sc_signal< sc_logic > ap_sig_cseq_ST_pp0_stg0_fsm_1;
    sc_signal< bool > ap_sig_bdd_87;
    sc_signal< sc_logic > ap_reg_ppiten_pp0_it0;
    sc_signal< sc_logic > ap_reg_ppiten_pp0_it1;
    sc_signal< sc_logic > ap_reg_ppiten_pp0_it2;
    sc_signal< sc_lv<1> > exitcond2_i_fu_68_p2;
    sc_signal< sc_lv<1> > exitcond2_i_reg_80;
    sc_signal< sc_lv<1> > ap_reg_ppstg_exitcond2_i_reg_80_pp0_it1;
    sc_signal< sc_lv<1> > ap_reg_ppstg_exitcond2_i_reg_80_pp0_it2;
    ...
    sc_signal< sc_lv<4> > i_2_i_phi_fu_42_p4;
    ...
    void thread_col_inbuf_0_address1();
    void thread_col_inbuf_0_ce0();
    void thread_col_inbuf_0_ce1();
    void thread_col_inbuf_1_address0();
    void thread_col_inbuf_1_address1();
    void thread_col_inbuf_1_ce0();
    void thread_col_inbuf_1_ce1();
    void thread_col_inbuf_2_address0();
    void thread_col_inbuf_2_address1();
    void thread_col_inbuf_2_ce0();
    void thread_col_inbuf_2_ce1();
    void thread_col_inbuf_3_address0();
    void thread_col_inbuf_3_address1();
    void thread_col_inbuf_3_ce0();
    void thread_col_inbuf_3_ce1();
    void thread_col_outbuf_i_address0();
    void thread_col_outbuf_i_address1();
    void thread_col_outbuf_i_ce0();
    void thread_col_outbuf_i_ce1();
    void thread_col_outbuf_i_d0();
    void thread_col_outbuf_i_d1();
    void thread_col_outbuf_i_we0();
    void thread_col_outbuf_i_we1();
    void thread_exitcond2_i_fu_68_p2();
    ...
    void thread_i_2_i_phi_fu_42_p4();
