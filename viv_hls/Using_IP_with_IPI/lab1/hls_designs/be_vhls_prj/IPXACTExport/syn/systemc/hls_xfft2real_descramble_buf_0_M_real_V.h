...
#ifndef _hls_xfft2real_descramble_buf_0_M_real_V_H_
#define _hls_xfft2real_descramble_buf_0_M_real_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "hls_xfft2real_descramble_buf_0_M_real_V_memcore.h"

SC_MODULE(hls_xfft2real_descramble_buf_0_M_real_V) {
...
protected:
    ...
    // buffer instances
    hls_xfft2real_descramble_buf_0_M_real_V_memcore* buffer[BufferCount];
...
public:
    ...
    SC_CTOR(hls_xfft2real_descramble_buf_0_M_real_V) : m_trace_file(0) {
        for (unsigned i = 0; i < BufferCount; i++) {
            char szTmp[128];
            sprintf(szTmp, "%d", i);
            std::string name = "hls_xfft2real_descramble_buf_0_M_real_V_memcore_U_";
            name += szTmp;

            buffer[i] = new hls_xfft2real_descramble_buf_0_M_real_V_memcore(name.c_str());
            buffer[i]->clk      ( clk );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "hls_xfft2real_descramble_buf_0_M_real_V.trace");
            // ports
