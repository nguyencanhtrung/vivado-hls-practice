...
(* CORE_GENERATION_INFO="adders_io,hls_ip_2015_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.700000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=100,HLS_SYN_LUT=101}" *)
...
always @ (posedge ap_clk) begin : ap_ret_ap_reg_ioackin_in_out1_o_ap_ack
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin : ap_ret_in1_ap_vld_preg
    if (ap_rst == 1'b1) begin
...
always @ (posedge ap_clk) begin : ap_ret_in1_preg
    if (ap_rst == 1'b1) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or ap_sig_ioackin_in_out1_o_ap_ack) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(ap_const_logic_0 == ap_sig_ioackin_in_out1_o_ap_ack))) begin
...
always @ (in_out1_o_ap_ack or ap_reg_ioackin_in_out1_o_ap_ack) begin
...
always @ (in1_ap_vld or in1_ap_vld_preg) begin
...
always @ (in1 or in1_preg or in1_ap_vld) begin
    if ((ap_const_logic_1 == in1_ap_vld)) begin
        in1_in_sig = in1;
    end else begin
        in1_in_sig = in1_preg;
...
always @ (ap_sig_cseq_ST_st1_fsm_0 or ap_sig_bdd_51) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_bdd_51)) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or ap_reg_ioackin_in_out1_o_ap_ack) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_51 or ap_sig_ioackin_in_out1_o_ap_ack) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
...
always @ (ap_start or in1_ap_vld_in_sig or in_out1_i_ap_vld) begin
