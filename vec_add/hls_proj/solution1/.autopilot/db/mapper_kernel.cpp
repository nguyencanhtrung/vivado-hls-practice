...
extern "C" void kernel(int*, int*, int*, int, int, int, float);
extern "C" void apatb_kernel_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c, float __xlx_apatb_param_d) {
  ...
  // DUT call
  kernel(__xlx_a__input_buffer, __xlx_b__input_buffer, __xlx_c__input_buffer, __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c, __xlx_apatb_param_d);
